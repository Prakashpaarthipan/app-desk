...
if($inner_menuaccess[0]['VEWVALU'] == 'Y') { // Menu Permission is allowed
    ...
    <body>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group" >
                                             ...
                                             <div id="id_expense_head_list">
                                                            <select <? if($_REQUEST['action'] == 'edit') { ?> disabled class="form-control custom-select" <? } else { ?> class="form-control custom-select chosn"  onblur="call_days()" <? } ?> tabindex='7' required name='slt_expense_approval_listings' id='slt_expense_approval_listings' data-toggle="tooltip" data-placement="top" data-original-title="Expense Head">
                                                            
                                                                   <? 
                                                               
                                                                    $sql_expense_list = select_query_json("select distinct(expsrno),expname from trandata.department_asset@tcscentr where deleted='N' and expsrno>0 order by expsrno desc", "Centra", "TCS");

                                                              
                                                                for($approval_type_mode_i = 0; $approval_type_mode_i < count($sql_expense_list); $approval_type_mode_i++) { ?>
                                                                    <option value='<?=$sql_expense_list[$approval_type_mode_i]['EXPSRNO']?>' selected ><?=$sql_expense_list[$approval_type_mode_i]['EXPNAME']?></option>
                                                            <? } ?>
                                                            </select>
                                                        </div>
                                                        <?}?>
                                                 ...
                                                 <!-- <script type="text/javascript">
                                                     function expense_li(val){
                                                        var exp = $("#slt_expense_approval_listings").val();
                                                        alert(exp);
                                                     }
                                                 </script> -->

                                                <!-- Product Quotation fix Expense List -->
            ...
            $("#frm_request_entry").on('submit',(function(e) {
                ...
                if(flag == 1)
                {
                    ...
                    if (hid_noofdays == "" || hid_noofdays == "0") {
                        ...
                        $.ajax({
                            type: 'post',
                            url: "lib/process_connect_quote.php",
                           // url:"viki/post_test.php",
                            ...
                            success: function(response)
                            {
                                ...
                                if(response == '{"type":"error","info":"ttlfailure","msg":"Failed in Request Creation. Kindly try again!"}' || response == '{"type":"error","info":"ttlfailure","msg":"Failed in Request Creation & Product Adding. Kindly try again!!!!"}' || response == '{"type":"error","info":"ttlfailure","msg":"Failed in Request Creation. Kindly try again!!"}' || response == '{"type":"error","info":"ttlfailure","msg":"Failed in Request Creation. Kindly try again!!!"}') {
                                    ...
                                    createCustomAlert(ALERTMSG, ALERT_TITLE);
                                    $('input[type=text]').val('');
                                    var quto = $("#slt_core_department").val();
                                    var qutofix = $("#slt_approval_listings").val();
                                    var expensehead = $("#slt_expense_approval_listings").val();
                                    console.log(expensehead);
                                    console.log(qutofix);

                                    

                                    //window.location="request_entry_quote.php";
                                    //$('#load_page').show();
        ...
        function call_product_innergrid(gridid) {
            ...
            /*
            if(gridid == 17){
              // product grid17 P.Pralkash 21-9-2018
              if( ($('.parts3 .part3').length+1) > 99) {
                    alert("Maximum 100 Products allowed.");
                } else {
                    var slt_subcore = $('#slt_subcore').val();
                    ...
                    var apnd_content = '<div class="part3" style="margin-right: -5px; text-transform: uppercase;">'+
                                            ...
                                            '<div class="col-sm-1 colheight red_clrhighlight" style="padding: 1px 0px;" id="id_sltrate_'+id+'">'+
                                                ' -'+
                                            '</div>'+
                                            //Product Quotatio fix P.Prakash 21-9-2018
                                            ...
                                            '<div class="col-sm-10 colheight" style="padding: 0px; border-top-left-radius:5px;">'+
                                                '<div class="fair_border" style="padding-left: 0px;">'+
                                                    '<div class="row" style="margin-right: -10px; background-color: #666666; color:#FFFFFF; display: flex; font-weight: bold;">'+
                                                        ...
                                                        '<div class="col-sm-3 colheight" style="padding: 0px;">Supplier Details <br><span class="blink_me" style="display: none;" id="hid_id_nof_suppliers_'+id+'"> 3 Suppliers Mandatory</span></div>'+
                                                        '<div class="col-sm-1 colheight" style="padding: 0px;">Delivery Duration</div>'+
                                                        '<div class="col-sm-1 colheight" style="padding: 0px;">Per Piece Rate</div>'+
                                                        // '<div class="col-sm-1 colheight" style="padding: 0px;">Rate</div>'+
                                                       // '<div class="col-sm-1 colheight" style="padding: 0px;">Tax Val.</div>'+
                                                        '<div class="col-sm-1 colheight" style="padding: 0px;">Discount % </div>'+
                                                        '<div class="col-sm-1 colheight" style="padding: 0px;">Total Amount</div>'+
                                                ...
                                                '<div class="parts3_'+id+' fair_border">'+
                                                    '<div class="row" style="margin-right: -10px; display: flex;">'+
                                                        '<div class="col-sm-1 colheight" style="padding: 1px 0px;">'+
                                                            '<div class="fg-line">'+
                                                                '<input type="hidden" name="partint3_'+id+'" id="partint3_'+id+'" value="1"><input type="hidden" name="hid_nof_suppliers_'+id+'" id="hid_nof_suppliers_'+id+'" value="1"><input type="hidden" name="txt_prdsgst_per['+id+'][]" id="txt_prdsgst_per_'+id+'_1" value=""><input type="hidden" name="txt_prdcgst_per['+id+'][]" id="txt_prdcgst_per_'+id+'_1" value=""><input type="hidden" name="txt_prdigst_per['+id+'][]" id="txt_prdigst_per_'+id+'_1" value="">'+
                                                                '<button class="btn btn-success btn-add3" id="addbtn_'+id+'" type="button" title="Add Suppliers" onclick="call_innergrid17('+id+')" style="padding: 2px 5px; margin-right: 4px !important;"><span class="glyphicon glyphicon-plus"></span></button>'+
                                                                '<button id="removebtn_'+id+'" class="btn btn-remove btn-danger" type="button" title="Delete Suppliers" onclick="call_innergrid_remove('+id+')" style="padding: 2px 5px; margin-right: 0px !important;"><span class="glyphicon glyphicon-minus"></span></button>&nbsp;<br><input type="radio" checked="checked" name="txt_sltsupplier['+id+'][]" id="txt_sltsupplier_'+id+'_1" value="1" onclick="getrequestvalue('+id+', 1)" data-toggle="tooltip" data-placement="top" title="Select This Supplier" placeholder="Select This Supplier" class="calc">&nbsp;1<br>';
                                                    ...
                                                    apnd_content += '</div>'+
                                                        ...
                                                        '<div class="col-sm-1 colheight" style="padding: 1px 0px;">'+
                                                            '<input type="text" onKeyPress="enable_product(); return validateFloatKeyPress(this,event); return isNumber(event)" name="txt_prdrate['+id+'][]" id="txt_prdrate_'+id+'_1" onblur="calculatenetamount('+id+',1); find_tags();" placeholder="Product Per Piece Rate" required="required" maxlength="10" data-toggle="tooltip" data-placement="top" title="Product Per Piece Rate" class="form-control supquot" style=" text-transform: uppercase;height: 25px;">'+
                                                            //Product Quotation Fix Prakash P 21-9-2018
                ...
                // grid17 end here P.Prakash 21.9.2018 
        ...
        // Product Quotation Fix P.Prakash 21-9-2018
       /* function call_innergrid17(gridid) {
            $('#load_page').show();
            // alert("**"+gridid);
            // $("#addbtn_"+gridid).click(function () {
                // alert("!!"+gridid);
        ...
        function call_dynamic_option() {
            ...
            if(slt_submission == 4 && slt_approval_listings == 1905){
            ...
            if(slt_approval_listings != '' && alow_prd == 1) {
                var strURL="ajax/ajax_dynamic_option_quote.php?action=add_edit&slt_branch="+slt_branch+"&deptid="+deptid+"&core_deptid="+core_deptid+"&target_no="+target_no+"&slt_submission="+slt_submission+"&slt_approval_listings="+slt_approval_listings+"&view="+view;
                $.ajax({
                    type: "POST",
                    url: strURL,
                    success: function(data1) {
 ...
 //  error
        ...
        function get_advancedetails() {
            ...
            if(approval_listings_id == 1781) { // 1781 - AMC (9063 - HW Maintenance)
                ...
                $("#dynamic_date_subject").css("display", "block");
                $("#list_expense_head").css("display","none");
            } else if(approval_listings_id == 1905){
                $("#list_expense_head").css("display","block");
            }
