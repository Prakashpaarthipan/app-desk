										...
										<div class="row">
											<div class="col-md-6">
											   ...
											   <div class="form-group">
													<label class="col-md-3 control-label" >Top Core<span style='color:red'>*</span></label>
													<div class="col-md-9"  >
														<select class="form-control custom-select chosn" autofocus tabindex='1' required name='txtTopcore' id='txtTopcore' onChange="find_tags(); getcore();" data-toggle="tooltip" data-placement="top" data-original-title="Top Core" >
														<option value="choose top core" selected>CHOOSE TOP CORE</option>
														<?  $sql_project = select_query_json("select * from approval_topcore where deleted = 'N' order by ATCSRNO", "Centra", 'TEST');
															for($project_i = 0; $project_i < count($sql_project); $project_i++) { ?>
															<option value='<?=$sql_project[$project_i]['ATCCODE']?>'><?=$sql_project[$project_i]['ATCNAME']?></option>
														<? } ?>
                                                    </select>
												...
												<div class="form-group">
													<label class="col-md-3 control-label">Priority<span style='color:red'>*</span></label>
													<div class="col-md-9">
														<select class="form-control custom-select chosn" tabindex='1' required name='Priority' id='Priority' data-toggle="tooltip" data-placement="top" data-original-title="Top Core" onChange="find_tags(); ">
														<?  $sql_project = select_query_json("select * from APPROVAL_Priority where deleted = 'N' order by PRISRNO", "Centra", 'TEST');
															for($project_i = 0; $project_i < count($sql_project); $project_i++) { ?>
															<option value='<?=$sql_project[$project_i]['PRICODE']?>'><?=$sql_project[$project_i]['PRINAME']." - ".$sql_project[$project_i]['PRIDESC']?></option>
														<? } ?>
														</select>
														<span class="help-block">Select Prioprity</span>
													</div>
												</div>
												<!-- tilte text feild -->
												<div class="form-group">
													<label class="col-md-3 control-label" id='attachment'>Title<span style='color:red'>*</span></label>
													<div class="col-md-9 col-xs-12">
														<div class="">
															<input type="text" class="form-control" id="title" name="title" style="text-transform: uppercase;" maxlength="100" required />
														</div>
														<span class="help-block">NOTE : ENTER THE TITLE</span>
													</div>
...
<!--fix me-->
											<div class="col-md-6">
												...
												<div class="form-group">
													...
													<div class="col-md-9">
														<div id='get_core'></div>
														<span class="help-block">Select Core</span>
													</div>
												...
												<div class="form-group">
                            <label class="col-md-3 control-label">Assign Member</label>
                            <div class="col-md-9 col-xs-12">
                                <b>
                                  <input type='text' class="form-control" tabindex='6' style="text-transform: uppercase;" name='txt_assign' id='txt_assign' data-toggle="tooltip" onblur="find_tags();" data-placement="top" data-original-title="Assign member" value='<?=$sql_emp[0]['EMPCODE']." - ".$sql_emp[0]['EMPNAME']." - ".substr($sql_emp[0]['ESENAME'], 3)?>'>
														     <span class="help-block">NOTE : ASSIGN THE MEMBER</span>
                            </div>
                        </div>

												<!-- Tag layout -->
												<div class="form-group">
													<label class="col-md-3 control-label" id='attachment'>Attachments</label>
													<div class="col-md-9 col-xs-12">
												...
												<div class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-xs-12">
                                                        <? if($_REQUEST['action'] == 'view') {
                                                                ...
                                                                <input type="text" tabindex='22' onblur="find_tags();" name="due_date" id="due_date" class="form-control" required readonly placeholder='Implementation Due Date' <?=$rdonly;?> autocomplete='off' value='<? if($sql_reqid[0]['IMDUEDT'] != '') { echo strtoupper(date("d-M-Y", strtotime($sql_reqid[0]['IMDUEDT']))); } else { echo strtoupper(date("d-M-Y", strtotime("+14 days"))); } ?>' style='text-transform:uppercase; ' maxlength='11' title='Implementation Due Date'>
                                                        <? } ?>
                                                    </div>
                                                </div>
