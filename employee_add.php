...
if($_REQUEST['action'] == 'deleted')
{
    ...
    // Update in EMPLOYEE_HEAD_USER Table
    $tbl_appreq = "EMPLOYEE_HEAD_USER";
    $field_appreq = array();
    ...
    $where_appreq = "EMPHDSR = '".$reqid."'";
    $insert_appreq = update_test_dbquery($field_appreq, $tbl_appreq, $where_appreq);
    // Update in EMPLOYEE_HEAD_USER Table
    // exit;

    if($insert_appreq == 1) { ?>
        <script>window.location='employee_add.php?status=delete_success';</script>
        <?php exit();
    } else { ?>
        <script>window.location='employee_add.php?status=failure';</script>
        <?php exit();
    }
}
?>
...
<head>
    ...
    <link href="css/jquery.filer.css" rel="stylesheet">
	 <link rel="stylesheet" href="js/jquery-confirm/jqueryconfirm.css">
...
<body>
        ...
        <div class="page-content">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><strong>Employee Head Fix</strong></h3><br>

                    <div class="pull-right">
                        <a class="btn btn-danger" target="_blank" style="margin-right: 5px;" href="employee_grade_fix.php">Grade Fix</a>&nbsp;&nbsp;<a class="btn btn-danger" target="_blank" style="margin-right: 50px;" href="employee_grade_fix_report.php">Grade Fix Report</a><br><br>
                    </div>
                </div>
                                ...
                                <div class="col-md-6">
                                    <div id="add_emp" class="form-group">
                                        ...
                                        <div class="form-group input-group" id="dynamicRemove">
                                          ...
                                          <input type="text" name="txt_employee_code[]" id="txt_employee_code1" placeholder="ENTER THE EMPLOYEE CODE" title="select the employee here" class="form-control find_empcode" data-toggle="tooltip" data-placement="top" style=" text-transform: uppercase; position: relative; top: auto; right: auto; bottom: auto; left: auto;"  required maxlength="5" tabindex="5" onchange="javascript:return removeduperun(this);" size="40">
    ...
    <!-- END TEMPLATE -->
<script src="js/jquery-confirm/jqueryconfirm.js"></script>
    ...
    function teamremove(head1,srno)
    {
                ...
                $.ajax({
                 ...
                 $.alert({
                    title: '<span style="color:red">Alert!</span>',
                    content: 'Adding Failed.Try Again!',
                });
    ...
    function employee_submit(){
		var comments = document.getElementById("txt_employee_head");
          if (comments.value == "") {
             $.alert({
                    title: '<span style="color:red">Alert!</span>',
                    content: 'Please Enter the Head Code'
					
                });
				return false;
		  }
              
	var comments = document.getElementById("txt_employee_code1");
          if (comments.value == "") {
             $.alert({
                    title: '<span style="color:red">Alert!</span>',
                    content: 'Please Enter the Employee Code',
                });
				return false;
		  }
        $("#load_page").fadeOut("slow");
...
console.log(data);
               if (data=="1") {
				...
				window.location.reload(true);
                 ...
                 $.alert({
                    title: '<span style="color:red">Alert!</span>',
                    content: 'Saving Failed.Try Again!',
                });
               } 
