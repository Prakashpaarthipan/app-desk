...
<body>
    ...
    <div class="page-container page-navigation-top-fixed">
        ...
        <div class="page-content">
            ...
            <form class="form-horizontal" role="form" id="frm_requirement_entry" name="frm_requirement_entry" action="nancy/inset.php" method="post" enctype="multipart/form-data">
									...
									<div class="panel-body">
										...
										<div class="row">
											   ...
											   <div class="form-group">
													<label class="col-md-2 control-label" >POLICY SUBJECT<span style='color:red','text-align:center'>*</span></label>
													<div class="col-md-10"  >
