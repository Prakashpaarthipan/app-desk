...
if($_REQUEST['slt_submission'] == 4 && $slt_approval_listings == 1905) { $pathid = 17;}
?>
<div class='clear clear_both'></div>
			...
			<div class="parts3 fair_border">
				...
				<div class="row" style="margin-right: -5px; display: flex; text-transform: uppercase;">
		            ...
		            <div class="col-sm-3 colheight" style="padding: 1px 0px;">
						...
						<div style="width: 49%; float: left;">
		    				<input type="text" onKeyPress="enable_product();" name="txt_from_duedate[]" required id="datepicker_dynfrom_1" onblur="calculateqtyamount('1'); find_tags();" maxlength="11" placeholder="From Due Date" data-toggle="tooltip" data-placement="top" title="From Due Date" class="form-control supquot" value='<? if($sql_reqid[0]['IMDUEDT'] != '') { echo strtoupper(date("d-M-Y", strtotime($sql_reqid[0]['IMDUEDT']))); } else { echo strtoupper(date("d-M-Y", strtotime("+1 days"))); } ?>' readonly="readonly" style="text-transform: uppercase; height: 25px;" >
		    			</div>
						<div style="width: 49%; float: left; margin-left: 2px;">
		    				<input type="text" onKeyPress="enable_product();" name="txt_to_duedate[]" required id="datepicker_dynto_1" onblur="calculateqtyamount('1'); find_tags();" maxlength="11" placeholder="To Due Date" data-toggle="tooltip" data-placement="top" title="To Due Date" class="form-control supquot" value='<? if($sql_reqid[0]['IMDUEDT'] != '') { echo strtoupper(date("d-M-Y", strtotime($sql_reqid[0]['IMDUEDT']))); } else { echo strtoupper(date("d-M-Y", strtotime("+2 days"))); } ?>' readonly="readonly" style="text-transform: uppercase; height: 25px;" >
		    			</div>
		    			<div style="clear: both;"></div>
		            ...
		            <div class="col-sm-1 colheight" style="padding: 1px 0px;">
		    			<input type="text" onKeyPress="enable_product(); return validateFloatKeyPress(this,event); return isNumber(event)" name="txt_prdqty[]" id="txt_prdqty_1" onblur="calculateqtyamount('1'); find_tags();" required="required" maxlength="9" placeholder="Qty" data-toggle="tooltip" data-placement="top" title="Qty" class="form-control supquot decimal_point" style=" text-transform: uppercase;height: 25px;" >
		    		</div>
					...
					<div class="col-sm-10 colheight" style="padding: 0px; border-top-left-radius:5px;">
		    			<div class="fair_border" style="padding-left: 0px;">
							<div class="row" style="margin-right: -10px; background-color: #666666; color:#FFFFFF; display: flex; font-weight: bold;">
								...
								<div class="col-sm-3 colheight" style="padding: 0px;">Supplier Details <br><span class="blink_me" style="display: none;" id="hid_id_nof_suppliers_1"> 3 Suppliers Mandatory</span></div>
		    		...
		    		<div class="col-sm-10 colheight" style="padding-left: 0px;">
		    			...
		    			<div class="parts3_1 fair_border">
							<div class="row" style="margin-right: -10px; display: flex;">
					            ...
					            <div class="col-sm-1 colheight" style="padding: 1px 0px;">
					            	<input type="text" onKeyPress="enable_product(); return validateFloatKeyPress(this,event); return isNumber(event)" name="txt_prdrate[1][]" id="txt_prdrate_1_1" placeholder="Product Per Piece Rate" required="required" maxlength="10" data-toggle="tooltip" data-placement="top" onblur="calculatenetamount('1','1'); find_tags();" title="Product Per Piece Rate" class="form-control supquot" style=" text-transform: uppercase;height: 25px;">
					            	Adv.Amount Val.:
...
<? 	// PO Based - End
			...
			case 100: // Staff Night Duty ?>
					...
					<div class="parts3 fair_border">
						<div class="row" style="margin-right: -5px; text-transform: uppercase; background-color: #666666; color:#FFFFFF; border-top-left-radius:5px; border-top-right-radius: 5px; display: flex; font-weight: bold;">
			            	...
			            	<div class="col-sm-1 colheight"  style="padding: 0px;">MOBILE NO</div>
			            </div>
				     	...
				     	<div class="row" style="margin-right: -5px; display: flex; text-transform: uppercase;">
				    		...
				    		<div class="col-sm-1 colheight" style="padding: 1px 0px; text-align: center; padding-left: 2px;">
				    			  <input type="text"  name="MOBILENO[]" id="mobileno_1" placeholder="MOBILE NO" data-toggle="tooltip" data-placement="top" title="MOBILE NO" class="form-control"   style=" text-transform: uppercase;height: 25px;" maxlength="10"  required="required" >
				    		</div>
	...
	// New Product Code Create Template
			...
			case 15: // approval subject create ?>
					<div id='' style="text-align: center;">
					<div class="parts3 fair_border">
						<div class="row" style="text-transform: uppercase; background-color: #666666; color:#FFFFFF; border-top-left-radius:5px; border-top-right-radius: 5px; display: flex; font-weight: bold;">
							<div class="col-md-2 colheight"  style="padding: 0px; border-top-left-radius:5px;">
								<input type="hidden" name="partint3" id="partint3" value="1">
								<button class="btn btn-success btn-add3" id="addbtn" type="button" title="Add Employee" onclick="subject_add(1)"><span class="glyphicon glyphicon-plus"></span></button>
								<button id="removebtn" class="btn btn-remove btn-danger" type="button" title="Delete Product" onclick="emp_remove(1)"><span class="glyphicon glyphicon-minus"></span></button>&nbsp;#
							</div>
							<div class="col-md-2 colheight"  style="padding:6px 0px;">TYPE OF SUBMISSION</div>
							<div class="col-md-2 colheight"  style="padding:6px 0px;">TARGET NUMBER</div> <!-- fetch table -->
						 	<div class="col-md-2 colheight"  style="padding:6px 0px;">SUBJECT</div>
				     	<div class="col-md-2 colheight"  style="padding:6px 0px;">CORE</div>  <!--fetch table -->
				      <div class="col-md-2 colheight"  style="padding:6px 0px;">EMPLOYEE</div>
			      </div>

				   	<div class="row" style="display: flex; text-transform: uppercase;">
							<div class="col-sm-2 colheight" style="padding: 6px 0px;">
								<div class="fg-line">&nbsp;1</div>
							</div>

							<div class="col-sm-2 colheight" style="padding: 1px 0px;">
								<div>
									<select name="types_of_submission[]" id="types_of_submission_0" class="form-control" style=" text-transform: uppercase;" required="required" title="TYPES OF SUBMISSION"></select>
								</div>
								<div style="clear: both;"></div>
							</div>

							<div class="col-sm-2 colheight" style="padding: 1px 0px;">
								<select name="target_number[]" id="target_number_0" class="form-control" style=" text-transform: uppercase;" title="TARGET NUMBER" readonly></select>
							</div>

				    	<div class="col-sm-2 colheight" style="padding: 1px 0px; text-align: center; padding-left: 2px;">
								<input type="text" name="txt_subject[]" id="txt_subject_0" required="required" maxlength="50" placeholder="SUBJECT" title="SUBJECT" class="form-control find_empcode" data-toggle="tooltip" data-placement="top" style=" text-transform: uppercase; padding: 2px;">
							</div>

				      <div class="col-sm-2 colheight" style="padding: 1px 0px; text-align: center; padding-left: 2px;">
				    	 	<select name="txt_subcore[]" id="txt_subcore_0" class="form-control" style=" text-transform: uppercase;" title="CORE" readonly></select>
				    	</div>

				      <div class="col-sm-2 colheight" style="padding: 1px 0px; text-align: center; padding-left: 2px;">
								<div id="add_emp_0" class="form-group" style="margin:0 15px !important">
									<input type="hidden" name="partint3" id="partint30" value="1">
	                    <div class="form-group input-group">
												<span class="input-group-btn"><button id="add_emp_button_0_1" type="button" onclick="subject_addnew(0)" class="btn btn-success btn-add" disabled>+</button></span>
												<input type="text" name="add_emp_txt[0][]" id="add_emp_txt_0_1" maxlength="50" placeholder="EMPLOYEE" title="EMPLOYEE" class="form-control find_empcode" data-toggle="tooltip" data-placement="top" style=" text-transform: uppercase; padding: 2px;" readonly>
	                    </div>
	                </div>
							</div>
				...
				$(document).ready(function(){
			          ...
			          minLength: 0
								...
								$.ajax({
										url: 'ajax/ajax_load_aprtype.php',
										type: 'post',
										dataType: 'json',
										success:function(response){
												var len = response.length;
												$("#types_of_submission_0").append("<option value='' selected hidden>CHOOSE TYPES OF SUBMISSION</option>");
												for( var i = 0; i<len; i++){
														var id = response[i]['id'];
														var name = response[i]['name'];
														$("#types_of_submission_0").append("<option value='"+id+"'>"+name+"</option>");

												}
										}
								});
								$("#types_of_submission_0").change(function(){
									var t_id = $("#types_of_submission_0").val();
									if (t_id == 1) {
										$("#target_number_0").prop('readonly', false);
										$("#add_emp_txt_0_1").val("");
										$("#add_emp_txt_0_1").prop('readonly', true);
										$("#add_emp_button_0_1").prop('disabled', true);
										$("#txt_subcore_0").prop('readonly', true);
										$("#txt_subcore_0 option").remove();
										$("#txt_subcore_0").append("<option value='' selected hidden>- -</option>");

										$.ajax({
												url: 'ajax/ajax_load_targetnum.php',
												type: 'post',
												dataType: 'json',
												data: { id: t_id	},
												success:function(response){
														var len = response.length;
														$("#target_number_0 option").remove();
														$("#target_number_0").append("<option value='' selected hidden>CHOOSE TYPES OF SUBMISSION</option>");
														for( var i = 0; i<len; i++){
																var id = response[i]['id'];
																var name = response[i]['name'];
																$("#target_number_0").append("<option value='"+id+"'>"+name+"</option>");
										...
										$("#target_number_0").prop('readonly', true);
										$("#add_emp_txt_0_1").prop('readonly', false);
										$("#add_emp_button_0_1").prop('disabled', false);
										$("#txt_subcore_0").prop('readonly', false);
										$("#target_number_0 option").remove();
										$("#target_number_0").append("<option value='' selected hidden>- -</option>");
	 ...
	 /* case 13 :?>
		...
		<div class="parts3 fair_border">
			...
			<div class="row" style="margin-right: -5px; display: flex; text-transform: uppercase;">
	            ...
	            <div class="col-sm-4 colheight" style="padding: 0px; line-height: 30px;">
	            	<input type='file' class="form-control" style="text-transform: uppercase;" required name='txtdynamic_policy_docs' id='txtdynamic_policy_docs' data-toggle="tooltip" data-placement="top" data-original-title="POLICY DOCUMENTS" value=''>
	            </div>
	        </div>
			</div>
		</div>
 ...
 */
		/*case 17:?>
			...
			<!-- PRODUCT QUOTATION FIX -->
				<div id='' style="margin: 1px 5px 1px 0px; text-align: center;">
			<div class="parts3 fair_border">
				<div class="row" style="margin-right: -5px; text-transform: uppercase; background-color: #666666; color:#FFFFFF; border-top-left-radius:5px; border-top-right-radius: 5px; display: flex; font-weight: bold;">
					<div class="col-sm-1 colheight" style="padding: 0px; border-top-left-radius:5px;">
						<input type="hidden" name="partint3" id="partint3" value="1">
						<button class="btn btn-success btn-add3" id="addbtn" type="button" title="Add Product" style="padding: 2px 5px; margin-right: 0px !important;" onclick="call_product_innergrid(17)"><span class="glyphicon glyphicon-plus"></span></button>
						<button id="removebtn" class="btn btn-remove btn-danger" type="button" title="Delete Product" style="padding: 2px 5px; margin-right: 0px !important;" onclick="call_product_innergrid_remove(17)"><span class="glyphicon glyphicon-minus"></span></button>&nbsp;#
					</div>
					<div class="col-sm-3 colheight" style="padding: 0px;">Product / Sub Product / Spec. / Image</div>
		            <div class="col-sm-3 colheight" style="padding: 0px;">Advt. Product & Due Date Details</div>
		            <div class="col-sm-1 colheight" style="padding: 0px;">Qty</div>
		    			...
		    			<!--<div class="parts3_1 fair_border">
							<div class="row" style="margin-right: -10px; display: flex;">
								<div class="col-sm-1 colheight" style="padding: 1px 0px;">
									<div class="fg-line">
										<input type="hidden" name="partint3_1" id="partint3_1" value="1"><input type="hidden" name="hid_nof_suppliers_1" id="hid_nof_suppliers_1" value="1"><input type="hidden" name="txt_prdsgst_per[1][]" id="txt_prdsgst_per_1_1" value=""><input type="hidden" name="txt_prdcgst_per[1][]" id="txt_prdcgst_per_1_1" value=""><input type="hidden" name="txt_prdigst_per[1][]" id="txt_prdigst_per_1_1" value="">
										<button class="btn btn-success btn-add3" id="addbtn_1" type="button" title="Add Suppliers" style="padding: 2px 5px; margin-right: 0px !important;" onclick="call_innergrid17(1)"><span class="glyphicon glyphicon-plus"></span></button>
										<button id="removebtn_1" class="btn btn-remove btn-danger" type="button" title="Delete Suppliers" style="padding: 2px 5px; margin-right: 0px !important;" onclick="call_innergrid_remove(1)"><span class="glyphicon glyphicon-minus"></span></button>&nbsp;<br><input type="radio" onKeyPress="enable_product();" onclick="getrequestvalue(1, 1)" checked="checked" name="txt_sltsupplier[1][]" id='txt_sltsupplier_1_1' value='1' data-toggle="tooltip" data-placement="top" title="Select This Supplier" placeholder="Select This Supplier" class="calc">&nbsp;1<br>
