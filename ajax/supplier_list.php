	...
	for($i = 0 ; $i<count($supplier_list) ; $i++){?>
		...
		<div class="col-md-3" style="height:330px">
            ...
            <div class="panel panel-default list">
                <div class="panel-body profile supplier_profile_class">
                    ...
                    <div class="profile-controls">
                        ...
                        <a href="service_request_entry.php" target="_blank" class="profile-control-right"><span class="fa fa-comments"></span></a>
                    </div>
                </div>                                
