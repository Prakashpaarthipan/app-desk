...
if($_REQUEST['slt_submission'] == 9 ){$pathid = 13;}
if($_REQUEST['slt_submission'] == 10 || $_REQUEST['slt_submission'] == 11) { $pathid = 13;}
	...
	case 2: // Monthwise Budget - Start ?>
		...
		<? 	}
			...
			case 100: // Staff Night Duty ?>
					<div class='' id="branch" name="branchstaff" style="text-align: left;margin-top: 20px" ><h4>TCS EMPLOYEES</h4></div> 
					...
					<div id='' style="padding-left: 10px; text-align: center;">
					<div class="parts4 fair_border">
						<div class="row" style="margin-right: -5px; text-transform: uppercase; background-color: #666666; color:#FFFFFF; border-top-left-radius:5px; border-top-right-radius: 5px; display: flex; font-weight: bold;">
							<div class="col-sm-1 colheight"  style="padding: 0px; border-top-left-radius:5px;">
								<input type="hidden" name="partint3" id="partint3" value="1">
								<button class="btn btn-success btn-add3" id="addbtn" type="button" title="Add Employee" onclick="emp_night_add_company(1)"><span class="glyphicon glyphicon-plus"></span></button>
								<button id="removebtn" class="btn btn-remove btn-danger" type="button" title="Delete Product" onclick="emp_remove_company(1)"><span class="glyphicon glyphicon-minus"></span></button>&nbsp;#
							</div>
							<div class="col-sm-2 colheight"  style="padding: 0px;">COMPANY NAME</div>
				            <div class="col-sm-2 colheight"  style="padding: 0px;">EMPLOYEE NAME</div>
				            ...
				            <div class="col-sm-2 colheight"  style="padding: 0px;">TOTAL WORKING HOURS</div>
			            	<div class="col-sm-2 colheight"  style="padding: 0px;">MOBILE</div>
				     	...
				     	<div class="row" style="margin-right: -5px; display: flex; text-transform: uppercase;">
							...
							<div class="col-sm-2 colheight" style="padding: 1px 0px;">	
									...
									?>
									 <select class="form-control" name="txt_cmp_name[]" id="txt_cmp_name" title="COMPANY NAME">
									 	<option value="">CHOOSE THE COMPANY HERE</option>	
									 	<?foreach ($sqlCompany as $key => $sres) {?>
									 		<option value="<?=$sres['CMPCODE']?>"> <?=$sres['CMPNAME']?></option>	
									 	<?}?>
									</select>
				            ...
				            <div class="col-sm-2 colheight" style="padding: 1px 0px; text-align: center; padding-left: 2px;">	
				    			 <input type="text"  name="txt_emp_name[]" id="txt_emp_name" placeholder="EMPLOYEE NAME" data-toggle="tooltip" data-placement="top" title="EMPLOYEE NAME" class="form-control" style=" text-transform: uppercase;height: 30px;" required="required" maxlength="30">
				    		</div>
				    		 <div class="col-sm-1 colheight" style="padding: 1px 0px; text-align: center; padding-left: 2px;">	
				    		 	<input type="file"  name="contractor_photo[]" id="contractor_photo" placeholder="Choose Photo" accept="image/jpg,image/jpeg,image/gif,image/png" onchange="readURLdesign(this);" data-toggle="tooltip" data-placement="top"  title="" class="form-control" style="text-transform: uppercase;">
				    		 	<div id="cphoto_1"><img  id = "design" class="img" style="height: 100px;width: 100px" align="center" src="" title="Image" ></div>
						
				    		 </div>
				    		<div class="col-sm-2 colheight" style="padding: 1px 0px; text-align: center; padding-left: 2px;">	
				    			 <input type="text"  name="txt_nature_wrk[]" id="txt_nature_wrk" placeholder="NATURE OF WORK" data-toggle="tooltip" data-placement="top" title="NATURE OF WORK" class="form-control" style=" text-transform: uppercase;height: 30px;" required="required" maxlength="40" >
				    		</div>
				    		 
				    		<div class="col-sm-2 colheight" style="padding: 1px 0px; text-align: center; padding-left: 2px;">	
				    			  <input type="text"  name="txt_total_wrk_hrs[]" id="txt_total_wrk_hrs" placeholder="TOTAL WORKING HOURS" data-toggle="tooltip" data-placement="top" title="TOTAL WORKING HOURS" class="form-control"   style=" text-transform: uppercase;height: 30px;" required="required" maxlength="10">
				    		</div>
							
				    		<div class="col-sm-2 colheight" style="padding: 1px 0px; text-align: center; padding-left: 2px;">	
				    			  <input type="text"  name="txt_mobile[]" id="txt_mobile" placeholder="MOBILE" maxlength="10" data-toggle="tooltip" data-placement="top" title="MOBILE" class="form-control"   style=" text-transform: uppercase;height: 30px;" onkeypress="return validateFloatKeyPress(this,event,1);" maxlength="5"  required="required" >
				    		</div>
		...
		case 14 :
			?>
			    ...
			    <tbody class="text-center">
						<?// Write the php code
						$sql_project_branch = select_query_json("SELECT BRNCODE , BRNNAME, NICNAME from approval_branch_list where DELETED = 'N' order by BRNCODE","Centra","TEST");
