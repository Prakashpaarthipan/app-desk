...
<? 	// PO Based - End
	...
	<!-- <input type="checkbox" name="alw_create" id="alw_create" onclick="default_view();"> -->
	 <form class="form-horizontal" role="form" id="frm_requirement_entry" name="frm_requirement_entry" action='nancy/inset.php' enctype="multipart/form-data">
									...
									<div class="panel-body">
										...
										<div class="row">
											   ...
											   <div class="form-group">
													...
													<div class="col-md-10"  >
														<select class="form-control " autofocus tabindex='1' required name='txtdynamic_subject' id='txtdynamic_subject' " data-toggle="tooltip" data-placement="top" data-original-title="Top Core" >
...
<!--fix me-->
  ...
  <script src="js/fSelect.js"></script>
	...
	/*function nsubmit(){
		alert("uable to call");
			var vurl = "process_connect_test.php";
