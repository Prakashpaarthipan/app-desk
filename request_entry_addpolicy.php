...
<body>
                                    ...
                                    <div id='id_policy_approval' style="padding-left: 10px; text-align: center; display: none;">
                                        <div class="parts3 fair_border">
                                            ...
                                            <div class="row" style="margin-right: -5px; display: flex; text-transform: uppercase;">
                                                ...
                                                <div class="col-sm-2 colheight" style="padding: 0px; text-align: right; line-height: 30px;">CREATOR EC NO \ NAME: </div>
                                                <div class="col-sm-4 colheight" style="padding: 0px; line-height: 30px;">
                                            ...
                                            <div class="row" style="margin-right: -5px; display: flex; text-transform: uppercase;">
                                              ...
                                              <div class="col-sm-4 colheight" style="padding: 0px; line-height: 30px;">
                                                  <input type="text" name="txtdynamic_valid_upto" id="datepicker_example61" class="form-control policy_approval_required" required readonly placeholder='VALID UPTO' autocomplete='off' value='<?=strtoupper(date("d-M-Y"));?>' style='text-transform:uppercase; ' maxlength='11' title='APPROVAL DATE'>
                                              </div>

                                                <div class="col-sm-2 colheight" style="padding: 0px; text-align: right; line-height: 30px;">CO-ORDINATOR EC NO \ NAME: </div>
                                                <div class="col-sm-4 colheight" style="padding: 0px; line-height: 30px;">
                                                    <input type='text' class="form-control policy_approval_required" style="text-transform: uppercase;" required name='txtcoordinate_assistby' id='txtdynamic_assistby' data-toggle="tooltip" data-placement="top" data-original-title="ASSIST BY" value='<?=$sql_emp[0]['EMPCODE']." - ".$sql_emp[0]['EMPNAME']." - ".substr($sql_emp[0]['ESENAME'], 3)?>'>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row" style="margin-right: -5px; display: flex; text-transform: uppercase;">
                                                ...
                                                <div class="col-sm-4 colheight" style="padding: 0px; line-height: 30px;">
                                                    <input type='text' class="form-control policy_approval_required" style="text-transform: uppercase;" required name='txtdynamic_assist' id='txtdynamic_assist' data-toggle="tooltip" data-placement="top" data-original-title="APPROVED BY" value='<?=$sql_emp[0]['EMPCODE']." - ".$sql_emp[0]['EMPNAME']." - ".substr($sql_emp[0]['ESENAME'], 3)?>'>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row" style="margin-right: -5px; display: flex; text-transform: uppercase;">
                                                <div class="col-sm-2 colheight" style="padding: 0px; text-align: right; line-height: 30px;">MAINTENANCE OF POLICY : </div>
                                                <div class="col-sm-10 colheight" style="padding: 0px; line-height: 30px;">
                                                    <input type='text' class="form-control policy_approval_required" style="text-transform: uppercase;" required name='MAINTENANCE_OF_POLICY' placeholder="MAINTENANCE OF POLICY" value=''>
                                                </div>
                                            </div>

                                            <div class="row" style="margin-right: -5px; display: flex; text-transform: uppercase;">
                                                <div class="col-sm-12" style="padding: 0px; line-height: 30px;">
                                                    <?  if($_REQUEST['action'] == 'view') {
                                                            echo ": ".$sql_reqid[0]['APPRDET'];
                                                       } else {
                                                            /* <textarea class="form-control" <? if($_REQUEST['action'] != 'edit') { } ?> tabindex='23' rows="10" placeholder="Details" required maxlength='400' name='txtdetails' id='txtdetails' data-toggle="tooltip" data-placement="top" title="Details" style='text-transform:uppercase' onKeyPress="return isQuotes(event)"><? echo $sql_reqid[0]['APPRDET']; ?></textarea>
                                                            <span style='color:#FF0000; font-size:10px;'>NOTE : MAXIMUM 400 CHARACTERS ALLOWED..</span> */ ?>
                                                            <input type="hidden" name="hid_apprsub" id='hid_apprsub' value="<?=$sql_reqid[0]['APPRSUB']?>" onblur="find_tags();">
                                                            <textarea name="FCKeditor2" id="FCKeditor2" tabindex='14'>
                                                                <?  if($_REQUEST['action'] == 'edit') {
                                                                        if($sql_reqid[0]['APPRFOR'] == '1') {
                                                                            $filepathname = $sql_reqid[0]['APPRSUB'];
                                                                            $filename = "ftp://".$ftp_user_name_apdsk.":".$ftp_user_pass_apdsk."@".$ftp_server_apdsk.":5022/approval_desk/text_approval_source/".$filepathname;
    ...
    <?  /* $sql_chklist = select_query_json("select * from approval_checklist where deleted = 'N' and tarnumb = 7515 order by apcklst");
        ...
        description1=CKEDITOR.instances['FCKeditor2'].getData().replace(/<[^>]*>/gi, '');
        if(description1=='')
        {
            var ALERT_TITLE = "Message";
            var ALERTMSG = "Please enter the details";
            createCustomAlert(ALERTMSG, ALERT_TITLE);
            CKEDITOR.instances['FCKeditor2'].focus();
            $('#load_page').hide();
            gtvl = 0;
        }
    ...
    $('#datepicker_example61').Zebra_DatePicker({
      direction: true,
      format: 'd-M-Y'
    });
    ...
    <script type="text/javascript">
        $(document).ready(function ($) {
            ...
            // Policy approval
            $('#txtdynamic_assist').autocomplete({
                source: function( request, response ) {
                    $.ajax({
                        url : 'ajax/ajax_employee_details.php',
                        dataType: "json",
