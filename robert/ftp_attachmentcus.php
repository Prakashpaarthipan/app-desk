...
<?
$sql_docs = select_query_json("select * from APPROVAL_REQUEST_DOCS where aprnumb = '".$aprnumb."' order by APRHEAD, apdcsrn", 'Centra', 'TCS');
$apphed = '';
?>
...
for($ij = 0; $ij < count($sql_docs); $ij++) {
	...
	switch($exp[5])
	{
		case 'i':
				...
				break;
		case 'n':
				echo $fieldindi = "</ul><a href=\"ftp://".$ftp_user_name_apdsk.":".$ftp_user_pass_apdsk."@".$ftp_server_apdsk.$ftp_srvport_apdsk."/approval_desk/request_entry/".$dataurl."/".$filename."\" target=\"_blank\" ><img src='../images/npdf.png' style='width:100px;height: 100px;margin-left:  10px;margin-top: 11px;' class=\"style_box\"> </a><ul id=\"lightgallery\" class=\"list-unstyled row lightgallery\" style='float:left; margin-left:5px;'>";
				break;
		case 'w':
				echo $fieldindi = "</ul><a href=\"ftp://".$ftp_user_name_apdsk.":".$ftp_user_pass_apdsk."@".$ftp_server_apdsk.$ftp_srvport_apdsk."/approval_desk/request_entry/".$dataurl."/".$filename."\" target=\"_blank\" ><img src='../images/npdf.png' style='width:100px;height: 100px;margin-left:  10px;margin-top: 11px;' class=\"style_box\"></a><ul id=\"lightgallery\" class=\"list-unstyled row lightgallery\" style='float:left; margin-left:5px;'>";
				break;
