            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="pull-right">
                        <a class="btn btn-danger" target="_blank" style="margin-right: 5px;" href="employee_grade_fix.php">Grade Fix</a>&nbsp;&nbsp;<a class="btn btn-danger" target="_blank" style="margin-right: 50px;" href="employee_grade_fix_report.php">Grade Fix Report</a>
                    </div>
                </div>
