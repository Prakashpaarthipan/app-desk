											 ...
											 <div id="add_ledger" class="form-group">
													...
													<div style="width:100%">
														<div style="width:70%;float:left;">
															<select class="form-control" autofocus  name='txt_ledger_name[]' id='txt_ledger_name1' data-toggle="tooltip" data-placement="top" title="ledger Name" onchange="findFlowUser()" >
														</select>
														</div>
