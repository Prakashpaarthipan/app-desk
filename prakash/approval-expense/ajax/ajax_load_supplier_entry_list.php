              ...
              <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    $sel=select_query_json("select ap.* from approval_product_quotation_fix ap where ap.TARNUMB='".$tarnum."' and  ap.PRDCODE='".$prdcode."' and ap.DEPCODE='".$depcode."' and ap.SUBCODE='".$subcode."' and ap.DELETED='N' order by ap.supsrno desc",'Centra','TEST');
                                    if($sel){
                                      $count=1;
                                      $i=0;
                        ...
                        <? $supname = select_query_json("select supcode,supname from supplier_asset where supcode = '".$value['SUPCODE']."' and DELETED = 'N'","Centra","TEST");?>     
                                      ...
                                      <div class="col-md-1 col-sm-1" style="width:100px">
                                          ...
                                          <div class="col-md-1 col-sm-1" style="width:100px" >
                                              <input type="text" class="form-control" id="cess_<?=$i?>" name="cess1[]"  value='<?=$value['PRDQTY']?>'/>
                                          </div><!-- IGSTt -->
                          ...
                          <a href = "../approval-desk/ftp_image_view_pdf.php?pic=<?=$value['SUPQFILE']?>&path=approval_desk/product_quotation_fix/2018-19/" target="_blank" ><?if($value['SUPQFILE'] != ''){echo $value['SUPQFILE'];}else{echo "No Attchment";}?> </a>
                                    ...
                                    <? }
                                      ...
                                      <div class="col-md-1 col-sm-1" style="width:300px"  >
                                          <input type="text" class="form-control required"  id ="slp_load_1"  name="slp_load[]" style="text-transform: uppercase;" maxlength="100" required onblur="return fix_state(this);"/>
                                          <input type="hidden" name="supplierstate" value='' id='supstate_1'/>
                                      </div><!-- supplier -->
                                      <div class="col-md-1 col-sm-1" style="width:100px">
                                          <input type="text" class="form-control required" id="duration_1" name="duration[]" onkeypress="javascript:return isNumber(event);" style="text-transform: uppercase;" onblur ="javascript:return valueNotZero(this);return fix_tax(this);" maxlength="3" required />
                                      </div><!-- duration -->
                                      <div class="col-md-1 col-sm-1" style="width:120px">
                                          <input type="text" class="form-control required" id="rate_1" name="rate[]" onkeypress="javascript:return validateFloatKeyPress(this,event);return isNumber(event);" onblur ="javascript:return valueNotZero(this)" style="text-transform: uppercase;" maxlength="10" required />
                                      </div><!-- rate -->
                                      <div class="col-md-1 col-sm-1"style="width:100px">
                                      ...
                                      <div class="col-md-1 col-sm-1" style="width:100px">
                                             <input type="text" class="form-control" id="cgst_1" name="cgst[]" onkeypress="javascript:return validateFloatKeyPress(this,event);return isNumber(event);"  maxlength="5" oninput ='checkNumber(this)'/>
                                          </div><!-- CGST -->
                                          <div class="col-md-1 col-sm-1" style="width:100px" >
                                              <input type="text" class="form-control" id="sgst_1" name="sgst[]" onkeypress="javascript:return validateFloatKeyPress(this,event);return isNumber(event);" maxlength="5" oninput ='checkNumber(this)' />
                                          </div><!-- SGST -->
                                          <div class="col-md-1 col-sm-1" style="width:100px" >
                                              <input type="text" class="form-control" id="igst_1" name="igst[]" onkeypress="javascript:return validateFloatKeyPress(this,event);return isNumber(event);" maxlength="5" oninput ='checkNumber(this)' />
                                          </div><!-- IGSTt -->
                                          <div class="col-md-1 col-sm-1" style="width:100px" >
                                              <input type="text" class="form-control" id="cess_1" name="cess[]" onkeypress="javascript:return validateFloatKeyPress(this,event);return isNumber(event);" maxlength="5" oninput ='checkNumber(this)' />
                                          </div><!-- IGSTt -->
                                          <div class="col-md-1 col-sm-1" style="width:200px" >                                                                                      
