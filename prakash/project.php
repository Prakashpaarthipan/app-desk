...
if($inner_menuaccess[0]['VEWVALU'] == 'Y') { // Menu Permission is allowed ?>
                    ...
                    <div class="panel panel-default">
						...
						<div class="form-group trbg" style='min-height:40px; padding-top:10px'>
							<div class="col-lg-12 col-md-12" style=' text-align:center; padding-right:10px;'>
							  ...
							  <input type="button" class="btn btn-success" name="btn_submit" id="btn_submit" value="Submit" onclick="insertdb()"/>-->
	...
	<script type="text/javascript">
        ...
        <script type="text/javascript">
			...
			*/
			$(function(){
				$('#frm_project_creation').validate({
					rules:{
							txt_branch_type :{required:true},
							txt_mode_type:{required:true}
