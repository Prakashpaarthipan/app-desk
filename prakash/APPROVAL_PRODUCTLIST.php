...
foreach($PRJCODE  as $val)
{
 ...
 $file['PRDCODE'] = $val['PRDCODE'];                 
 $file['PRDNAME'] = $val['PRDNAME'];                 
 $file['PRDSPEC'] = $val['PRDSPEC'];                 
 $file['SUBCODE'] = $val['SUBCODE'];                          
 $file['SUBNAME'] = $val['SUBNAME'];                          
 $file['TOTLQTY'] = $val['TOTLQTY'];                 
 $file['TOTLVAL'] = $val['TOTLVAL'];                 
 $file['PRLSTYR'] = $val['PRLSTYR'];                 
 $file['PRLSTNO'] = $val['PRLSTNO'];                 
 $file['ADURATI'] = $val['ADURATI'];                          
 $file['ADLENGT'] = $val['ADLENGT'];                          
 $file['ADWIDTH'] = $val['ADWIDTH'];                          
 $file['ADLOCAT'] = $val['ADLOCAT'];                          
 $file['UNTCODE'] = $val['UNTCODE'];                          
 $file['UNTNAME'] = $val['UNTNAME'];                          
 $file['USESECT'] = $val['USESECT'];                          
 $file['BPLYEAR'] = $val['BPLYEAR'];                          
 $file['BPLNUMB'] = $val['BPLNUMB'];                          
 $file['NRQYEAR'] = $val['NRQYEAR'];                          
 $file['NRQNUMB'] = $val['NRQNUMB'];                          
 $file['PRDIMAG'] = $val['PRDIMAG'];                          
 $file['REJRESN'] = $val['REJRESN'];                          
 $file['REJUSER'] = $val['REJUSER'];                          
 $file['REJDATE'] = $val['REJDATE'];                          
 $file['PRODHSN'] = $val['PRODHSN'];                          
 $file['SPRDHSN'] = $val['SPRDHSN'];                          
 $file['PRDDEDT'] = 'dd-Mon-yyyy HH:MI:SS AM~~'.date("d-M-Y h:i:s A", strtotime($val['PRDDEDT']));                    
 $file['PRDEDDT'] = 'dd-Mon-yyyy HH:MI:SS AM~~'.date("d-M-Y h:i:s A", strtotime($val['PRDEDDT']));                           
