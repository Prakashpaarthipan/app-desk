...
<body>
    ...
    <div class="page-container page-navigation-top-fixed">
        ...
        <div class="page-content">
            ...
            <!--<form class="form-horizontal" role="form" id="frm_request_entry" name="frm_request_entry" action="viki/insert_req.php" method="post" enctype="multipart/form-data">    viki/insert_req.php-->
										...
										<div class="row">
											<div class="col-md-6">
											   ...
											   <div class="form-group">
													...
													<div class="col-md-9"  >
														<select class="form-control custom-select chosn" autofocus tabindex='1' required name='txtTopcore' id='txtTopcore' onChange="find_tags();" data-toggle="tooltip" data-placement="top" data-original-title="Top Core" >
												...
												<div class="form-group">                                        
													<label class="col-md-3 control-label" id='attachment'>Title</label>
                                                ...
                                                <div class="col-md-9 col-xs-12">
													...
													<span class="help-block">NOTE : ENTR THE TITLE</span>
										...
										<div class="tags_clear"></div>
											<div class="row">
												...
												<div class="col-md-12">
															...
															<textarea name="FCKeditor1" id="FCKeditor1" tabindex='14' onblur="find_tags();">
