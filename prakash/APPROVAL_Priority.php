...
extract($_REQUEST);
		...
		$PRJCODE = select_query_json("select * from APPROVAL_Priority","Centra","TCS");
...
foreach($PRJCODE  as $val)
{
 ...
 $file['PRISRNO'] = $val['PRISRNO'];                
 $file['PRINAME'] = $val['PRINAME'];                
