                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading">
                                    <h3 class="panel-title">TEST PRODUCT SUPPLIER</h3>                                   
                                </div>
                                          ...
                                          <div class="form-group">
                                            <label class="col-md-3 control-label" style="padding-top:10px">Choose Sub-Product <span style='color:red'>*</span></label>
                                              ...
                                              <div class="col-md-9">
                                                        ...
                                                        <select class="form-control custom-select chosn" autofocus tabindex='1' required name='slt_subproduct' id='slt_subproduct' data-toggle="tooltip" data-placement="top" data-original-title="Project" required onChange="getsuppliertable(this.value)" data-toggle="tooltip" data-placement="top" data-original-title="Type of Product" style="padding:10px">
              ...
              <div class="row">
                        <div class="col-md-12">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div id="list_content" style="margin-bottom: 20px;padding: 10px;margin-left: 1%;margin-right: 1%;">
                                      ...
                                      <div class="col-md-1 col-xs-3">
                                          <input type="text" class="form-control" id="duration_1" name="duration[]" style="text-transform: uppercase;" maxlength="2" required />
                                      </div><!-- duration -->
                                      <div class="col-md-1 col-xs-3">
                                          <input type="text" class="form-control" id="rate_1" name="rate[]" style="text-transform: uppercase;" maxlength="8" required />
                                      </div><!-- rate -->
                                      <div class="col-md-1 col-xs-3">
                                          <input type="text" class="form-control" id="discount_1" name="discount[]" style="text-transform: uppercase;" maxlength="2" required />
                                      </div><!-- discount -->
                                      <div class="col-md-1 col-xs-3">
                                          <input type="text" class="form-control" id="qty_1" name="qty[]" style="text-transform: uppercase;" maxlength="5" required />
                                      </div><!-- Qty -->
                          ...
                          <!-- <div style="width: 50%">welcomd.jpg</div> -->
                                  ...
                                  <button class="btn btn-primary " type="button"   onclick="javascript:supplierquote();"><span class="fa fa-save"></span> Save</button>
                                </div>
                              </form>  
                                 </div>
                                   </div>   
