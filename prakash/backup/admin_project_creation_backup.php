                                ...
                                <div class="col-lg-12 col-md-12 tooltip-demo" style='border-right: 1px solid #d4d4d4;'>
                                    ...
                                    <div class="form-group trbg">
                                        <div class="col-lg-3 col-md-3">
                                            <label style='height:27px;'>Process Type <span style='color:red'>*</span></label>
                                        </div>
                                        <div class="col-lg-3 col-md-3">
                                            <select class="form-control" autofocus required name='txt_process_type' id='txt_process_type' data-toggle="tooltip" data-placement="top" title="Process Type" onchange="choose_listing(this.value)">
                                                <option value="1" SELECTED>ORIGINAL APPROVAL NEED</option>
                                                <? /* <option value="2">APPROVAL AUTO FORWARD</option>
                                                <option value="3">PROJECT ID CHANGE, AFTER APPROVAL</option> */ ?>
                                            </select>
                                        </div>
