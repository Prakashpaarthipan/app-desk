                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                          <? $sql_reqid = select_query_json("select * from APPROVAL_TOPCORE where ATCCODE = '".$_REQUEST['reqid']."' order by ATCCODE", "Centra", "TCS"); ?>
                            <form role="form" id='frm_project_creation' name='frm_project_creation' action='' method='post' enctype="multipart/form-data">
                              ...
                              <?
                                ...
                                ?>
									...
									<div class="col-sm-6">
										...
										<label style="height:40px;padding-top:5px;padding-left:10px" >Project Name: <span style="font-weight:bold;font-size:16px;color:#e04b4a; margin-left:30px;"> <?echo $admin_project[0]['PRJNAME']." - " .$admin_project[0]['PRMSCOD'];?></span></label>
										</div>
									</div>
									<div class="col-sm-6">
									...
									<form role="form" id='frm_project_creation' name='frm_project_creation' method='post' enctype="multipart/form-data" >
                                                      ...
                                                      foreach($sql_timer as $key => $timer_value) {
                                                                ...
                                                                <div class="form-group input-group">
                                  																<div style="width:100%">
                                  																	<div style="width:70%;float:left;">
                                  																	 <input type = "text" name ='txt_ledger_name[]' class="form-control" value="<?echo $timer_value['TARNUMB']." - ".$timer_value['TARNAME'];?>"  disabled style="background:#fff">
                                  																	...
                                  																	<div style="width:30%;float:right">
                                  																		<input type="text" name = "txt_value[]" class="form-control" value="<?echo $timer_value['PRJVALU'];?>" disabled style="background:#fff">
                                  																	</div>
                                  																</div>
                                                                  <span class="input-group-btn"><button id="add_ledger_button" type="button"  class="btn btn-danger btn-remove">-</button>
                                                                  </span>
                                                                </div>
                                    														<script>
                                                              ...
                                                              <?}?>
                                                                ...
                                                                <div style="width:100%">
                                                                    ...
                                                                    </select>-->Press + to Add more
                                                                    </div>
                                                                    <div style="width:30%;float:right">
                                                                       <!-- <input type="text" name = 'txt_value[]' class="form-control" id='txt_value' placeholder= "Value" >-->
                                        ...
                                        <div class="col-lg-8 col-md-8">
                                            <input type="text" value="<?if ($admin_project[0]['BRN_PRJ'] == "B"){ echo 'BRANCH'; } else {echo 'NEW PROJECT';}?>" class="form-control" disabled style="background:#fff"/>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="row form-group ">
                                                ...
                                                <div class="col-lg-8 col-md-8">
                                                    ...
                                                    <input type='text' name='txt_project_name' value='<?echo $admin_project[0]['PRJNAME'];?>' class='form-control' disabled  style="background:#fff">
                                                </div>
                                            </div>
                                            <div class="row form-group ">
                                                <div class="col-lg-4 col-md-4">
                                                ...
                                                <div class="col-lg-8 col-md-8">
                                                  <div id="add_emp" class="form-group">
                                                    ...
                                                    <?
                                                      $sql_timer = select_query_json("select * from approval_project_head where PRMSYER = '".$c_year."' and PRMSCOD = '".$id."' and PRJTITL = '1' and DELETED = 'N'", "Centra", "TEST");
                                                      foreach($sql_timer as $key => $timer_value) {
                                                    ?>
                                                      <div class="form-group input-group">

                                                        <input type="text" name="txt_project_owner[]" id="txt_project_owner" maxlength="50" value="<?echo $timer_value['EMPCODE']." - ".$timer_value['EMPNAME'];?>" placeholder="SELECT THE PROJECT OWNER" title="select the project owner" class="form-control find_empcode" data-toggle="tooltip" data-placement="top" style=" text-transform: uppercase; padding: 2px;">
                                                        <span class="input-group-btn"><button id="add_emp_button" type="button" class="btn btn-danger btn-remove">-</button></span>
                                                      ...
                                                      <?}?>
                                                        ...
                                                        <div class="form-group input-group">
                                                          ...
                                                          <input type="text" name="txt_project_owner[]" id="txt_project_owner" value="" placeholder="SELECT THE PROJECT OWNER" title="select the project owner" class="form-control find_empcode" data-toggle="tooltip" data-placement="top" style=" text-transform: uppercase; padding: 2px;">
                                            ...
                                            <div class="row form-group ">
                                                ...
                                                <div class="col-lg-8 col-md-8">
                                                     <div id="add_emp1" class="form-group">
                                                       ...
                                                       <?
                                                      $sql_timer = select_query_json("select * from approval_project_head where PRMSYER = '".$c_year."' and PRMSCOD = '".$id."' and PRJTITL = '2' and DELETED = 'N'", "Centra", "TEST");
                                                      foreach($sql_timer as $key => $timer_value) {
                                                    ?>
                                                        <div class="form-group input-group">

                                                          <input type="text" name="txt_project_head[]" id="txt_project_head" value="<?echo $timer_value['EMPCODE']." - ".$timer_value['EMPNAME'];?>" placeholder="SELECT THE PROJECT HEAD" title="select the project head" class="form-control find_empcode" data-toggle="tooltip" data-placement="top" style=" text-transform: uppercase; padding: 2px;">
                                                          <span class="input-group-btn"><button id="add_emp_button" type="button" class="btn btn-danger btn-remove">-</button></span>
														  </div>
                                                           <script>
                                                            $( document ).on( 'click', '.btn-remove', function ( event ) {
                                                          ...
                                                          <input type="text" name="txt_project_head[]" id="txt_project_head" value="" placeholder="SELECT THE PROJECT HEAD" title="select the project head" class="form-control find_empcode" data-toggle="tooltip" data-placement="top" style=" text-transform: uppercase; padding: 2px;">
                                            ...
                                            <div class="row form-group ">
                                                ...
                                                <div class="col-lg-8 col-md-8">
                                                        ...
                                                        <input type="hidden" name="partint3" id="partint" value="1">
                                                        <?
                                                      $sql_timer = select_query_json("select * from approval_project_head where PRMSYER = '".$c_year."' and PRMSCOD = '".$id."' and PRJTITL = '3' and DELETED = 'N'", "Centra", "TEST");
                                                      foreach($sql_timer as $key => $timer_value) {
														?>

                                                        <div class="form-group input-group">

                                                          <input type="text" name="txt_project_member[]" id="txt_project_member" value="<?echo $timer_value['EMPCODE']." - ".$timer_value['EMPNAME'];?>" placeholder="SELECT THE PROJECT MEMBER" title="select the project member" class="form-control find_empcode" data-toggle="tooltip" data-placement="top" style=" text-transform: uppercase; padding: 2px;">
                                                        ...
                                                        <div class="form-group input-group">
                                                          ...
                                                          <input type="text" name="txt_project_member[]" id="txt_project_member"  placeholder="SELECT THE PROJECT MEMBER" title="select the project member" class="form-control find_empcode" data-toggle="tooltip" data-placement="top" style=" text-transform: uppercase; padding: 2px;">
                                    ...
                                    <div class="form-group trbg" style='min-height:40px; padding-top:10px'>
                                        <div class="col-lg-12 col-md-12" style=' text-align:center; padding-right:10px;'>
                                            <button type="submit" id="approve_btn" tabindex='2' class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Modify"><i class="fa fa-save"></i> Approve</button>
                                            <!-- <input type="submit" class="btn btn-success" id = "modify_btn"/> -->
                                            <button type="reset" id="" tabindex='3' class="btn btn-danger" data-toggle="tooltip" data-placement="top" onclick=" window.location.reload();" title="Reset"><i class="fa fa-times"></i> Reset</button>
                                        </div>
                                    <div class='clear clear_both'>&nbsp;</div>
    ...
    <script type="text/javascript" src="js/angular-route-segment.min.js"></script>
		...
		//<script>
			...
			$("#reject-button").click(function(e){
				e.preventDefault();
				var id = <?echo $admin_project[0]['PRMSCOD'];?>;
			...
			var id1 = <?echo $admin_project[0]['PRMSCOD'];?>;
			if(confirm("Do you want to approve the project?")){
       ...
       function subject_addnew4() {
        ...
        $('#add_ledger').append(
              '<div class="form-group input-group">'+
                '<div style="width:100%">'+
                    '<div style="width:70%;float:left;">'+
                        '<select class="form-control" autofocus required name="txt_ledger_name_new[]" id="txt_ledger_name_new'+id+'" data-toggle="tooltip" data-placement="top" title="Ledger Name" ></select>'+
                    '</div>'+
                    '<div style="width:30%;float:right">'+
                        '<input type="text" name = "txt_value_new[]" id= "txt_value_new'+id+'"class="form-control" placeholder= "Value" required>'+
                    '</div>'+
                '</div>'+
              ...
              '</div>');
                 ...
                 $.ajax({
                    ...
                    success:function(response){
                     var len = response.length;
                     // $("#txt_ledger_code").append("<option value='' selected hidden>CHOOSE THE LEDGER CODE</option>");
                     $("#txt_ledger_name_new"+id).append("<option value='' selected hidden>CHOOSE THE LEDGER NAME</option>");

                     for( var i = 0; i<len; i++){
                      var idd = response[i]['id'];
                      var name = response[i]['name'];
                      // $("#txt_ledger_code").append("<option value='"+id+"'>"+id+"</option>");
                      $("#txt_ledger_name_new"+id).append("<option value='"+name+"'>"+name+"</option>");
    ...
    function subject_addnew1() {
        ...
        $('#add_emp1').append(
          '<div class="form-group input-group">'+
            ...
            '<input type="text" name="txt_project_head[]" id="txt_project_head'+id+'" required="required" maxlength="50" placeholder="SELECT THE PROJECT HEAD"  class="form-control find_empcode" data-toggle="tooltip" data-placement="top" style=" text-transform: uppercase; padding: 2px;">'+'<span class="input-group-btn"><button id="add_emp_button" type="button" class="btn btn-danger btn-remove">-</button></span>'+
          '</div>');
    ...
    function subject_addnew2() {
        ...
        $('#add_emp2').append(
          '<div class="form-group input-group">'+
            ...
            '<input type="text" name="txt_project_member[]" id="txt_project_member'+id+'" required="required" maxlength="50" placeholder="SELECT THE PROJECT MEMBER"  class="form-control find_empcode" data-toggle="tooltip" data-placement="top" style=" text-transform: uppercase; padding: 2px;">'+'<span class="input-group-btn"><button id="add_emp_button" type="button" class="btn btn-danger btn-remove">-</button></span>'+
          '</div>');
