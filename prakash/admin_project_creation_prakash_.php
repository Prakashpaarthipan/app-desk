                ...
                <div class="page-content-wrap">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                          ...
                          <form role="form" id='frm_project_creation' name='frm_project_creation' action="prakash/insert_project.php" method='post' enctype="multipart/form-data" >
        ...
        <script type="text/javascript">
            ...
            /* $('#btn_submit').click(function(event)
                ...
                // function insertTo(){
                    ...
                    var result = $('#frm_project_creation').serializeArray();
					 alert (result);
                      $.ajax({
