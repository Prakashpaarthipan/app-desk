...
function updateprocess(e,process,id,znecode,znepcde,poryear,pornumb,pordate,supcode,porqty,porval,prostat,empsrno,status){
  ...
  e.stopPropagation();
$('#load_page').show();
  var flag=0;var proval='';
  $('.processstat'+id).each(function(){
    $(this).next('.processlabel').removeClass('blink');
    $(this).next('.processlabel').css('visibility', 'visible');
});
  $('.processstat'+id).each(function(){
    $(this).next('.processlabel').removeClass('blink');
    $(this).next('.processlabel').css('visibility', 'visible');
    if($(this).prop('checked')==true){
      console.log('enter');
      flag=1;
      $(this).next('.processlabel').addClass('blink');
      proval=$(this).val();
    }
...
function getemployee(event,id,znecode,znepcde,poryear,pornumb,pordate,supcode,porqty,porval,prostat,empsrno){
	$(".chosn").customselect();
