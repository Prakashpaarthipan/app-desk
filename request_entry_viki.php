...
if($inner_menuaccess[0]['VEWVALU'] == 'Y') { // Menu Permission is allowed
    ...
    <body>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                                        ...
                                                        <div class="col-md-9 col-xs-12">
                                                            <?  if(count($sql_emp) > 1) {
                                                                ...
                                                                if($_REQUEST['action'] == 'view') {
                                                                    ...
                                                                    <input type='text' class="form-control" style="text-transform: uppercase;" tabindex='7' onblur="getapproval_listings()" name='txt_rate_finalized' id='txt_rate_finalized' data-toggle="tooltip" data-placement="top" data-original-title="Rate Finalized By User" value='<?=$emcd." - ".$emnm." - ".substr($senm, 3)?>'>
                                                            <?  } ?>
                                                        </div>
                                                    </div>
                                                    <div class="tags_clear"></div>
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <? if($_REQUEST['action'] == 'edit' or $_REQUEST['action'] == 'view') { ?>
                                                        <div class="form-group trbg">
                                                            ...
                                                            <div class="col-lg-9 col-xs-9" id="app_list" style="font-weight:bold;">
                                                                : <? $flo = 0; $newentry = 0;
                                                            ...
                                                            <div class="row" style="margin-right: -5px; min-height: 25px; display: flex; background-color: #FFFFFF; text-transform: uppercase;">
                                                                ...
                                                                <div class="col-sm-3 colheight" style="padding: 1px 0px;">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <input type="text" name="txt_prdpur[]" id="txt_prdpur_<?=$inc?>" onblur="find_tags();" value="<?=$prdlist['PRDSPEC']?>" required="required" maxlength="100" placeholder="Purpose Of Product Usage" onKeyPress="enable_product();" data-toggle="tooltip" data-placement="top" title="Purpose Of Product Usage" class="form-control supquot find_prdspec" onBlur="validate_prdspcempty(<?=$inc?>)" style=" text-transform: uppercase;height: 25px;">
                                                                    </div>
                                                                    <div style="clear: both;"></div>
                                ...
                                <div class="panel-footer">
                                    ...
                                    <? } else { ?>
                                        <button type="button" name='sbmt_request' id='sbmt_request' tabindex='40' value='submit' class="btn btn-success pull-right" data-toggle="tooltip" data-placement="top" onclick="return checkform()" title="Submit" style="padding: 6px 12px;"><i class="fa fa-save"></i> Submit</button>
                                    <? } ?>
        ...
        function add_flow(){
            var rate_finalized_usr=$('#txt_rate_finalized').val();
            rate_finalized_usr=rate_finalized_usr.split(' - ');
            console.log(rate_finalized_usr);
            if(typeof rate_finalized_usr[2] != 'undefined')
            {
                var hid_appuser =$('#hid_appuser').val();
                $('#hid_noofdays').val($('#hid_noofdays').val()+1);
                //console.log(rate_finalized_usr);
                console.log("working else");
                $('#id_app_list').prepend(rate_finalized_usr[1]+' - '+rate_finalized_usr[0]+" [ 1 Day(s) ]<br>");
                var str=rate_finalized_usr[0]+"~~"+hid_appuser;
                hid_appuser=str;
                $('#hid_appuser').val(hid_appuser);
                ...
                if( ($('.parts3 .part3').length+1) > 99) {
                    ...
                    var apnd_content = '<div class="part3" style="margin-right: -5px; text-transform: uppercase;">'+
                                            ...
                                            '<div class="col-sm-3 colheight" style="padding: 1px 0px;">'+
                                                ...
                                                '<div>'+
                                                    '<input type="text" name="txt_prdpur[]" id="txt_prdpur_'+id+'" required="required" maxlength="100" placeholder="Purpose Of Product Usage" data-toggle="tooltip" data-placement="top" onKeyPress="enable_product();" title="Purpose Of Product Usage" class="form-control supquot find_prdspec" onBlur="validate_prdspcempty('+id+'); find_tags();" style=" text-transform: uppercase;height: 25px;">'+
                                                '</div><div style="clear: both;"></div>'+
                                                '<div>'+
                                                    '<!-- Product Image -->'+
 ...
 //  error
        ...
        // function checkform() {viki

        $("#sbmt_request").click(function(e){
             //alert("changed");
            var slt_targetno = $("#slt_targetno").val();
            var slt_submission = $("#slt_submission").val();
            console.log(slt_targetno);
            console.log(slt_submission);
            return true;
            $('#load_page').show();
