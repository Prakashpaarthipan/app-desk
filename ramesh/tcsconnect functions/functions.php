...
$sql_brn = select_query_json_test("Select end.*,c.ctyname,esec.eseNAME From employee_notice_detail end,empsection esec,city c,branch b 
	...
	echo "<div class='container'>
		...
		<div class='row sign' style='margin-top:100px'>
			<div class='col-md-12'>
			<table style='width:100%' class='signature'>".($_REQUEST['all'] == 4?".$sign1.":"").($_REQUEST['authby']=='43400'?".$sign2.":"").($_REQUEST['authby']=='452'?".$sign3.":"").($_REQUEST['authby']=='21344'?".$sign4.":"").($_REQUEST['authby']=='20118'?".$sign5.":"")."
