                        ...
                        <div class="panel-body" style="overflow-x: scroll !important;">
                            <div class="form-group trbg non-printable">
                                <form role="form" id='frm_request_entry' name='frm_request_entry' action='' method='post' enctype="multipart/form-data">
                                   ...
                                   <div class="col-lg-2 col-sm-3" style='text-align:center; padding:5px 5px 0 0;margin-left:10px;width:400px;' >
								    <select class="form-control custom-select chosn"  tabindex='1'  name='slt_approval_listings' id='slt_approval_listings' data-toggle="tooltip" data-placement="top" data-original-title="Approval Subject">
                                                            <option value=''>Choose Approval Subject</option>
                                          <?$approval_list = select_query_json("select APMCODE,ATYCODE,ATMCODE,APMNAME from approval_master where DELETED = 'N' and APMCODE > 965","Centra","TCS");
												foreach($approval_list as $key => $apm){?>
												<option value='<?=$apm['APMCODE']?>'><?=$apm['APMCODE']?> - <?=$apm['APMNAME']?></option>	
												<?}
										  ?>                  
                                     </select>
                                    ...
                                    <div class="col-lg-2 col-sm-3" style='text-align:center; padding:5px 5px 0 5px;'>
                                        <input type='text' class="form-control" tabindex='2' name='search_aprno' id='search_aprno' value='<?=$_REQUEST['search_aprno']?>' maxlength="100" data-toggle="tooltip" data-placement="top" placeholder='Approval No' title="Approval No" style='text-transform: uppercase;'>
                                    </div>

                                    <div class="col-lg-2 col-sm-3" style='text-align:center; padding:5px;'>
                                        <input type='text' class="form-control" tabindex='3' name='search_value' id='search_value' value='<?=$_REQUEST['search_value']?>' data-toggle="tooltip" data-placement="top" maxlength="10" placeholder='Value' title="Value" style='text-transform: uppercase;'>
                                    </div>
                                    ...
                                    <div class="col-lg-1 col-sm-1" style='text-align:left; padding:5px;'>
                            ...
                            <table id="customers2" class="table datatable" style="overflow-x: scroll !important;">
                                ...
                                <tbody>
                                <?  $and = "";
										if($slt_approval_listings !=''){
											$and.=" And ar.APMCODE ='".$slt_approval_listings."' ";
										}
                                        if($search_aprno != '') {
                                    ...
                                    if($and != '') {
                                        $sql_search = select_query_json("select distinct ar.APRNUMB, ar.APPSTAT, ar.APPRSUB, ar.APPFVAL, ar.APRTITL, ar.ARQCODE, ar.ATYCODE, ar.ATCCODE,
                                                                                ...
                                                                                order by APPORDER asc, ar.adddate asc, APRNUMB desc", "Centra", 'TEST');
                                    }
