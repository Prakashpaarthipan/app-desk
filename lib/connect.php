...
try{
	...
	if($hidrequest_value != $txtrequest_value) {
		...
		// echo "<br>++".$server_file = 'approval_desk_test/text_approval_source/'.$lpdyear.'/'.$srno."/".$txt_srcfilename;
		$server_file = 'approval_desk_test/text_approval_source/'.$lpdyear.'/'.$txt_srcfilename;
		echo "<br>%%".$ftp_conn;
		echo "<br>$$".$server_file;
		echo "<br>##".$local_file;
	...
	for($keybrn = 0; $keybrn < count($slt_brnch); $keybrn++) { // branch for loop
		...
		//////////////////
		 if($insert_appreq == 1 and ($slt_approval_listings==955 or $slt_approval_listings==954 ))
			{
			$f_table = "APPROVAL_SALARY";
		$f_fld = array();
                $f_fld['APRYEAR'] = $current_year[0]['PORYEAR'];
				$f_fld['APRNUMB'] = $apprno;
				$f_fld['POLSUBJ'] = $txt_dynamic_subject;			
				$f_fld['EFFDATE'] = 'dd-Mon-yyyy HH:MI:SS AM~~'.$current_date;
				$f_fld['POLTYPE'] = $txt_dynamic_policy_type;
				$f_fld['VALUPTO'] = 'dd-Mon-yyyy HH:MI:SS AM~~'.$current_date;
				$f_fld['CRENAME'] = $txt_dynamic_creator;
                $f_fld['APPDATE'] = 'dd-Mon-yyyy HH:MI:SS AM~~'.$current_date;
				$f_fld['COONAME'] = $txt_dynamic_coordinator;
				$f_fld['USELIST'] = $txt_dynamic_userlist;
				$f_fld['ASISTBY'] = $txt_dynamic_asistby;
				$f_fld['DESKPRO'] = '0';
				$f_fld['POLIDOC'] =  $txt_dynamic_policy_docs;
				$f_fld['FILEPOL'] = '0';
				//print_r($g_fld);
					...
					if($txt_prdcode[$pdi] != '') {
						...
						if($_FILES['fle_prdimage']['type'][$pdi] == "image/jpeg" or $_FILES['fle_prdimage']['type'][$pdi] == "image/gif" or $_FILES['fle_prdimage']['type'][$pdi] == "image/png" or $_FILES['fle_prdimage']['type'][$pdi] == "application/pdf") {
								...
								if($fldimli == 'i')
								{
									...
									$dest_thumbfile = "approval_desk_test/product_images/".$uploadimg."/thumb_images/".$complogos1_tmp;
									...
									$server_file = 'approval_desk_test/product_images/'.$uploadimg.'/thumb_images/'.$complogos1;
								...
								$server_file = 'approval_desk_test/product_images/'.$uploadimg.'/'.$complogos1;
								if ((!$conn_id) || (!$login_result)) {
									$upload = ftp_put($ftp_conn, $server_file, $local_file, FTP_BINARY);
									// echo "lar Succes";
									unlink($local_file);
						...
						for($qdi = 0; $qdi < count($txt_sltsupcode[$pdii]); $qdi++) { // echo "***";
							...
							if($_FILES['fle_supquot']['type'][$pdii][$qdi] == "image/jpeg" or $_FILES['fle_supquot']['type'][$pdii][$qdi] == "image/gif" or $_FILES['fle_supquot']['type'][$pdii][$qdi] == "image/png" or $_FILES['fle_supquot']['type'][$pdii][$qdi] == "application/pdf") {
								...
								if($fldimli == 'i')
								{
									...
									$resized_file = "uploaded_files/thumb_images/". $complogos1_tmp;
									$dest_thumbfile = "approval_desk_test/product_quotation/".$uploadimg."/thumb_images/".$complogos1_tmp;
									imagejpeg($tmp1, $resized_file, 50);
									imagedestroy($image1);
									imagedestroy($tmp1);
									// echo "^^^".$source_tmp."^^".$dest_thumbfile."^^".'<br>';
									...
									// exit;
									$local_file = "uploaded_files/thumb_images/".$complogos1_tmp;
									$server_file = 'approval_desk_test/product_quotation/'.$uploadimg.'/thumb_images/'.$complogos1;
								...
								$server_file = 'approval_desk_test/product_quotation/'.$uploadimg.'/'.$complogos1;
								if ((!$conn_id) || (!$login_result)) {
									$upload = ftp_put($ftp_conn, $server_file, $local_file, FTP_BINARY);
									// echo "lar Succes";
									unlink($local_file);
					...
					if($assign[$i] != '')
					{
						...
						if($_FILES['txt_submission_fieldimpl']['type'][$i] == "image/jpeg" or $_FILES['txt_submission_fieldimpl']['type'][$i] == "image/gif" or $_FILES['txt_submission_fieldimpl']['type'][$i] == "image/png" or $_FILES['txt_submission_fieldimpl']['type'][$i] == "application/pdf") {
							...
							if($fldimli == 'i')
							{
								...
								$dest_thumbfile = "approval_desk_test/request_entry/fieldimpl/thumb_images/".$complogos1_tmp;
								imagejpeg($tmp1, $resized_file, 50);
								imagedestroy($image1);
								imagedestroy($tmp1);
								...
								$server_file = 'approval_desk_test/request_entry/fieldimpl/thumb_images/'.$complogos1;
								// exit;
							...
							$server_file = 'approval_desk_test/request_entry/fieldimpl/'.$complogos1;
					...
					if($assign0[$i] != '')
					{
						...
						if($_FILES['txt_submission_othersupdocs']['type'][$i] == "image/jpeg" or $_FILES['txt_submission_othersupdocs']['type'][$i] == "image/gif" or $_FILES['txt_submission_othersupdocs']['type'][$i] == "image/png" or $_FILES['txt_submission_othersupdocs']['type'][$i] == "application/pdf") {
							...
							if($fldimli == 'i')
							{
								...
								$resized_file = "../uploaded_files/". $complogos1_tmp;
								$dest_thumbfile = "approval_desk_test/request_entry/othersupdocs/thumb_images/".$complogos1_tmp;
								imagejpeg($tmp1, $resized_file, 50);
								imagedestroy($image1);
								imagedestroy($tmp1);
								...
								move_uploaded_file($source_tmp, $dest_thumbfile);
								$local_file = "../uploaded_files/".$complogos1_tmp;
								$server_file = 'approval_desk_test/request_entry/othersupdocs/thumb_images/'.$complogos1;
							...
							$server_file = 'approval_desk_test/request_entry/othersupdocs/'.$complogos1;
					...
					if($assign1[$i1] != '')
					{
						...
						if($_FILES['txt_submission_quotations']['type'][$i1] == "image/jpeg" or $_FILES['txt_submission_quotations']['type'][$i1] == "image/gif" or $_FILES['txt_submission_quotations']['type'][$i1] == "image/png" or $_FILES['txt_submission_quotations']['type'][$i1] == "application/pdf") {
							...
							if($qutat1i == 'i')
							{
								...
								$dest_thumbfile = "approval_desk_test/request_entry/quotations/thumb_images/".$complogos2_tmp;
								imagejpeg($tmp1, $resized_file, 50);
								imagedestroy($image2);
								imagedestroy($tmp1);
								...
								$server_file = 'approval_desk_test/request_entry/quotations/thumb_images/'.$complogos2_tmp;
							...
							$server_file = 'approval_desk_test/request_entry/quotations/'.$complogos2;
					...
					if($assign2[$i2] != '')
					{
						...
						if($_FILES['txt_submission_clrphoto']['type'][$i2] == "image/jpeg" or $_FILES['txt_submission_clrphoto']['type'][$i2] == "image/gif" or $_FILES['txt_submission_clrphoto']['type'][$i2] == "image/png" or $_FILES['txt_submission_clrphoto']['type'][$i2] == "application/pdf") {
							...
							if($smplpti == 'i')
							{
								...
								$dest_thumbfile = "approval_desk_test/request_entry/clrphoto/thumb_images/".$complogos7_tmp;
								imagejpeg($tmp1, $resized_file, 50);
								imagedestroy($image7);
								imagedestroy($tmp1);
								...
								$server_file = 'approval_desk_test/request_entry/clrphoto/thumb_images/'.$complogos7_tmp;
							...
							$server_file = 'approval_desk_test/request_entry/clrphoto/'.$complogos7;
					...
					if($assign3[$i3] != '')
					{
						...
						if($_FILES['txt_submission_last_approval']['type'][$i3] == "image/jpeg" or $_FILES['txt_submission_last_approval']['type'][$i3] == "image/gif" or $_FILES['txt_submission_last_approval']['type'][$i3] == "image/png" or $_FILES['txt_submission_last_approval']['type'][$i3] == "application/pdf") {
							...
							if($lstapri == 'i')
							{
								...
								$dest_thumbfile = "approval_desk_test/request_entry/lastapproval/thumb_images/".$complogos8_tmp;
								imagejpeg($tmp1, $resized_file, 50);
								imagedestroy($image8);
								imagedestroy($tmp1);
								...
								$server_file = 'approval_desk_test/request_entry/lastapproval/thumb_images/'.$complogos8_tmp;
							...
							$server_file = 'approval_desk_test/request_entry/lastapproval/'.$complogos8;
					...
					if($assign4[$i4] != '')
					{
						...
						if($_FILES['txt_submission_artwork']['type'][$i4] == "image/jpeg" or $_FILES['txt_submission_artwork']['type'][$i4] == "image/gif" or $_FILES['txt_submission_artwork']['type'][$i4] == "image/png" or $_FILES['txt_submission_artwork']['type'][$i4] == "application/pdf") {
							...
							if($lstapri == 'i')
							{
								...
								$dest_thumbfile = "approval_desk_test/request_entry/artwork/thumb_images/".$complogos9_tmp;
								imagejpeg($tmp1, $resized_file, 50);
								imagedestroy($image9);
								imagedestroy($tmp1);
								...
								$server_file = 'approval_desk_test/request_entry/artwork/thumb_images/'.$complogos9_tmp;
							...
							$server_file = 'approval_desk_test/request_entry/artwork/'.$complogos9;
