...
<center><font size="5px">POLICY-APPROVAL</font></center>
					   ...
					   <center><table border="2" ><center>
                                    ...
                                    <div id='id_policy_approval' style="padding-left: 10px; text-align: center; display: none;">
                                        <div class="parts3 fair_border">
                                            <div class="row colheight" style="margin-right: 0px; text-transform: uppercase; background-color: #666666; color:#FFFFFF; border-top-left-radius:5px; border-top-right-radius: 5px; line-height: 25px; font-weight: bold; text-align: center;">
											 ...
											 <thead><th colspan="2">
					                 <div class="row colheight" style="margin-right: 0px;width:100%; text-transform: uppercase; background-color: #666666; color:#FFFFFF;  line-height: 25px; font-weight: bold; text-align: center;">
                                                POLICY - APPROVAL  </div>                                   
                                            </th></thead>
											<tbody>
											<tr ><td colspan="2">
                                            <div class="row" style="margin-right: 0px; display: flex; text-transform: uppercase;">
                                                <div class="col-sm-2 colheight" style="padding: 2px; text-align: left; line-height: 28px;">POLICY SUBJECT : </div>
                                            ...
                                            <div class="row" style="margin-left: 0px; display: flex; text-transform: uppercase;">
                                                <div class="col-sm-4 colheight" style="padding: 2px; text-align: left; line-height: 30px;">EFFECTIVE DATE : </div>
                                                <div class="col-md-10 colheight" style="padding: 0px; line-height: 30px;width:350px;">
												<?  if($_REQUEST['action'] == 'view') {
                                                                echo ": ".$sql_reqid[0]["EFFDATE"];
                                                            } else { ?>
                                                    <input type="text" style="cursor: pointer; text-transform: uppercase; position: relative; top: auto; right: auto; bottom: auto; left: auto;width:350px;" class="form-control" required name="datepicker-example11" id="datepicker-example11" autocomplete="off" readonly="readonly" maxlength="18" tabindex="5" value='<? if($_REQUEST['search_fromdate'] != '') { echo $_REQUEST['search_fromdate']; } else { echo date("d-M-Y"); } ?>' data-toggle="tooltip" data-placement="top" placeholder="From Date" title=""  >
                                                   <?  } ?>
												</div></td><td>

                                                <div class="col-sm-5 colheight" style="padding: 2px; text-align: left; line-height: 30px;">POLICY TYPE : </div>
                                             ...
                                             <tr><td>
                                            <div class="row" style="margin-left: 0px; display: flex; text-transform: uppercase;">
                                                <div class="col-sm-4 colheight" style="padding: 6px; text-align: left; line-height: 30px;">VALID UPTO : </div>
                                                <div class="col-sm-7 colheight" style="padding: 0px; line-height: 30px;width:350px;">
                                                    <?  if($_REQUEST['action'] == 'view') {
                                                                echo ": ".$sql_reqid[0]["VALUPTO"];
                                                            } else { ?>
													<input type="text" style="cursor: pointer; text-transform: uppercase; position: relative; top: auto; right: auto; bottom: auto; left: auto; width:350px;" class="form-control" required name="datepicker-example12" id="datepicker-example12" autocomplete="off" readonly="readonly" maxlength="20" tabindex="10" value='' data-toggle="tooltip" data-placement="top" placeholder="To Date" title=""  >
                                                   <?  } ?>
												</div></td><td>

                                                <div class="col-sm-5 colheight" style="padding: 2px; text-align: left; line-height: 35px;">CREATOR EC NO \ NAME : </div>
                                                <div class="col-sm-7 colheight" style="padding: 0px; line-height: 35px;">
                                              ...
                                              <tr><td>
                                            <div class="row" style="margin-right: 0px; display: flex; text-transform: uppercase;">
                                                <div class="col-sm-4 colheight" style="padding: 6px; text-align: left; line-height: 30px;">APPROVAL DATE : </div>
                                                <div class="col-sm-7 colheight" style="padding: 0px; line-height: 30px; width:350px;">
                                               ...
                                               <input type="text" style="cursor: pointer; text-transform: uppercase; position: relative; top: auto; right: auto; bottom: auto; left: auto;width:350px;" class="form-control" required name="datepicker-example13" id="datepicker-example13" autocomplete="off" readonly="readonly" maxlength="11" tabindex="10" value="<? if($_REQUEST['search_fromdate'] != '') { echo $_REQUEST['search_fromdate']; } else { echo date("d-M-Y"); } ?>" data-toggle="tooltip" data-placement="top" placeholder="From Date" title=""  >
											   
												</div></td><td>

                                                <div class="col-sm-5 colheight" style="padding: 2px; text-align: left; line-height: 35px;">CO-ORDINATOR EC NO \ NAME : </div>
                                                <div class="col-sm-7 colheight" style="padding: 0px; line-height: 35px; ">
                                              ...
                                              <tr><td>
                                            <div class="row" style="margin-right: 0px; display: flex; text-transform: uppercase;">
                                                <div class="col-sm-4 colheight" style="padding: 2px; text-align: left; line-height: 30px;">USER LIST : </div>
                                                <div class="col-sm-7 colheight" style="padding: 0px; line-height: 30px;width:350px;">
                                               <select  class="form-control policy_approval_required" style="text-transform: uppercase;" required name='txtdynamic_uselist' id='txtdynamic_userlist' data-toggle="tooltip" data-placement="top" tabindex="10"> data-original-title="USER LIST"  value='<?=$sql_emp[0]['EMPCODE']." - ".$sql_emp[0]['EMPNAME']." - ".substr($sql_emp[0]['ESENAME'], 3)?>'>     
									...
									<option value='<?=$sql_emp[$sql_emp_i]['EMPCODE']?>'><?=$sql_emp[$sql_emp_i]['EMPCODE']." - ".$sql_emp[$sql_emp_i]['EMPNAME']." - ". $sql_emp[$sql_emp_i]['DESNAME']." - ".  $sql_emp[$sql_emp_i]['ESENAME'].""?></option>
                                                ...
                                                <div class="col-sm-5 colheight" style="padding: 2px; text-align: left; line-height: 35px;">ASSIST BY EC NO \ NAME : </div>
                                                <div class="col-sm-7 colheight" style="padding: 0px; line-height: 35px;">
									...
									<option value='<?=$sql_emp[$sql_emp_i]['EMPCODE']?>'><?=$sql_emp[$sql_emp_i]['EMPCODE']." - ".$sql_emp[$sql_emp_i]['EMPNAME'].""?></option>
                                            ...
                                            <div class="row" style="margin-left: 0px; display: flex; text-transform: uppercase;">
                                                ...
                                                <div class="col-sm-10 colheight" style="padding: 0px; line-height: 30px;">
                                                    <input type='file' class="form-control policy_approval_required" style="text-transform: uppercase;" required name='txtdynamic_deskpro' id='txtdynamic_deskprocedure' data-toggle="tooltip" data-placement="top" data-original-title="DESK PROCEDURE" value=''>
                                                </div></td></tr>
                                                <tr><td colspan="2">
										...
										<?  if($_REQUEST['action'] == 'view') {
										                ...
										                <input type="hidden" required name="hid_apprsub" id='hid_apprsub' value="<?=$sql_reqid[0]['APPRSUB']?>" onblur="find_tags();">
                                                        <textarea name="FCKeditor2" id="FCKeditor1" tabindex='14'>
                                                            <?  if($_REQUEST['action'] == 'edit') {
...
<!-- START SCRIPTS -->
    ...
    $('#datepicker-example11').Zebra_DatePicker({
      direction: false, // 1,
      format: 'd-M-Y',
      pair: $('#datepicker-example12')
    });

    $('#datepicker-example12').Zebra_DatePicker({
      direction: ['<?=strtoupper(date("d-M-Y", strtotime("+2 days")))?>', false],
      format: 'd-M-Y'
    });
