...
if($inner_menuaccess[0]['VEWVALU'] == 'Y') { // Menu Permission is allowed
    ...
    if($_REQUEST['action'] == "edit"){ ?>
        <script>window.location="request_duty_list.php";</script>
    <?php exit();
    }
    ...
    if($sql_rdsrno[0]['CNT'] > 1 && $action == 'edit') { ?>
        <script>alert('Already This request went for Approval / You dont have rights to edit this page.'); window.location="request_duty_list.php";</script>
    <? exit();
    }
        ...
        <div class="page-container page-navigation-top-fixed">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="request_duty_list.php">Approval Request</a></li>
                        ...
                        $.ajax({
                            ...
                            success: function(response)
                            {
                                ...
                                if(response == '{"type":"error","info":"ttlfailure","msg":"Failed in Request Creation. Kindly try again!"}' || response == '{"type":"error","info":"ttlfailure","msg":"Failed in Request Creation & Product Adding. Kindly try again!!!!"}' || response == '{"type":"error","info":"ttlfailure","msg":"Failed in Request Creation. Kindly try again!!"}' || response == '{"type":"error","info":"ttlfailure","msg":"Failed in Request Creation. Kindly try again!!!"}') {
                                    ...
                                    $('#sbmt_request').attr('disabled', false);
                                    // $('#loader').html('');
                                    window.location="request_entry_night_duty.php";
                                    $('#load_page').show();
