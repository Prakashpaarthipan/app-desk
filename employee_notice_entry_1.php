										...
										<div class="row">
											<div class="col-md-6">
											   ...
											   <div class="form-group">
													...
													<div class="col-md-9"  >
														<select class="form-control custom-select chosn" autofocus tabindex='1' required name='branch' id='branch' onChange="" data-toggle="tooltip" data-placement="top" data-original-title="Top Core" >
														...
														<?  $sql_project = select_query_json("select usrcode,useracc,allbran,brncode,MULTIBRN from tcs_centra_attn where  usrcode=1595888", "Centra", 'TCS');
                                                            //print_r($sql_project);
                                                                ...
                                                                {
                                                                     $sql_brn = select_query_json("Select Brncode,Substr(Nicname,3,10) Brnname From Branch Where brncode='".$sql_project[0]['BRNCODE']."' ", "Centra", 'TEST');
                                                                    
                                                                     //print_r($sql_brn);
                                                                }
                                                                else
                                                                { $sql_brn = select_query_json("Select Brncode,Substr(Nicname,3,10) Brnname From Branch Where brncode IN (".$sql_project[0]['MULTIBRN'].")", "Centra", 'TEST');
                                                                //print_r($sql_brn);
														...
														<span class="help-block">Select the Branch</span>
													</div>
												</div>
                                                    ...
                                                    <div class="col-md-9 col-xs-12">
                                                        <b>
                                                          <input type='text' class="form-control" tabindex='2' required style="text-transform: uppercase;" name='employee' id='employee' data-toggle="tooltip" onblur="" onchange="getprofile_img()" data-placement="top" data-original-title="Assign member" value='<?=$sql_emp[0]['EMPCODE']." - ".$sql_emp[0]['EMPNAME']." - ".substr($sql_emp[0]['ESENAME'], 3)?>'>
                                                            <span class="help-block">Select the Employee</span>
                                                ...
                                                <div class="form-group">
                                                        <label class="col-md-3 control-label" id='remarks'>REMARKS <span style='color:red'>*</span></label>
                                                    <div class="col-md-9 col-xs-12">
                                                        <div class="">
                                                            <textarea required id="message" name="message" type="text" tabindex="3" class="form-control" maxlength=250 style="text-transform: uppercase;height:75px; padding-right: 5px;" multiple placeholder="YOUR REMARKS.." required></textarea>
                                                        </div>
                                                        <span class="help-block">Give your Remarks here</span>
                                               ...
                                               <div class="form-group">
                                                    ...
                                                    <div class="col-md-8 col-xs-12">
                                                        ...
                                                        <option value='21344'>S KAARTHI</option>
...
<!--fix me-->
    ...
    function getprofile_img(){
        ...
        if(ececode[1]!='')
        {
             $('#profile_img').html('<img src="profile_img.php?action=user_profile_img&profile_img='+ececode[0]+'" style="width:200px; height:200px; border:1px solid #a0a0a0; text-align:center; border:0px;" />');
        }
        else{
            alert("error");
        }
