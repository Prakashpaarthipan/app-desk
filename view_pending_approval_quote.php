                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
										...
										<div class="form-group">
                                            <label class="col-md-3 control-label">Period Date</label>
                                            <div class="col-md-9 col-xs-12">
                                                :  <b><?=strtoupper(date('d-M-Y',strtotime($sql_renewal[0]['AGFRDAT'])));?>  -  <?=strtoupper(date('d-M-Y',strtotime($sql_renewal[0]['AGTODAT'])));?></b>
                                            </div>
                                        </div>
                                        <div class="tags_clear"></div>
																							<?}?>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div id="id_rate_finalize_by" class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-xs-12">
                                                        <?  $sql_emp = select_query_json("select distinct(emp.EMPSRNO), emp.EMPCODE, emp.EMPNAME, emp.ESECODE, sec.ESENAME, emp.DATEOFJOIN, des.DESNAME,Sal.PAYCOMPANY
                                                                                                    from employee_office emp, empsection sec, designation des, employee_salary sal
                                                                                                    where emp.ESECODE = sec.ESECODE and emp.DESCODE = des.DESCODE and (emp.empcode = '".$sql_reqid[0]['RTFNUSR']."')
                                                                                                        and sec.deleted = 'N' and sal.PAYCOMPANY = 1 and emp.empsrno = sal.empsrno
                                                                                                union
                                                                                                    select distinct(emp.EMPSRNO), emp.EMPCODE, emp.EMPNAME, emp.ESECODE, sec.ESENAME, emp.DATEOFJOIN,
                                                                                                        des.DESNAME, sal.PAYCOMPANY
                                  ...
                                  ?>
                                    <tr class="active">
                                      ...
                                      <td style="text-align: left;">
                                        <?
                                          $sql_descode=select_query_json("select EMPCODE, EMPNAME from approval_subject_add 
                                                                                where APRNUMB = '".$sql_reqid[0]['APRNUMB']."' AND ENTSRNO = '".$sectionrow['ENTSRNO']."' 
...
"</div>"); //add input box
    ...
    function dynamic_template_load(reqid, year, rsrid, creid, typeid)
    {
        ...
        if(prdcnt == 0){
        var strURL="ajax/ajax_dynamic_load_quote.php?reqid="+reqid+"&year="+year+"&rsrid="+rsrid+"&creid="+creid+"&typeid="+typeid+"&hid_aprnumb="+hid_aprnumb;
            $.ajax({
                type: "POST",
                url: strURL,
                success: function(data) {
