...
<div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-danger" target="_blank" style="margin-right: 5px;" href="employee_add.php">(+) Add Employees</a>&nbsp;&nbsp;<a class="btn btn-danger" target="_blank" style="margin-right: 50px;" href="employee_grade_fix.php">Grade Fix</a><br><br>
                        </div>
                    </div>
    ...
    function task_assign(empsrno, iv) {
        ...
        var strURL="ajax/fix_grade_testpage.php?action=fix_grade&empsrno="+empsrno+"&grade="+grade;
        if(grade != '') {
            $.ajax({
                type: "POST",
                url: strURL,
