                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="form-group trbg non-printable">
                            <form role="form" id='id_policy_approval' name='id_policy_approval' action='' method='post' enctype="multipart/form-data">
                            ...
                            <?  $and = "";
                                ...
                                if($and != '') { 
                                    ...
                                    $sql_search = select_query_json("select to_char(ar.ADDDATE,'dd-MON-yyyy hh:mi:ss AM') ADDDATE, ar.FINDATE, ar.APRNUMB, ar.APPSTAT, ar.APPRSUB, ar.APPRFOR,
                                                                            ...
                                                                            order by ADDDATE desc, APPORDER asc, APRNUMB desc", "Centra", 'TEST');
                                }else{
                                    /* $rqusr = " and ar.ADDUSER = '".$_SESSION['tcs_empsrno']."' ";
                                ...
                                for($search_i = 0; $search_i < count($sql_search); $search_i++) { $ij++;
                                    ...
                                    <tr class="odd gradeX" style='background-color:<?=$bgclr?>; color:<?=$clr?>;'>
                                        ...
                                        <td><a href='view_pending_approval2.php?action=view&reqid=<? echo $sql_search[$search_i]['ARQCODE']; ?>&year=<? echo $sql_search[$search_i]['ARQYEAR']; ?>&rsrid=1&creid=<? echo $sql_search[$search_i]['ATCCODE']; ?>&typeid=<? echo $sql_search[$search_i]['ATYCODE']; ?>' title='View' alt='View' style='color:<?=$clr?>; font-weight:normal; font-size:10px;'><? echo $sql_search[$search_i]['APRNUMB']; ?></a>
                                            <?  $sql_internal = select_query_json("select appfrwd from approval_request where (arqsrno,aprnumb) in (select max(arqsrno) arqsrno, aprnumb
                                        ...
                                        <td class="center"><? echo $sql_search[$search_i]['APRTITL']." ".$sql_search[$search_i]['REQTO']; //$sql_rqto = select_query_json("select EMPNAME from employee_office where empsrno = ".$sql_search[$search_i]['RQESTTO']); echo $sql_search[$search_i]['APRTITL']." ".$sql_rqto[0][0]; ?></td>
                                        <td class="center" style='text-align:center; white-space:nowrap;'>
                                            ...
                                            <a target="_blank" href='view_pending_approval2.php?action=view&reqid=<? echo $sql_search[$search_i]['ARQCODE']; ?>&year=<? echo $sql_search[$search_i]['ARQYEAR']; ?>&rsrid=<? echo $sql_search[$search_i]['ARQSRNO']; ?>&creid=<? echo $sql_search[$search_i]['ATCCODE']; ?>&typeid=<? echo $sql_search[$search_i]['ATYCODE']; ?>' title='View' alt='View' style='color:<?=$clr?>;'><i class="fa fa-eye"></i> View</a> <br>
                                            ...
                                            <? ////// HIDE FINISH APPRVOAL //////
                                                ...
                                                if($sql_search[$search_i]['APPSTAT'] != 'A') { ?>
                                                     / <a target="_blank" href='print_request_test.php?action=print&reqid=<? echo $sql_search[$search_i]['ARQCODE']; ?>&year=<? echo $sql_search[$search_i]['ARQYEAR']; ?>&rsrid=<? echo $sql_search[$search_i]['ARQSRNO']; ?>&creid=<? echo $sql_search[$search_i]['ATCCODE']; ?>&typeid=<? echo $sql_search[$search_i]['ATYCODE']; ?>' title='View' alt='View'><i class="fa fa-print"></i> Print</a>
                                                <? } elseif($sql_search[$search_i]['APPSTAT'] != 'R') { ?>
                                                     / <a href='javascript:void(0)' onclick="PrintDiv('print_request_test.php?action=print&reqid=<? echo $sql_search[$search_i]['ARQCODE']; ?>&year=<? echo $sql_search[$search_i]['ARQYEAR']; ?>&rsrid=<? echo $sql_search[$search_i]['ARQSRNO']; ?>&creid=<? echo $sql_search[$search_i]['ATCCODE']; ?>&typeid=<? echo $sql_search[$search_i]['ATYCODE']; ?>');" title='Print' alt='Print' style='color:<?=$clr?>;'><i class="fa fa-print"></i> Print</a>
