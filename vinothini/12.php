                                        ...
                                        <table  class="table  table-striped" name="copy_pre" >
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="center" style='text-align:center'>TUP
													<input type="text" name="txt_tup" id="txt_tup">
                                                     </th>
                                                    <th class="center" style='text-align:center'>EKM<input type="text" name="txt_tup" id="txt_tup"></th>
                                                    <th class="center" style='text-align:center'>MDU<input type="text" name="txt_mdu" id="txt_mdu"></th>
                                                    <th class="center" style='text-align:center'>DGL<input type="text" name="txt_dgl" id="txt_dgl"></th>
                                                    <th class="center" style='text-align:center'>AIR-HYD<input type="text" name="txt_hyd" id="txt_hyd"></th>
                                                    <th class="center" style='text-align:center'>AIR-MDU<input type="text" name="txt_md" id="txt_md"></th>
                                                    <th class="center" style='text-align:center'>TAILYOU<input type="text" name="txt_tail" id="txt_tail"></th>
                                                    <th class="center" style='text-align:center'>KKV<input type="text" name="txt_kkv" id="txt_kkv"></th>
                                                    <th class="center" style='text-align:center'>AIR-CHN<input type="text" name="txt_chn" id="txt_chn"></th>
                                                    <th class="center" style='text-align:center'>SCM<input type="text" name="txt_scm" id="txt_scm"></th>
                                                    <th class="center" style='text-align:center'>CLT<input type="text" name="txt_clt" id="txt_clt"></th>
                                                    <th class="center" style='text-align:center'>TUP-KTM<input type="text" name="txt_ktm" id="txt_ktm"></th>
                                                    <th class="center" style='text-align:center'>MDU-TJ<input type="text" name="txt_mdu_tj" id="txt_mdu_tj"></th>
                                                    <th class="center" style='text-align:center'>TUP-TJ<input type="text" name="txt_tup_tj" id="txt_tup_tj"></th>
                                                    <th class="center" style='text-align:center'>DGL-TJ<input type="text" name="txt_dgl_tj" id="txt_dgl_tj"></th> 
                                                    <th class="center" style='text-align:center'>COR<input type="text" name="txt_cor" id="txt_tup"></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            <?  
