		...
		<td colspan=2 style='width:100%; vertical-align:top; text-align:left;'>
			<table border=0 style='width:100%; max-width: 773px; '>
				...
				<tr style='min-height:20px !important; max-width: 773px; line-height:20px !important;'>
					<td colspan=2>
						<table border=0 width='100%' style='max-width: 773px; border: 1px solid #0088CC; min-height: 70px; height:auto; padding:3px; -webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px;'> <? echo $filename = "ftp://".$ftp_user_name_apdsk.":".$ftp_user_pass_apdsk."@".$ftp_server_apdsk.":5022/approval_desk/text_approval_source/".$filepathname;?>
							...
							<tr style=''>
								<td style='width:100%; text-align:left; max-width: 760px !important; overflow-x: auto !important;'>
									<label class="print_table"><? // echo $sql_approve_leads[0]['APPRDET'];
										if($sql_approve_leads['APPRFOR'] == '1' or $sql_approve_leads['APPRFOR'] == '2' or $sql_approve_leads['APPRFOR'] == '3' or $sql_approve_leads['APPRFOR'] == '4' or $sql_approve_leads['APPRFOR'] == '5') {
	                                        $filepathname = $sql_approve_leads['APPRSUB'];
	                                        ...
	                                        $handle = fopen($filename, "r") or die("The content might not be available!. Contact Admin - ". $sql_approve_leads['APPRSUB']);
	                                        // $contents = fread($handle, filesize($filename));
	                                        $contents = file_get_contents($filename);
	                                        fclose($handle);
	                                        echo $contents;
	                                    } else {
	                                        echo $sql_approve_leads['APPRDET'];
	                                    } ?></label> <!-- Details -->
								</td>
							</tr>
