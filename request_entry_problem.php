...
<body>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                                                ...
                                                <? } else { ?>
                                                    ...
                                                    <?  if($sql_reqid[0]['APRCODE'] != '') {
                                                        ...
                                                        if($sql_project[0]['BRNPROJ'] == 'P') {
                                                            ...
                                                            $sql_submission_type = select_query_json("select * from approval_type 
                                                                                                                where DELETED = 'N' and ATYCODE not in (7) order by ATYSRNO", "Centra", 'TCS'); 
                                                                                                                // 1 for FIXED BUDGET, 7 for Extra Budget
                                                        } ?>
                            ...
                            <div class="panel-footer">
                                ...
                                <? } else { ?>
                                    <button type="submit" name='sbmt_request' id='sbmt_request' tabindex='40' value='submit' class="btn btn-success pull-right" data-toggle="tooltip" data-placement="top" title="Submit" style="padding: 6px 12px;"><i class="fa fa-save"></i> Submit</button>
                                <? } ?>
    ...
    $("#frm_request_entry").on('submit',(function(e) {
        ...
        var enable1 = 0; var enable2 = 0; var enable3 = 0; var enable4 = 0; var flag = true;
        var enable5 = 0; var enable6 = 0; var enable7 = 0; var enable8 = 0; var enable9 = 0;
        var slt_targetno = $("#slt_targetno").val();
        var slt_submission = $("#slt_submission").val();
        var strURL="ajax/ajax_validate.php?action=fix_checklist&slt_targetno="+slt_targetno+"&slt_submission="+slt_submission;
    ...
    function get_topcore(slt_subcore) {
        ...
        var strURL="gettopcore.php?action=find_topcore_withname&slt_core_department="+slt_core_department+"&slt_subcore="+slt_subcore;
        var req = getXMLHTTP();
        if (req) {
            req.onreadystatechange = function() {
                if (req.readyState == 4) {
