                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <!-- Approval Subject -->
                                        <!-- EXPENSE HEAD -->
                                        <?$sql_expname = select_query_json("sELECT DPA.DEPCODE,DPA.EXPSRNO,DPA.EXPNAME,APQF.TARNUMB,decode(tar.ptdesc,'-',DPA.depname,tar.ptdesc) tarname FROM approval_PRODUCT_QUOTATION_FIX APQF,DEPARTMENT_ASSET DPA,non_purchase_target tar WHERE DPA.DEPCODE=APQF.DEPCODE and tar.depcode=DPA.depcode and APQF.tarnumb=tar.ptnumb and trunc(APQF.adddate) between trunc(ptfdate) and trunc(pttdate) AND APQF.APRNUMB='".$sql_reqid[0]['APRNUMB']."'", "Centra", 'TEST');?>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Expense Head <span style='color:red'>*</span></label>
                                            <div class="col-md-9 col-xs-12">
                                                <? if($_REQUEST['action'] == 'view') { ?>
                                                    : <? echo $sql_expname[0]['EXPNAME'];?> ( <? echo $sql_expname[0]['TARNUMB'];?>  - <? echo $sql_expname[0]['TARNAME'];?> )
                                                <? } else { ?>
                                                    <div id="id_appr_listings">
                                                        <select <? if($_REQUEST['action'] == 'edit') { ?> disabled class="form-control custom-select" <? } else { ?> class="form-control custom-select chosn" onChange="getapproval_listings(this.value)" onblur="call_days()" <? } ?> tabindex='7' required name='slt_approval_listings' id='slt_approval_listings' data-toggle="tooltip" data-placement="top" data-original-title="Approval Subject">
                                                        <option value=''>Choose Approval Subject</option>
                                            ...
                                            <div class="panel-body">
                                                <? if($sql_reqid[0]['WRKINUSR'] != '') { ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9 col-xs-12">
                                                            <?  $sql_emp = select_query_json("select EOF.EMPCODE,EOF.EMPNAME,DES.DESNAME,EMP.ESENAME from employee_office EOF,DESIGNATION DES,empsection emp where empcode='".$sql_reqid[0]['WRKINUSR']."' and eof.descode=des.descode and emp.esecode=eof.esecode", "Centra", 'TCS'); // 02052017
                                                                    if($_REQUEST['action'] == 'view') {
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-xs-12">
                                                        <?  $sql_emp = select_query_json("select EOF.EMPCODE,EOF.EMPNAME,DES.DESNAME,EMP.ESENAME from employee_office EOF,DESIGNATION DES,empsection emp where empcode='".$sql_reqid[0]['RESPUSR']."' and eof.descode=des.descode and emp.esecode=eof.esecode", "Centra", 'TCS'); // 02052017
                                                                if($_REQUEST['action'] == 'view') {
                                                                    echo ": ".$sql_emp[0]['EMPCODE']." - <b>".$sql_emp[0]['EMPNAME']."</b> (".$sql_emp[0]['DESNAME'].") - ".substr($sql_emp[0]['ESENAME'], 3)." ";
                                                            } else { ?>
                                            ...
                                            <div class="panel-body">
                                                <? if($sql_reqid[0]['ARQSRNO'] == 1) {
                                                        $sql_approval_levels = select_query_json("select req.REQDESN, req.REQESEN, req.APPRMRK, req.APRQVAL, req.APPFVAL, req.APPFRWD,
                                                                                                            ...
                                                                                                            BRNNAME, to_char(INTPFRD,'dd-MON-yyyy hh:mi:ss AM') INTPFRD_Time, AUTFRWD
                                                        ...
                                                        for($sql_approval_levelsi = 0; $sql_approval_levelsi < count($sql_approval_levels); $sql_approval_levelsi++) { 
                                                            $hst_brclr = "#F0F0F0";
                                                            if($sql_approval_levels[$sql_approval_levelsi]['AUTFRWD'] == 'Y') { $hst_brclr = "#e1e1ff"; } ?>
                                                    <div style='border:1px dashed #A0A0A0; -webkit-border-radius: 10px; -moz-border-radius: 10px; border-radius: 10px; background-color:<?=$hst_brclr?>; margin-bottom: 5px;'>
                                                        ...
                                                        <div class="form-group trbg" style='min-height: 30px; line-height: 30px; margin-right: 0px; margin-left: 0px; margin-bottom: 5px;'>
                                                            <div class="col-lg-12 col-md-12">
                                                                <? 
                                                                   ...
                                                                   <? if($sql_approval_levels[$sql_approval_levelsi]['AUTFRWD'] == 'Y') { ?><span class="label label-primary" style="">AUTO FORWARD APPROVAL</span><? } ?>
                                                            </div>
                                                        </div>
                                                        <div class="tags_clear"></div>
                                                    </div>
                                  ...
                                  <!-- viki -->
                                  <div class="row" style="background: #fff;padding: 10px 10px;margin-top: 10px; ">
                                    <!-- <pre> -->
                                ...
                                <center><h3 style="color: red">Product : <?=$key;?> - <?=$value[0]['SUBCODE']?> (<?=$value[0]['PRDNAME']?> - <?=$value[0]['SUBNAME']?> ) - <?=$value[0]['UNTNAME']?></h3></center> 
                                <table class="table table-bordered" style="box-shadow: 0 0 5px black;">
                            ...
                            <?}?>
                                        ...
                                        <div class="row" style="margin:10px;">
                                          <!-- <input style="float: left;border-radius: 10%;box-shadow: 0 0 7px black;" type="button" class="btn btn-warning" value="BID" name="bid"/> -->
                                      </div>
                                  </div>
