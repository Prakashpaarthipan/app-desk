                           ...
                           $totalval=number_format(($sum/100000),2);
                            ...
                            <div class="nonadv_list">
                                <h3 class="text-center" style="color:#000;font-size: 16px;margin-top:0px;padding-top:5px;">
                                    ...
                                    <span class="pull-right" style="color:#000;border:1px solid #000;font-size: 16px;border-radius:30px;padding:5px;padding:bottom:0px;min-width:50px;margin-right:5px"> <?php echo $subcount;?></span><br><br>
