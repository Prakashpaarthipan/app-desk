                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-footer">
                                ...
                                <? } else { ?>
                                    <button type="submit" name='sbmt_request' id='sbmt_request' tabindex='40' value='submit' class="btn btn-success pull-right" data-toggle="tooltip" data-placement="top" onclick="return checkform removehere()" title="Submit" style="padding: 6px 12px;"><i class="fa fa-save"></i> Submit</button>
                                <? } ?>
