    ...
    <body>
        ...
        <div class="page-container page-navigation-toggled">
            ...
            <div class="page-content">
                ...
                <input type="text" class="form-control" placeholder="All Records Search" title="All Records Search" onfocus ="myFunction(this)" onblur="loadback(this)" autocomplete="off" id="listsupplier">
  ...
  $(function() {
    ...
    $("#load_page").show();
      ...
      $.ajax({
          ...
          url:"ajax/supplier_loader_allsearch.php?action=searchAll",
          async: true,
           dataType:'text',
           success:function(data)
           {
        ...
        {
            // $('#load_page').show();
            var strURL="ajax/supplier_loader_test.php";
              $.ajax({
                  type: "POST",
                  url: strURL,
                  dataType:'html',
        ...
        function close_call()
        {
            ...
            $.ajax({
                  ...
                  success: function(data1) {
          if(data1==0) { 
            alert("Sir, Kindly send Response first!");
            $('#message').focus();
            $('#load_page').hide();
                    } else {
            commentupdator();
            $("#all-messages").html(" ");
            $("#head_titile").html(" ");
            alert("SERVICE REQUEST CALL CLOSED");
            $('#load_page').hide();
          }
                  },
            data: {
        ...
        function sendmessage()
        {
            ...
            {
              alert("max message length is 250");
            }
            else
            {
               $('#load_page').show();
