                                    ...
                                    <div style="height: 700px;overflow-x: scroll;overflow-y: scroll;">
                                        <table  class="table  table-striped" name="copy_pre" >
                                           	...
                                           	// echo "select APR.BRNCODE,apr.EMPCODE||'-'||EMPNAME NAME from trandata.approval_branch_head@tcscentr apr, trandata.branch@tcscentr brn where apr.brncode = brn.brncode and apr.deleted = 'N' and brn.deleted = 'N' AND apr.apmcode ='".$sql_search[$f]['APMCODE']."'  GROUP BY apr.BRNCODE, apr.TARNUMB, apr.EMPSRNO, apr.EMPCODE, apr.EMPNAME, apr.brncode Order by apr.brncode";
                                                ...
                                                <tr>
                                                   ...
                                                   <td style='text-align:left;width: 10%;' data-toggle="tooltip" data-placement="top" title="TUP">
                                                        <input type="text" name="emp_<?=$f;?>_1" id="emp_<?=$f;?>_1" class="auto_complete"  onblur="insert('<?=$f;?>','1','1','<?=$sql_search[$f]['APMCODE']?>');" onblur="addselect('<?=$f;?>')";/>
                                         ...
                                         <td style='text-align:left;width: 10%;' data-toggle="tooltip" data-placement="top" title="EKM">
                                             <input type="text" name="emp_<?=$f;?>_2" id="emp_<?=$f;?>_2" class="auto_complete" onblur="insert('<?=$f;?>','2','10','<?=$sql_search[$f]['APMCODE']?>');" onblur="addselect1('<?=$f;?>/>
                                                    ...
                                                    <td style='text-align:left;width: 10%;' data-toggle="tooltip" data-placement="top" title="MDU">
                                                        <input type="text" name="emp_<?=$f;?>_3" id="emp_<?=$f;?>_3"    class="auto_complete" onblur="insert('<?=$f;?>','3','14','<?=$sql_search[$f]['APMCODE']?>');" onblur="addselect2('<?=$f;?>/>
                                                    ...
                                                    <td style='text-align:left;width: 10%;' data-toggle="tooltip" data-placement="top" title="DGL">
                                                        <input type="text" name="emp_<?=$f;?>_4" id="emp_<?=$f;?>_4" class="auto_complete" onblur="insert('<?=$f;?>','4','23','<?=$sql_search[$f]['APMCODE']?>');" onblur="addselect3('<?=$f;?>/>
                                                    ...
                                                    <td style='text-align:left;width: 10%;' data-toggle="tooltip" data-placement="top" title="AIR-HYD">
                                                        <input type="text" name="emp_<?=$f;?>_5" id="emp_<?=$f;?>_5" class="auto_complete" onblur="insert('<?=$f;?>','5','107','<?=$sql_search[$f]['APMCODE']?>');" onblur="addselect4('<?=$f;?>/>
                                                    ...
                                                    <td style='text-align:left;width: 10%;' data-toggle="tooltip" data-placement="top" title="AIT-MDU">
                                                        <input type="text" name="emp_<?=$f;?>_6" id="emp_<?=$f;?>_6" class="auto_complete" onblur="insert('<?=$f;?>','6','112','<?=$sql_search[$f]['APMCODE']?>');" onblur="addselect5('<?=$f;?>/>
                                                    ...
                                                    <td style='text-align:left;width: 10%;' data-toggle="tooltip" data-placement="top" title="TAILYOU">
                                                        <input type="text" name="emp_<?=$f;?>_7" id="emp_<?=$f;?>_7" class="auto_complete" onblur="insert('<?=$f;?>','7','114','<?=$sql_search[$f]['APMCODE']?>');" onblur="addselect6('<?=$f;?>/>
                                                    ...
                                                    <td style='text-align:left;width: 10%;' data-toggle="tooltip" data-placement="top" title="KKV">
                                                        <input type="text" name="emp_<?=$f;?>_8" id="emp_<?=$f;?>_8" class="auto_complete" onblur="insert('<?=$f;?>','8','115','<?=$sql_search[$f]['APMCODE']?>');" onblur="addselect7('<?=$f;?>/>
                                                    ...
                                                    <td style='text-align:left;width: 10%;' data-toggle="tooltip" data-placement="top" title="AIR-CHN">
                                                        <input type="text" name="emp_<?=$f;?>_9" id="emp_<?=$f;?>_9" class="auto_complete" onblur="insert('<?=$f;?>','9','116','<?=$sql_search[$f]['APMCODE']?>');" onblur="addselect8('<?=$f;?>/>
                                                    ...
                                                    <td style='text-align:left;width: 10%;' data-toggle="tooltip" data-placement="top" title="SCM">
                                                        <input type="text" name="emp_<?=$f;?>_10" id="emp_<?=$f;?>_10" class="auto_complete" onblur="insert('<?=$f;?>','10','117','<?=$sql_search[$f]['APMCODE']?>');" onblur="addselect9('<?=$f;?>/>
                                                    ...
                                                    <td style='text-align:left;width: 10%;' data-toggle="tooltip" data-placement="top" title="CLT">
                                                        <input type="text" name="emp_<?=$f;?>_11" id="emp_<?=$f;?>_11"  class="auto_complete" onblur="insert('<?=$f;?>','11','120','<?=$sql_search[$f]['APMCODE']?>');" onblur="addselect10('<?=$f;?>/>
                                                    ...
                                                    <td style='text-align:left;width: 10%;' data-toggle="tooltip" data-placement="top" title="TUP-KTM">
                                                       <input type="text" name="emp_<?=$f;?>_12" id="emp_<?=$f;?>_12" class="auto_complete" onblur="insert('<?=$f;?>','12','201','<?=$sql_search[$f]['APMCODE']?>');" onblur="addselect11('<?=$f;?>/>
                                                    ...
                                                    <td style='text-align:left;width: 10%;' data-toggle="tooltip" data-placement="top" title="MDU-TJ">
                                                        <input type="text" name="emp_<?=$f;?>_13" id="emp_<?=$f;?>_13" class="auto_complete" onblur="insert('<?=$f;?>','13','203','<?=$sql_search[$f]['APMCODE']?>');" onblur="addselect12('<?=$f;?>/>
                                                    ...
                                                    <td style='text-align:left;width: 10%;' data-toggle="tooltip" data-placement="top" title="TUP-TJ">
                                                        <input type="text" name="emp_<?=$f;?>_14" id="emp_<?=$f;?>_14" class="auto_complete" onblur="insert('<?=$f;?>','14','204','<?=$sql_search[$f]['APMCODE']?>');" onblur="addselect13('<?=$f;?>/>
                                                    ...
                                                    <td style='text-align:left;width: 10%;' data-toggle="tooltip" data-placement="top" title="DGL-TJ">
                                                        <input type="text" name="emp_<?=$f;?>_15" id="emp_<?=$f;?>_15" class="auto_complete" onblur="insert('<?=$f;?>','15','206','<?=$sql_search[$f]['APMCODE']?>');" onblur="addselect14('<?=$f;?>/>
                                                    ...
                                                    <td style='text-align:left;width: 10%;' data-toggle="tooltip" data-placement="top" title="COR">
                                                       <input type="text" name="emp_<?=$f;?>_16" id="emp_<?=$f;?>_16" class="auto_complete" onblur="insert('<?=$f;?>','16','888','<?=$sql_search[$f]['APMCODE']?>');" onblur="addselect15('<?=$f;?>/>
