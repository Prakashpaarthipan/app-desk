                                ...
                                for($search_i = 0; $search_i < count($sql_search); $search_i++) { $ij++;
                                    ...
                                    <tr class="odd gradeX" style='background-color:<?=$bgclr?>; color:<?=$clr?>;'>
                                        ...
                                        <td class="center" style='text-align:center; white-space:nowrap;'>
                                            <? if($sql_search[$search_i]['APPSTAT'] != 'A') { if($editid == 1) { /* ?><a href='request_entry_night_duty.php?action=edit&reqid=<? echo $sql_search[$search_i]['ARQCODE']; ?>&year=<? echo $sql_search[$search_i]['ARQYEAR']; ?>&rsrid=<? echo $sql_search[$search_i]['ARQSRNO']; ?>&creid=<? echo $sql_search[$search_i]['ATCCODE']; ?>&typeid=<? echo $sql_search[$search_i]['ATYCODE']; ?>' title='Edit' alt='Edit' style='color:<?=$clr?>;'><i class="fa fa-edit"></i> Edit</a> / <? */ } } ?>
