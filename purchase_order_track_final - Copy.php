            ...
            <div class="page-content-wrap">
                ...
                <div class="content-frame-body" style="margin-left:0px;">
                    ...
                    <div class="list_view push-up-12" id='id_monitor_board'>
                      ...
                      {
                          $sql_process[$process['ZNECODE']][$key] = $process;
                      }
                      print_r($sql);echo "<br><br>";
                       ...
                       //  $seltotal=select_query_json("select COUNT(*) totcount from order_tracking_detail where ZNECODE>0 and ZNESTAT='N' and DELETED='N'", "Centra", "TEST");
                          ...
                          foreach ($sql_ord_confirm as $key => $ord_confirm_value) { $tme++; 
                           ...
                           echo $count= $sql_process[$ord_confirm_value['ZNECODE']][0]['TOTCOUNT'];
                            echo '<br><br>'.count($sql_process[$ord_confirm_value['ZNECODE']]);
                             
                           echo $perc=round((count($sql_process[$ord_confirm_value['ZNECODE']])/$count)*100);
                            echo $totalval=number_format(($sum/100000),2);
                            ?>
                                        ...
                                        <div class="form-group">
                                         <!--<div class="col-md-1">
                                          ...
                                          <div class="col-md-12" style="padding: 5px 10px;">
                                              ...
                                              // $empname=select_query_json("select EMPNAME,EMPCODE from employee_office where empsrno='".$sql_process[$ord_confirm_value['ZNECODE']][$i]['EMPSRNO']."'","Centra","TEST");  ?>
                                          </div>
										  <div style="clear: both;"></div>
