...
<div class = "border-bottom " id="notassign" style="overflow-y: scroll;position: relative;">
<?	if($supplier[0]==''){?>
...
<div class = "border-bottom" id="assign" style=" height:200px;position: relative;overflow-y: scroll;">
