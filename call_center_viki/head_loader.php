...
$supplier = select_query_json("select rre.REQSTAT,rre.reqnumb from service_register_entry rre where rre.REQUSRTYP='S' and rre.reqnumb='".$_REQUEST['reqnumb']."'","Centra","TEST");
$clr='';
