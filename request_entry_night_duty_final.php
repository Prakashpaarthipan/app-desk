                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <? } else { ?>
                                                        ...
                                                        <?  $sql_project = select_query_json("select * from approval_project where DELETED = 'N' order by APRCODE Asc", "Centra", 'TCS');
															$count_sql_project = count($sql_project);
                                                            for($project_i = 0; $project_i < $count_sql_project; $project_i++) { ?>
                                                ...
                                                <div class="col-md-9 col-xs-12" id="id_submission_type">
                                                    ...
                                                    <? } else { ?>
                                                        ...
                                                        <?  if($sql_reqid[0]['APRCODE'] != '') {
                                                            ...
                                                            <? $count_sql_submission_type = count($sql_submission_type);
															for($submission_type_i = 0; $submission_type_i < $count_sql_submission_type; $submission_type_i++) { ?>
