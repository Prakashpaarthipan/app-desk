...
<? 	// PO Based - End
	...
	case 13 : ?>
		 <form class="form-horizontal" role="form" id="frm_requirement_entry" name="frm_requirement_entry" enctype="multipart/form-data">
	...
	function nsubmit(){
		...
		$.ajax({
			...
			data:{
				...
				'FCKeditor2':CKEDITOR.instances.FCKeditor2.getData(),
