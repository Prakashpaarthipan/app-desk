                                    ...
                                    <div id='id_policy_approval' style="padding-left: 10px; text-align: center; display: none;">
                                        <div class="parts3 fair_border">
                                            ...
                                            <div class="row" style="margin-left: 0px; display: flex; text-transform: uppercase;">
                                                ...
                                                <div class="col-sm-7 colheight" style="padding: 0px; line-height: 30px;">
                                                    <input type="text" style="cursor: pointer; text-transform: uppercase; position: relative; top: auto; right: auto; bottom: auto; left: auto;" class="form-control" name="search_fromdate" id="datepicker-example4" autocomplete="off" readonly="readonly" maxlength="11" tabindex="5" value='' data-toggle="tooltip" data-placement="top" placeholder="To Date" title=""  >
                                                </div></td><td>
                                                ...
                                                <div class="col-sm-5 colheight" style="padding: 0px; line-height: 30px;">
                                                 ...
                                                 <!--<input type='text' class="form-control policy_approval_required" style="text-transform: uppercase;" required name='txtdynamic_creator' id='txtdynamic_creator' data-toggle="tooltip" data-placement="top" data-original-title="CREATOR" value='<?=$sql_emp[0]['EMPCODE']." - ".$sql_emp[0]['EMPNAME']." - ".substr($sql_emp[0]['ESENAME'], 3)?>'>-->
									              ...
									              <option value='<?=$sql_emp[$sql_emp_i]['EMPCODE']?>'><?=$sql_emp[$sql_emp_i]['EMPNAME']." - ".$sql_emp[$sql_emp_i]['EMPCODE'].""?></option>
                                            ...
                                            <div class="row" style="margin-right: 0px; display: flex; text-transform: uppercase;">
                                               ...
                                               <input type="text" style="cursor: pointer; text-transform: uppercase; position: relative; top: auto; right: auto; bottom: auto; left: auto;" class="form-control" name="search_fromdate" id="datepicker-example5" autocomplete="off" readonly="readonly" maxlength="11" tabindex="5" value="<? if($_REQUEST['search_fromdate'] != '') { echo $_REQUEST['search_fromdate']; } else { echo date("d-M-Y"); } ?>" data-toggle="tooltip" data-placement="top" placeholder="From Date" title=""  >
                                                ...
                                                <div class="col-sm-5 colheight" style="padding: 0px; line-height: 30px; ">
                                                 ...
                                                 <select  class="form-control policy_approval_required" style="text-transform: uppercase;" required name='txtdynamic_coordinator' id='txtdynamic_coordinator' data-toggle="tooltip" data-placement="top" data-original-title="ASSISTBY"  value='<?=$sql_emp[0]['EMPCODE']." - ".$sql_emp[0]['EMPNAME']." - ".substr($sql_emp[0]['ESENAME'], 3)?>'>     
												   <? 	for($sql_emp_i = 0; $sql_emp_i < count($sql_emp); $sql_emp_i++) { ?>
									...
									<option value='<?=$sql_emp[$sql_emp_i]['EMPCODE']?>'><?=$sql_emp[$sql_emp_i]['EMPNAME']." - ".$sql_emp[$sql_emp_i]['EMPCODE'].""?></option>
                                            ...
                                            <div class="row" style="margin-right: 0px; display: flex; text-transform: uppercase;">
                                               ...
                                               <select  class="form-control policy_approval_required" style="text-transform: uppercase;" required name='txtdynamic_userlist' id='txtdynamic_userlist' data-toggle="tooltip" data-placement="top" data-original-title="USER LIST"  value='<?=$sql_emp[0]['EMPCODE']." - ".$sql_emp[0]['EMPNAME']." - ".substr($sql_emp[0]['ESENAME'], 3)?>'>     
												...
												<?
                                                   $sql_emp = select_query_json("select distinct(emp.EMPSRNO), emp.EMPCODE, emp.EMPNAME, emp.ESECODE, sec.ESENAME,  des.DESNAME,
                                                                                                    ...
                                                                                                    where emp.ESECODE = sec.ESECODE and emp.DESCODE = des.DESCODE and sec.deleted = 'N' and
                                                                                                        sec.deleted = 'N' and (emp.empcode = '".$sql_reqid[0]['WRKINUSR']."')  
                                                                                                    order by EMPCODE", "Centra", 'TCS'); ?>
                                                              
                                                                <? 	for($sql_emp_i = 0; $sql_emp_i < count($sql_emp); $sql_emp_i++) { ?>
																
									<option value='<?=$sql_emp[$sql_emp_i]['EMPCODE']?>'><?=$sql_emp[$sql_emp_i]['EMPNAME']." - ".$sql_emp[$sql_emp_i]['EMPCODE']." - ". $sql_emp[$sql_emp_i]['DESNAME']." - ". $sql_emp[$sql_emp_i]['BRNNAME']." - ". $sql_emp[$sql_emp_i]['ESENAME'].""?></option>
                                                ...
                                                <div class="col-sm-5 colheight" style="padding: 0px; line-height: 30px;">
												   ...
												   <? $sql_emp = select_query_json("select distinct emp.empsrno, emp.empcode, emp.empname, des.descode, des.desname, des.dessrno, ese.esecode, substr(ese.esename, 4, 100) esename 
																from trandata.employee_office@tcscentr emp, trandata.designation@tcscentr des, trandata.empsection@tcscentr ese 
																where emp.descode = des.descode and emp.esecode = ese.esecode
																	and des.deleted = 'N' and emp.brncode in (121, 888, 114, 1) and  rownum<10
																Order by des.dessrno, ese.esecode, emp.empcode;", "Centra", "TCS");
												    	for($sql_emp_i = 0; $sql_emp_i < count($sql_emp); $sql_emp_i++) { ?>
