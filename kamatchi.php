...
$join=select_query_json("select * from TASK_GRADE  tg, employee_office  ef where tg.empsrno=ef.empsrno and ef.empsrno='".$_SESSION['tcs_empsrno']."' order by tg.TASKDATE", "Centra", "TEST");
}
?>
<!DOCTYPE html>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										...
										<!--		<div class="col-md-6">
						                        ...
						                        <? } else  ?>  
                                                    <input type="text" style=" text-transform: uppercase; position: relative; top: auto; right: auto; bottom: auto; left: auto;" class="form-control" name="txt_task_details" id="txt_task_details" autocomplete="off"  maxlength="100" tabindex="5"  data-toggle="tooltip" data-placement="top" placeholder="ENTER THE DETAILS" value='<?=$sql_reqid[0]['TASKDET']?>'>
												...
												<div class="form-group">
													...
													<div class="col-md-2 col-xs-4">
                                                     <input type='hidden' name='txt_task_from_timetxt_task_from_time' id='txt_task_from_time' value='<?=$sql_reqid[0]['ENTTIME']?>'>
						                              <? } else  ?>
                                                    <input type="time" style="cursor: pointer; text-transform: uppercase; position: relative; top: auto; right: auto; bottom: auto; left: auto;" class="form-control" name="txt_task_from_time" id="txt_task_from_time" autocomplete="off"  maxlength="11" tabindex="5"  data-toggle="tooltip" data-placement="top" value='<?=$sql_reqid[0]['ENTTIME']?>'>
							 ...
							 <input type='hidden' name='txt_task_to_time' id='txt_task_to_time' value='<?=$sql_reqid[0]['OUTTIME']?>'>
						              ...
						              <? } else  ?>
                                                    <input type="time" style="cursor: pointer; text-transform: uppercase; position: relative; top: auto; right: auto; bottom: auto; left: auto;" class="form-control" name="txt_task_to_time" id="txt_task_to_time" autocomplete="off"  maxlength="11" tabindex="5"  data-toggle="tooltip" data-placement="top" value='<?=$sql_reqid[0]['OUTTIME']?>'>
...
<tr class="odd gradeX" style='background-color:<?=$bgclr?>; color:<?=$clr?>;'>
							    ...
							    <td class="center"><? echo $join[$search_i]['TASKDATE'];?></td>
						...
						<td style='text-align:center'><a href='kamatchi.php?action=edit&reqid=<? echo $join[$search_i]['OUTTIME']; ?>' title='Edit' alt='Edit'><i class="fa fa-edit"></i> Edit</a> 
