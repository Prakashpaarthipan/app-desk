                    ...
                    <div class="panel-heading">
                        ...
                        <div class="pull-right">
                            <?  $menu_name = 'EMPLOYEE GRADE MASTER';
                                ...
                                if($inner_menuaccess[0]['VEWVALU'] == 'Y') { ?><a class="btn btn-danger" target="_blank" style="margin-right: 5px;" href="employee_add.php">(+) Add Employees</a>&nbsp;&nbsp;<? } ?><a class="btn btn-danger" target="_blank" style="margin-right: 50px;" href="employee_grade_fix_report_1.php">Grade Fix Report</a>
                        </div>
                    </div>
