        ...
        <div class="page-content">
            ...
            <div class="row" style="margin: 0px;">
                <?  $sql_ccnt = select_query_json("select nvl(sum(decode(APPSTAT||APPFRWD||REQSTFR,'NF".$_SESSION['tcs_empsrno']."', 1, 'NI".$_SESSION['tcs_empsrno']."', 1,
                                                            ...
                                                            group by ATCCODE order by ATCCODE", 'Centra', 'TCS');
                    ...
                    $sql_ccnt_priority = select_query_json("select nvl(sum(decode(PRICODE, '1', 1, '2', 1, '3', 1, '4', 1, '5', 1, 0)), 0) cntstat, PRICODE, decode(PRICODE, '1', 'DO RIGHT AWAY',
                                                                    ...
                                                                    group by PRICODE order by PRICODE", 'Centra', 'TCS');
                    ...
                    <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                        <? $sql_priority = select_query_json("select * from approval_priority where deleted = 'N'", 'Centra', 'TCS'); ?>
                        <div class="col-lg-12 col-sm-12 col-xs-12" style="padding:0;margin:10px 0">

                            <!-- Do Right Away -->
                            <div style="padding:0 10px">

                            <a href="<?=$link_name?>?status=waiting&prty=1">
                              <img src="images/dashboard/11.png" width="98%" style="position:relative" >
                                <div class="pull-right" style='font-size:16px; font-weight:bold; background-color:#FFFFFF;color:#000000;min-width: 30px;text-align: center;border-radius: 25px;margin: 5px 0px;right:1%;bottom:-6px;padding: 10px;position:absolute;border:solid 2px #E32139'><? if($sql_search2['1'][0]['CNTSTAT'] > 0) { echo $sql_search2['1'][0]['CNTSTAT']; } else { echo "0"; } ?></div>
                            </a>
                            </div>
                            <!-- Do Right Away -->
                        ...
                        <div class="col-lg-12 col-sm-12 col-xs-12" style="padding:0;margin:10px 0">
                            ...
                            <!-- Do Right Away -->
                            <div style="padding:0 10px; margin-top: 0%;" class=".hidden-sm">

                            <a href="<?=$link_name?>?status=waiting&prty=2">
                              <img src="images/dashboard/21.png" width="98%" style="position:relative" >
                                <div class="pull-right" style='font-size:16px; font-weight:bold;  background-color:#FFFFFF;color:#000000;min-width: 30px;text-align: center;border-radius: 25px;margin: 5px 0px;padding: 10px;right:1%;bottom:-6px;padding: 10px;position:absolute;border:solid 2px #00a651'><? if($sql_search2['2'][0]['CNTSTAT'] > 0) { echo $sql_search2['2'][0]['CNTSTAT']; } else { echo "0"; } ?></div>
                            </a>
                            </div>
                            <!-- Do Right Away -->
                        ...
                        <div class="col-lg-12 col-sm-12 col-xs-12" style="padding:0;margin:10px 0">
                            ...
                            <a href="<?=$link_name?>?status=waiting&prty=3">
                              <img src="images/dashboard/31.png" width="98%" style="position:relative" >
                                <div class="pull-right" style='font-size:16px; font-weight:bold; background-color:#FFFFFF;color:#000000;min-width: 30px;text-align: center;border-radius: 25px;margin: 5px 0px;padding: 10px;right:1%;bottom:-6px;padding: 10px;position:absolute;border:solid 2px #fff200'><? if($sql_search2['3'][0]['CNTSTAT'] > 0) { echo $sql_search2['3'][0]['CNTSTAT']; } else { echo "0"; } ?></div>
                            </a>
                            </div>
                            <!-- Do Right Away -->
                        ...
                        <? $sql_priority = select_query_json("select * from approval_priority where deleted = 'N'", 'Centra', 'TCS'); ?>
                        <div class="col-lg-12 col-sm-12 col-xs-12" style="padding:0;margin-top:10px;margin-bottom:10px">

                            <!-- Do Right Away -->
                            <div style="padding:0 10px; margin-top: 0%;" class=".hidden-sm">

                            <a href="<?=$link_name?>?status=waiting&prty=4">
                              <img src="images/dashboard/41.png" width="98%" style="position:relative" >
                                <div class="pull-right" style='font-size:16px; font-weight:bold; background-color:#FFFFFF;color:#000000;min-width: 30px;text-align: center;border-radius: 25px;margin: 5px 0px;padding: 10px;right:1%;bottom:-6px;padding: 10px;position:absolute;border:solid 2px #6e3694'><? if($sql_search2['4'][0]['CNTSTAT'] > 0) { echo $sql_search2['4'][0]['CNTSTAT']; } else { echo "0"; } ?></div>
                            </a>
                            </div>
                            <!-- Do Right Away -->
                        ...
                        <div class="col-lg-12 col-sm-12 col-xs-12" style="padding:0;margin-top:10px;margin-bottom:10px">
                            ...
                            <a href="<?=$link_name?>?status=waiting&prty=5">
                              <img src="images/dashboard/51.png" width="98%" style="position:relative" >
                                <div class="pull-right" style='font-size:16px; font-weight:bold;  background-color:#FFFFFF;color:#000000;min-width: 30px;text-align: center;border-radius: 25px;margin: 5px 0px;padding: 10px;right:1%;bottom:-6px;padding: 10px;position:absolute;border:solid 2px #32327b'><? if($sql_search2['5'][0]['CNTSTAT'] > 0) { echo $sql_search2['5'][0]['CNTSTAT']; } else { echo "0"; } ?></div>
                            </a>
                            </div>
                            <!-- Do Right Away -->
                ...
                <div>
                    <div class="res_das">
                        ...
                        <div class="col-md-6 cursor_pointer" title="Waiting with Query - <? echo $wwqr; ?>" onclick="location.href='waiting_query.php';">
                        ...
                        <div class="col-md-6 cursor_pointer" title="New Requests - <? echo $nwrq; ?>" onclick="location.href='request_list.php';">
                        ...
                        <div class="col-md-6 cursor_pointer" title="Sending With Query - <? echo $snqr; ?>" onclick="location.href='http://www.tcsportal.com/approval-desk/approved_approvals_list.php#/Internal Verification Approvals';">
                  ...
                  <div>
                    <div class="res_das">
                        <div class="col-md-6 cursor_pointer" title="Alternate User Requests - <? echo $nwal; ?>" onclick="location.href='<?=$link_name?>?status=alternate';">
                        ...
                        <div class="col-md-6 cursor_pointer" title="Post Audit Approvals - <? echo $poad; ?>" onclick="location.href='<?=$link_name?>?status=post_audit';">
                    ...
                    <!-- Start template Design -->
                        <div class="col-md-6 cursor_pointer" title="Acknowledge Approvals - <? echo $akap; ?>" onclick="location.href='acknowledge_approvals.php';">
                    ...
                    <? // if($nwbd > 0) { ?>
                        <div class="col-md-6 cursor_pointer" <? if($nwbd > 0 and $_SESSION['tcs_esecode'] == 137) { ?> onclick="popup_biddisplay()" <? } else { ?> onclick="location.href='<?=$link_name?>?status=bid';" <? } ?>>
