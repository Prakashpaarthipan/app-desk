            ...
            <div class="page-content-wrap" style="padding:10px;">
                <div class="panel panel-default">
					...
					$sql_search = select_query_json("select distinct atycode,aprnumb,appstat,appfval,arqcode,arqyear,arqsrno,atccode,apprdet,tarnumb,tardesc, 
																		...
																		(SELECT distinct aprnumb FROM trandata.approval_budget_planner@tcscentr bud	WHERE bud.deleted='N' AND   bud.APPYEAR=TO_CHAR(sysdate,'YYYY') and bud.APPMNTH=TO_CHAR(sysdate-10,'MM') and bud.APPRVAL>0 )group by aprnumb)","Centra","TCS");
