...
<div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-danger" target="_blank" style="margin-right: 5px;" href="employee_add.php">(+) Add Employees</a>&nbsp;&nbsp;<a class="btn btn-danger" target="_blank" style="margin-right: 50px;" href="employee_grade_fix_report1.php">Grade Fix Report</a><br><br>
                        </div>
                    </div>
                        ...
                        <table id="customers" class="table datatable" border="1">
                            ...
                            <tr class="odd gradeX" style='background-color:<?=$bgclr?>; color:<?=$clr?>;'>
                                ...
                                <td class="center" style="text-align: center;">
                                    <select id="txt_employee_grade_<?=$search_i;?>" name='txt_employee_grade_<?=$search_i;?>' class="txt_employee_grade" onchange="task_assign('<?=$join[$search_i]['EMPSRNO']?>', '<?=$search_i?>');" style="min-height: 25px;">
                                        <? $sql_empgrade = select_query_json("select EMPGRAD, EMPRMRK from EMPLOYEE_GRADE_FIX 
                                                                                    where deleted = 'N' and EMPSRNO = '".$join[$search_i]['EMPSRNO']."' 
                                                                                        and trunc(ADDDATE) = trunc(sysdate)", 'Centra', 'TEST'); ?>
    ...
    function task_assign(empsrno, iv) {
        ...
        var strURL="ajax/fix_grade.php?action=fix_grade&empsrno="+empsrno+"&grade="+grade+"&txt_empgrade_remarks="+txt_empgrade_remarks;
        if(grade != '') {
            $.ajax({
                type: "POST",
                url: strURL,
