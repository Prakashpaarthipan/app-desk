...
$sql_fields=select_query_json("select FIELDNM,FIELDNO,FIELDTY from SUPMAIL_PROCESS_FIELD a where a.PRCSNO='".$processno."' and a.PRCSYR='".$processyear."' and a.DELETED='N' order by a.FIELDNM asc","Centra",'TEST');
