			...
			<table border=0 style='width:100%; max-width: 773px; '>
				...
				<?  $sql_renewal = select_query_json("select * from APPROVAL_AGREEMENT_RENEWAL
					...
					<tr style='min-height:20px; line-height:20px;'>
						...
						<td style='width:80%; text-align:left;'>
							<span style="font-size:12px; font-weight: normal; line-height:20px;">:</span> <span style=" font-size: 18px; font-weight: bold;" class="blue_highlight"><?=strtoupper(date('d-M-Y',strtotime($sql_renewal[0]['AGFRDAT'])));?>  -  <?=strtoupper(date('d-M-Y',strtotime($sql_renewal[0]['AGTODAT'])));?></span></label> <!-- RENEWAL Period -->
						</td>
					</tr>
					<?}?>
												...
												<td class="colheight" style="padding: 1px 0px 1px 3px; width: 39%; text-align: left;">
													...
													<? echo "<ul id=\"lightgallery\" class=\"list-unstyled row lightgallery\" style='float:left; margin:0px;'>";
		                                                if($prdlist['PRDIMAG'] != '-' and $prdlist['PRDIMAG'] != '') {
		                                                    ...
		                                                    {
		                                                        case 'i':
		                                                                $folder_path = "approval_desk1/product_images/".$dataurl."/";
		                                                                $thumbfolder_path = "approval_desk1/product_images/".$dataurl."/thumb_images/";
