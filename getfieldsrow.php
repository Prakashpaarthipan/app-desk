...
$sql_fields=select_query_json("select FIELDNM,FIELDVAL from SUPMAIL_PROCESS_FIELD a,SUPMAIL_PROCESS_VALUE b where a.PRCSNO='".$processno."' and a.PRCSYR='".$processyear."' and b.PRCSNO='".$processno."' and b.PRCSYR='".$processyear."' and a.FIELDNM=b.FIELDNM and a.DELETED='N' and b.DELETED='N'","Centra",'TEST');
