...
.nav-tabs > li.active > a, .nav-tabs > li.active > a:hover, .nav-tabs > li.active > a:focus {
            ...
            <div class="page-content">
                ...
                <div class="page-content-wrap">
                    ...
                    <ul class="nav nav-tabs">
                      ...
                      <li class="active"><a href="#tab_2" data-toggle="tab"  title ="attendance">Attendance</a></li>
                      <li class=""><a href="#tab_3" data-toggle="tab"  title ="special">Special</a></li>
    ...
    <!-- START SCRIPTS -->
        ...
        <!-- END TEMPLATE -->
        <script type="text/javascript" src="prakash/js/vue.js"></script>
        <script type="text/javascript" src="prakash/js/axios.js"></script>
        <script type="text/javascript" src="prakash/js/app.js"></script>
