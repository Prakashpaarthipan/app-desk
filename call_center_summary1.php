                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default tabs">                            
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li><a role="tab" href="#tab-second" data-toggle="tab">TOPCORE</a></li>
                                    <li><a role="tab" href="#tab-third" data-toggle="tab">SUB CORE</a></li>
                                    <li><a role="tab" href="#tab-fourth" data-toggle="tab">OPERATION</a></li>
                                    <li><a role="tab" href="#tab-fifth" data-toggle="tab">POLICY</a></li>
                                </ul>                            
                                <div class="panel-body tab-content">
                                    <div class="tab-pane active" id="tab-first">
                                        <table  class="table datatable table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="center" style='text-align:center'>Top Core</th>
                                                     <th class="center" style='text-align:center'>Subcore</th>
                                            ...
                                            //echo('</pre>');
                                            $ki = 0;
                                            for($i=0;$i<count($sql_search1);$i++){//echo $sql_search[$k]['ENTSTAT'];
                                                 $ki++; ?>
                                    ...
                                    <div class="tab-pane " id="tab-second">
                                        <table  class="table datatable table-striped">
                                            ...
                                            $sql_search = select_query_json("select atcname,sub.esename,ATYNAME,APMNAME from trandata.approval_topcore@tcscentr atc, trandata.approval_master@tcscentr mas, trandata.approval_type@tcscentr typ,trandata.empsection@tcscentr sub where atc.atccode=mas.topcore and atc.atccode=1 and typ.atycode=mas.atycode and sub.esecode(+)=mas.subcore and sub.deleted(+)='N'", "Centra", 'TCS');
                                    ...
                                    <div class="tab-pane " id="tab-third">
                                        ...
                                        <table  class="table datatable table-striped">
                                            ...
                                            $sql_search = select_query_json("select atcname,sub.esename,ATYNAME,APMNAME from trandata.approval_topcore@tcscentr atc, trandata.approval_master@tcscentr mas, trandata.approval_type@tcscentr typ,trandata.empsection@tcscentr sub where atc.atccode=mas.topcore and atc.atccode=2 and typ.atycode=mas.atycode and sub.esecode(+)=mas.subcore and sub.deleted(+)='N'", "Centra", 'TCS');
                                    ...
                                    <div class="tab-pane " id="tab-fourth">
                                        ...
                                        <table  class="table datatable table-striped">
                                            ...
                                            $sql_search = select_query_json("select atcname,sub.esename,ATYNAME,APMNAME from trandata.approval_topcore@tcscentr atc, trandata.approval_master@tcscentr mas, trandata.approval_type@tcscentr typ,trandata.empsection@tcscentr sub where atc.atccode=mas.topcore and atc.atccode=3 and typ.atycode=mas.atycode and sub.esecode(+)=mas.subcore and sub.deleted(+)='N'", "Centra", 'TCS');
                                    ...
                                    <div class="tab-pane " id="tab-fifth">
                                        ...
                                        <table  class="table datatable table-striped">
                                            ...
                                            $sql_search = select_query_json("select atcname,sub.esename,ATYNAME,APMNAME from trandata.approval_topcore@tcscentr atc, trandata.approval_master@tcscentr mas, trandata.approval_type@tcscentr typ,trandata.empsection@tcscentr sub where atc.atccode=mas.topcore and atc.atccode=4 and typ.atycode=mas.atycode and sub.esecode(+)=mas.subcore and sub.deleted(+)='N'", "Centra", 'TCS');
