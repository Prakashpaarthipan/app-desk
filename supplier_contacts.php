                                    ...
                                    <form class="form-horizontal" action="">
                                        <div class="form-group" >
                                            <div class="col-md-6 col-md-offset-3" >
                                                <div><p style="color:gray; text-align: center; font-size: 14px">Use search to find contacts. You can search by: name,code, mobile no.</p></div>
                                                <div class="input-group" >
                                                    <div class="input-group-addon">
                                                        <span class="fa fa-search"></span>
                                                    </div>
                                                    <input type="text" class="form-control" placeholder="Search your query" id="supplier_list" onfocus ="myFunction(this)" onblur="loadback(this)" autocomplete="off" />
                        ...
                        $("#load_page").show();
                           ...
                           if(search != '' ){
                            $.ajax({
                                    type:'post',
                                    data:{search:search},
                                    url:"ajax/supplier_list.php?action=textsearch",
                                    async: true,
                                   dataType:'text',
                                   success:function(data)
                                   {
