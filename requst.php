...
<!-- START SCRIPTS -->
    ...
    function checkform() {
        $("#id_policy_approval").on('submit',(function(e) {
            // alert("~~");
            e.preventDefault();
            checkform_check();
            ...
            if(flag == 1) {
                ...
                var data_serialize = $("#id_policy_approval").serialize();
    ...
    $("#sbmt_request").click(function(e){
        ...
        if (id_policy_approval.slt_submission.value == "") {
            var ALERT_TITLE = "Message";
            var ALERTMSG = "Please choose the type of submission";
            createCustomAlert(ALERTMSG, ALERT_TITLE);
            // id_policy_approval.slt_submission.focus();
            $('#load_page').hide();
            gtvl = 0 ;
        }

        if (id_policy_approval.slt_approval_listings.value == "") {
            var ALERT_TITLE = "Message";
            var ALERTMSG = "Please choose the approval listings";
            createCustomAlert(ALERTMSG, ALERT_TITLE);
            // id_policy_approval.slt_approval_listings.focus();
            $('#load_page').hide();
            gtvl = 0 ;
        }

        if (id_policy_approval.txt_workintiator.value == "" || id_policy_approval.txt_workintiator.value == " -  - ") {
            id_policy_approval.txt_workintiator.value = '';
            // alert( "Please enter the submission request by user id" );
            var ALERT_TITLE = "Message";
            var ALERTMSG = "Please enter the Work Initiate Person user id";
            createCustomAlert(ALERTMSG, ALERT_TITLE);
            id_policy_approval.txt_workintiator.focus();
            $('#load_page').hide();
            gtvl = 0 ;
        }
    ...
    <?  /* $sql_chklist = select_query_json("select * from approval_checklist where deleted = 'N' and tarnumb = 7515 order by apcklst");
        ...
        if(enable1 == 1) {
            if (id_policy_approval.txt_submission_quotations.value == "" && id_policy_approval.txt_submission_quotations_remarks.value == "") {
                id_policy_approval.txt_submission_quotations_remarks.value = '';
                var ALERT_TITLE = "Message";
                var ALERTMSG = "Kindly fill the remarks for the Quotations & Estimations..";
                createCustomAlert(ALERTMSG, ALERT_TITLE);
                id_policy_approval.txt_submission_quotations_remarks.focus();
                $('#load_page').hide();
                gtvl = 0;
            }
        }
        ...
        if(enable2 == 1) {
        // alert("=="+id_policy_approval.txt_submission_fieldimpl.value+"=="+id_policy_approval.txt_submission_fieldimpl_remarks.value+"==");
            if (id_policy_approval.txt_submission_fieldimpl.value == "" && id_policy_approval.txt_submission_fieldimpl_remarks.value == "") {
                // alert("CAME1");
                id_policy_approval.txt_submission_fieldimpl_remarks.value = '';
                var ALERT_TITLE = "Message";
                var ALERTMSG = "Kindly fill the remarks for the Budget / Common Approval..";
                createCustomAlert(ALERTMSG, ALERT_TITLE);
                id_policy_approval.txt_submission_fieldimpl_remarks.focus();
                $('#load_page').hide();
                // alert("CAME2");
                gtvl = 0;
            }
        ...
        if(enable3 == 1) {
            if (id_policy_approval.txt_submission_clrphoto.value == "" && id_policy_approval.txt_submission_clrphoto_remarks.value == "") {
                id_policy_approval.txt_submission_clrphoto_remarks.value = '';
                var ALERT_TITLE = "Message";
                var ALERTMSG = "Kindly fill the remarks for the Work Place Before / After Photo / Drawing Layout..";
                createCustomAlert(ALERTMSG, ALERT_TITLE);
                id_policy_approval.txt_submission_clrphoto_remarks.focus();
                $('#load_page').hide();
                gtvl = 0;
            }
        }
        ...
        if(enable4 == 1) {
            if (id_policy_approval.txt_submission_artwork.value == "" && id_policy_approval.txt_submission_artwork_remarks.value == "") {
                id_policy_approval.txt_submission_artwork_remarks.value = '';
                var ALERT_TITLE = "Message";
                var ALERTMSG = "Kindly fill the remarks for the Art Work Design with MD Approval..";
                createCustomAlert(ALERTMSG, ALERT_TITLE);
                id_policy_approval.txt_submission_artwork_remarks.focus();
                $('#load_page').hide();
                gtvl = 0;
            }
        }
        ...
        if(enable5 == 1) {
            if (id_policy_approval.txt_submission_othersupdocs.value == "" && id_policy_approval.txt_submission_othersupdocs_remarks.value == "") {
                id_policy_approval.txt_submission_othersupdocs_remarks.value = '';
                var ALERT_TITLE = "Message";
                var ALERTMSG = "Kindly fill the remarks for the Consultant Approval..";
                createCustomAlert(ALERTMSG, ALERT_TITLE);
                id_policy_approval.txt_submission_othersupdocs_remarks.focus();
                $('#load_page').hide();
                gtvl = 0;
            }
        }
        ...
        if(enable6 == 1) {
            if (id_policy_approval.txt_warranty_guarantee.value == "") {
                id_policy_approval.txt_warranty_guarantee.value = '';
                var ALERT_TITLE = "Message";
                var ALERTMSG = "Kindly fill the Warranty / Guarantee details";
                createCustomAlert(ALERTMSG, ALERT_TITLE);
                id_policy_approval.txt_warranty_guarantee.focus();
                $('#load_page').hide();
                gtvl = 0;
            }
        }
        ...
        if(enable7 == 1) {
            if (id_policy_approval.txt_cur_clos_stock.value == "") {
                id_policy_approval.txt_cur_clos_stock.value = '';
                var ALERT_TITLE = "Message";
                var ALERTMSG = "Kindly fill the Current / Closing Stock details";
                createCustomAlert(ALERTMSG, ALERT_TITLE);
                id_policy_approval.txt_cur_clos_stock.focus();
                $('#load_page').hide();
                gtvl = 0;
            }
        }
        ...
        if(enable8 == 1) {
            if (id_policy_approval.txt_advpay_comperc.value == "") {
                id_policy_approval.txt_advpay_comperc.value = '';
                var ALERT_TITLE = "Message";
                var ALERTMSG = "Kindly fill the Advance or Final Payment / Work Completion Percentage details";
                createCustomAlert(ALERTMSG, ALERT_TITLE);
                id_policy_approval.txt_advpay_comperc.focus();
                $('#load_page').hide();
                gtvl = 0;
            }
        }
        ...
        if(enable9 == 1) {
            if (id_policy_approval.datepicker_example4.value == "") {
                id_policy_approval.datepicker_example4.value = '';
                var ALERT_TITLE = "Message";
                var ALERTMSG = "Kindly fill the Work Finish Target Date details";
                createCustomAlert(ALERTMSG, ALERT_TITLE);
                id_policy_approval.datepicker_example4.focus();
                $('#load_page').hide();
                gtvl = 0;
            }
        }
        ...
        if (id_policy_approval.txt_submission_reqby.value == "" || id_policy_approval.txt_submission_reqby.value == " -  - ") {
            id_policy_approval.txt_submission_reqby.value = '';
            // alert( "Please enter the submission request by user id" );
            var ALERT_TITLE = "Message";
            var ALERTMSG = "Please enter the responsible user id";
            createCustomAlert(ALERTMSG, ALERT_TITLE);
            id_policy_approval.txt_submission_reqby.focus();
            $('#load_page').hide();
            gtvl = 0 ;
        }
        if (id_policy_approval.txt_submission_reqby.value == id_policy_approval.txt_alternate_user.value) {
            id_policy_approval.txt_alternate_user.value = '';
            var ALERT_TITLE = "Message";
            var ALERTMSG = "Responsible User & Alternate User must be the different users.";
            createCustomAlert(ALERTMSG, ALERT_TITLE);
            id_policy_approval.txt_alternate_user.focus();
            $('#load_page').hide();
            gtvl = 0 ;
        }
        ...
        if (id_policy_approval.txtfrom_date.value == "") {
            // alert( "Please enter the from date" );
            var ALERT_TITLE = "Message";
            var ALERTMSG = "Please enter the from date";
            createCustomAlert(ALERTMSG, ALERT_TITLE);
            id_policy_approval.txtfrom_date.focus();
            $('#load_page').hide();
            gtvl = 0 ;
        }
        if (id_policy_approval.txtto_date.value == "") {
            // alert( "Please enter the to date" );
            var ALERT_TITLE = "Message";
            var ALERTMSG = "Please enter the to date";
            createCustomAlert(ALERTMSG, ALERT_TITLE);
            id_policy_approval.txtto_date.focus();
            $('#load_page').hide();
            gtvl = 0 ;
        }

        if (id_policy_approval.txtnoofhours.value == "") {
            // alert( "Please enter the no of hours" );
            var ALERT_TITLE = "Message";
            var ALERTMSG = "Please enter the no of hours";
            createCustomAlert(ALERTMSG, ALERT_TITLE);
            id_policy_approval.txtnoofhours.focus();
            $('#load_page').hide();
            gtvl = 0 ;
        }
        if (id_policy_approval.txtnoofdays.value == "") {
            // alert( "Please enter the no of days" );
            var ALERT_TITLE = "Message";
            var ALERTMSG = "Please enter the no of days";
            createCustomAlert(ALERTMSG, ALERT_TITLE);
            id_policy_approval.txtnoofdays.focus();
            $('#load_page').hide();
            gtvl = 0 ;
        }
        ...
        if($('#getmonthwise_budget').css('display') == 'block') {
            ...
            if (myElem === null) {
                ...
                $('#slt_targetno').focus();
                id_policy_approval.slt_targetno.focus();
                $('#load_page').hide();
                gtvl = 0;
            } else {
                /*if (id_policy_approval.frmdate.value == "") {
                    // alert( "Please enter the from month" );
                    var ALERT_TITLE = "Message";
                    var ALERTMSG = "Please enter the from month";
                    createCustomAlert(ALERTMSG, ALERT_TITLE);
                    id_policy_approval.frmdate.focus();
                    $('#load_page').hide();
                    gtvl = 0 ;
                }
                if (id_policy_approval.todate.value == "") {
                    // alert( "Please enter the to month" );
                    var ALERT_TITLE = "Message";
                    var ALERTMSG = "Please enter the to month";
                    createCustomAlert(ALERTMSG, ALERT_TITLE);
                    id_policy_approval.todate.focus();
                    $('#load_page').hide();
                    gtvl = 0 ;
                }
                if (id_policy_approval.txtrequest_value.value == "0" || id_policy_approval.txtrequest_value.value == "") {
                    // alert( "Please enter some value here" );
                    var ALERT_TITLE = "Message";
                    var ALERTMSG = "Please enter some value here";
                    createCustomAlert(ALERTMSG, ALERT_TITLE);
                    id_policy_approval.txtrequest_value.focus();
                    $('#load_page').hide();
                    gtvl = 0 ;
            } */
            }
        ...
        if($("#slt_submission").val() == 1 || $("#slt_submission").val() == 6 || $("#slt_submission").val() == 7) {
            ...
            /* if (id_policy_approval.txt_suppliercode.value == "") {
                // alert( "Please enter the details" );
                var ALERT_TITLE = "Message";
                var ALERTMSG = "Please enter the Supplier Details";
                createCustomAlert(ALERTMSG, ALERT_TITLE);
                id_policy_approval.txt_suppliercode.focus();
                $('#load_page').hide();
                gtvl = 0 ;
            }
            if (id_policy_approval.txt_supplier_contactno.value == "") {
                // alert( "Please enter the details" );
                var ALERT_TITLE = "Message";
                var ALERTMSG = "Please enter the Supplier Contact No";
                createCustomAlert(ALERTMSG, ALERT_TITLE);
                id_policy_approval.txt_supplier_contactno.focus();
                $('#load_page').hide();
                gtvl = 0 ;
            } */
