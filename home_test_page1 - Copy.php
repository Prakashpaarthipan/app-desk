...
<style type="text/css" media="screen">
                                  ...
                                  @media only screen and (min-width: 1333px) {
                                          ...
                                          /*border-style: solid;
                                          font-size:16px; font-weight:bold; background-color:#FFFFFF;color:#000000;min-width: 30px;text-align: center;border-radius: 25px;margin: 5px 0px;right:1%;bottom:-6px;padding: 10px;position:absolute;border:solid 2px #E32139
                                          */
                                          position:relative;
                                          margin-left: 119px;
                                        ...
                                        .num_4{
                                          border: 6px solid #6e3694;
                                        }

                                        .num_5{
                                          border: 6px solid #32327b;
                                        }
                                      ...
                                      @media only screen and (max-width: 1332px) and (min-width: 925px) {
                                          .badge12 {
                                          height: 40px;
                                          min-width: 40px;
                                          display: inline-block;
                                        ...
                                        .num_4{
                                          border: 4px solid #6e3694;
                                        }

                                        .num_5{
                                          border: 4px solid #32327b;
                                        }
                                        ...
                                        .num_4{
                                          border: 10px solid #6e3694;
                                        }

                                        .num_5{
                                          border: 10px solid #32327b;
                                        }
                ...
                <?  $sql_ccnt = select_query_json("select nvl(sum(decode(APPSTAT||APPFRWD||REQSTFR,'NF".$_SESSION['tcs_empsrno']."', 1, 'NI".$_SESSION['tcs_empsrno']."', 1,
                    ...
                    $pr5 = count(array_keys($sql_search2['5'])); ?>
                     ...
                     <div class="res_das" style="align-content: center">
                        ...
                        <div class="col-md-4 col-lg-2 col-sm-6 col-xs-12 cursor_pointer" title="Waiting with Query - <? echo $wwqr; ?>" onclick="location.href='waiting_query.php';">
                            <!-- <div class="dash-box dash-box-color-1"> 
                                <div class="dash-box-icon">
                                    <i class="fa fa-question-circle"></i>
                                </div>-->
                                <a href="<?=$link_name?>?status=waiting&prty=1">
                                      <img src="images/dashboard/img1_.png" width="75%" >
                                      

                                       <div class="badge12 num_1">2</div> 
                                    </a>
                            
                        </div>
                        <div class="col-md-4 col-lg-2 col-sm-6 col-xs-12  cursor_pointer" title="Waiting with Query - <? echo $wwqr; ?>" onclick="location.href='waiting_query.php';">
                          <a href="">
                              <img src="images/dashboard/img2_.png" width="75%" style="position:relative">
                                ...
                                <div class="badge12 num_2"  > 1 </div> 
                            </a>
                        </div>
                         <div class="col-md-4 col-lg-2 col-sm-6 col-xs-12  cursor_pointer" title="Waiting with Query - <? echo $wwqr; ?>" onclick="location.href='waiting_query.php';">
                         <a href="">
                              <img src="images/dashboard/img3_.png" width="75%"  style="position:relative">
                                ...
                                <div class="badge12 num_3"> 2 </div> 
                            </a>
                        </div>
                        <div class="col-md-4 col-lg-2 col-sm-6 col-xs-12  cursor_pointer" title="Waiting with Query - <? echo $wwqr; ?>" onclick="location.href='waiting_query.php';">
                             <a href="">
                              <img src="images/dashboard/img4_.png" width="75%"  style="position:relative">
                              
                                <!-- <div class="pull-right" style='font-size:18px; font-weight:bold; background-color:#FFFFFF;color:#000000;min-width: 40px;text-align: center;border-radius: 30px;margin:48px 64px;padding:12px;right:1%;bottom:-6px;position:absolute;border:solid 2px #6e3694'><? if($sql_search2['4'][0]['CNTSTAT'] > 0) { echo $sql_search2['4'][0]['CNTSTAT']; } else { echo "0"; } ?></div> -->
                                <div class="badge12 num_4">  6</div> 

                                </a>
                        </div>
                         <div class="col-md-4 col-lg-2 col-sm-6 col-xs-12  cursor_pointer" title="Waiting with Query - <? echo $wwqr; ?>" onclick="location.href='waiting_query.php';">
                             <a href="">
                              <img src="images/dashboard/img5_.png" width="75%"  style="position:relative">
