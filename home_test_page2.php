                ...
                <?  $sql_ccnt = select_query_json("select nvl(sum(decode(APPSTAT||APPFRWD||REQSTFR,'NF".$_SESSION['tcs_empsrno']."', 1, 'NI".$_SESSION['tcs_empsrno']."', 1,
                    ...
                    $pr5 = count(array_keys($sql_search2['5'])); ?>
                     ...
                     <div class="res_das" style="align-content: center">
                        ...
                        <div class="col-md-2 col-lg-2 col-sm-4 col-xs-12 cursor_pointer logo" title="Waiting with Query - <? echo $wwqr; ?>" onclick="location.href='waiting_query.php';">
                            <!-- <div class="dash-box dash-box-color-1"> 
                                ...
                                <a href="<?=$link_name?>?status=waiting&prty=1" >
                                      <img class="image" src="images/dashboard/shape1.png" width="90%" style="position:relative">
                        ...
                        <div class="col-md-2 col-lg-2 col-sm-4 col-xs-12 cursor_pointer logo" title="Waiting with Query - <? echo $wwqr; ?>" onclick="location.href='waiting_query.php';">
                          <a href="">
                              <img class="image" src="images/dashboard/shape3.png" width="90%" style="position:relative">
                         ...
                         <div class="col-md-2 col-lg-2 col-sm-4 col-xs-12 cursor_pointer logo" title="Waiting with Query - <? echo $wwqr; ?>" onclick="location.href='waiting_query.php';">
                         <a href="">
                              <img  class="image" src="images/dashboard/shape2.png" width="90%"  style="position:relative">
                        ...
                        <div class="col-md-2 col-lg-2 col-sm-4 col-xs-12 cursor_pointer logo" title="Waiting with Query - <? echo $wwqr; ?>" onclick="location.href='waiting_query.php';">
                             <a href="">
                              <img class="image" src="images/dashboard/shape4.png" width="90%"  style="position:relative">
                         ...
                         <div class="col-md-2 col-lg-2 col-sm-4 col-xs-12 cursor_pointer logo" title="Waiting with Query - <? echo $wwqr; ?>" onclick="location.href='waiting_query.php';">
                             <a href="">
                              <img class="image" src="images/dashboard/shapenew5.png" width="90%"  style="position:relative">
            ...
            <!-- APP LEVEL -->
                ...
                <div>
                    ...
                    <div class="res_das">
                        ...
                        <div class="col-md-4 col-sm-6 cursor_pointer" title="Waiting with Query - <? echo $wwqr; ?>" onclick="location.href='waiting_query.php';">
                            <div class="dash-box dash-box-color-1">
                                <div class="dash-box-icon">
                                    <i class="fa fa-question-circle"></i>
                                </div>
                        ...
                        <div class="col-md-4 col-sm-6 cursor_pointer" title="Waiting for Approval - <? echo $wapp; ?>" onclick="location.href='<? if($_SESSION['tcs_usrcode'] == '9938358' or $_SESSION['tcs_usrcode'] == '9193333' or $_SESSION['tcs_usrcode'] == '3000000' or $_SESSION['tcs_usrcode'] == '7292222' or $_SESSION['tcs_usrcode'] == '4003579') { ?><?=$link_name?>?status=waiting<? } else { ?><?=$link_name?>?status=waiting<? } ?>';">
                        ...
                        <div class="col-md-4 col-sm-6 cursor_pointer" title="New Requests - <? echo $nwrq; ?>" onclick="location.href='request_list.php';">
                        ...
                        <div class="col-md-4 col-sm-6 cursor_pointer" title="Sending With Query - <? echo $snqr; ?>" onclick="location.href='http://www.tcsportal.com/approval-desk/approved_approvals_list.php#/Internal Verification Approvals';">
                  ...
                  <div>
                    <div class="res_das">
                        <div class="col-md-4 col-sm-6 cursor_pointer" title="Alternate User Requests - <? echo $nwal; ?>" onclick="location.href='<?=$link_name?>?status=alternate';">
                        ...
                        <div class="col-md-4 col-sm-6 cursor_pointer" title="Post Audit Approvals - <? echo $poad; ?>" onclick="location.href='<?=$link_name?>?status=post_audit';">
                    ...
                    <!-- Start template Design -->
                        <div class="col-md-4 col-sm-6 cursor_pointer" title="Acknowledge Approvals - <? echo $akap; ?>" onclick="location.href='acknowledge_approvals.php';">
                    ...
                    <? // if($nwbd > 0) { ?>
                        <div class="col-md-4 col-sm-6 cursor_pointer" <? if($nwbd > 0 and $_SESSION['tcs_esecode'] == 137) { ?> onclick="popup_biddisplay()" <? } else { ?> onclick="location.href='<?=$link_name?>?status=bid';" <? } ?>>
