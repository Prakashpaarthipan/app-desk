...
<body>
    ...
    <div class="page-container page-navigation-top-fixed">
        ...
        <div class="page-content">
            ...
            <form class="form-horizontal" role="form" id="frm_requirement_entry" name="frm_requirement_entry" action="nancy/insert_fil.php" method="post" enctype="multipart/form-data">
								...
								<div class="panel panel-default">
					                 ...
					                 <div class="row colheight" style="margin-right: 0px;width:100%; text-transform: uppercase; background-color: #666666; color:#FFFFFF;  line-height: 25px; font-weight: bold; text-align: center;">
                                            ...
                                            <div class="row" style="margin-left: 0px; display: flex; text-transform: uppercase;">
												...
												<?  if($_REQUEST['action'] == 'view') {
                                                    ...
                                                    <input type="text" style="cursor: pointer; text-transform: uppercase; position: relative; top: auto; right: auto; bottom: auto; left: auto;width:350px;" class="form-control" required name="datepicker-example11" id="datepicker-example11" autocomplete="off" readonly="readonly" maxlength="18" tabindex="5" value='16-AUG-2018' data-toggle="tooltip" data-placement="top" placeholder="From Date" title=""  >
                                                   <?  } ?>
												</div></td><td>
                                            ...
                                            <div class="row" style="margin-right: 0px; display: flex; text-transform: uppercase;">
											   ...
											   <input type="text" style="cursor: pointer; text-transform: uppercase; position: relative; top: auto; right: auto; bottom: auto; left: auto;width:350px;" class="form-control" required name="datepicker-example13" id="datepicker-example13" autocomplete="off" readonly="readonly" maxlength="11" tabindex="10" value="16-AUG-2018" data-toggle="tooltip" data-placement="top" placeholder="From Date" title=""  >
											    <?  } ?>			
												</div></td><td>
									...
									<option value='<?=$sql_emp[$sql_emp_i]['EMPCODE']?>'><?=$sql_emp[$sql_emp_i]['EMPCODE']." - ".$sql_emp[$sql_emp_i]['EMPNAME'].""?></option>
                                            ...
                                            <div class="row" style="margin-left: 0px; display: flex; text-transform: uppercase;">
                                                ...
                                                <div class="col-sm-10 colheight" style="padding: 0px; line-height: 30px;">
                                                    <input type='file' class="form-control policy_approval_required" style="text-transform: uppercase;" required name='attachments' id='attachments' data-toggle="tooltip" data-placement="top" data-original-title="DESK PROCEDURE" value=''>
                                                </div></td></tr>
                                                <tr><td colspan="2">
		                ...
		                var cnt = $('input.common_style:checked').length;
                         ...
                         $('#datepicker-example11').Zebra_DatePicker({		
                                  ...
                                  $('#datepicker-example12').Zebra_DatePicker({
                                      direction: ['<?=strtoupper(date("d-M-Y", strtotime("+1 days")))?>', ],
                                         format: 'd-M-Y'
                             });
