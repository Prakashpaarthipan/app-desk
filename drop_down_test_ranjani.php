                ...
                <div class="page-content-wrap">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                          ...
                          <form role="form" id='frm_project_creation' name='frm_project_creation' method='post' enctype="multipart/form-data" autocomplete="off" >
											  ...
											  <div id="add_ledger" class="form-group">
													...
													<div style="width:100%">
														...
														<div style="width:30%;float:right">
															<input type="text" name = 'txt_value[]' class="form-control" id='txt_values'   placeholder= "VALUES"  data-toggle ="tooltip" title ="values" required onkeypress="javascript:return isNumber(event)" autocomplete="off" maxlength = "7">
														</div>
													</div>
						...
						<!-- Form Data Div-->
						<div class = 'col-sm-6'>
							<div class = 'approve' style ="font-size:10px"><p></br>
							Approve Flow: </br> <b>
							1. S. ASHOKKUMAR </br>
							2. M.A SELVA MUTHU KUMAR </br>
							3. K. KUMARN </br>
							4. S. KAARTHI
							</b></p>
							</div>
					...
					var result = $('#frm_project_creation').serialize();
						 //alert (result);
						  $.ajax({
							...
							error:function(msg){
								alert("Failed to Create Project. Kindly Try Again ."+msg);
							}
							//complete:function()
							//{
