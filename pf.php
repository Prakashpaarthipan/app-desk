                        ...
                        <div class="col-md-3" id="po_list">
                           ...
                           <div class="panel panel-default tabs nav-tabs-vertical hover-box-def" style="height:600px;overflow-y: scroll;overflow-x: hidden;box-shadow: 0 0 5px black; border-radius: 10px;">    <ul class="nav nav-tabs " style="width: 100%;border-radius: 10px;">
                                  <?for($k=0;$k<sizeof($sql_po);$k++){
									  $supname=select_query_json("select sup.SUPNAME,city.CTYNAME from supplier sup,city city where sup.SUPCODE=(select distinct SUPCODE from order_tracking_detail where PORNUMB='".$sql_po[$k]['PORNUMB']."') and sup.CTYCODE=city.CTYCODE", "Centra", "TEST");
?>
								...
								<div class="row" style="border:1px solid #ccc;margin:0;font-size:12px !important;max-width:100%;cursor:pointer">
                                    <div class="col-md-12"  style="padding-top:5px;padding-left:0;padding-right:0;height:auto;max-width:100%">
										...
										Order No :  <a data-toggle="tab" onclick="load_process(' <?=$sql_po[$k]['PORYEAR']?>  <?=$sql_po[$k]['PONUMB']?> [ <?=$sql_no[$k]['PORDATE']?> ]');" style="border-radius: 10px; color: #002eff;"><?=$sql_po[$k]['PONUMB']?>[ <?=$sql_no[$k]['PORDATE']?> ]</a>
								
                                          </div>
                                          <div style="clear: both;"></div>
                                          <div class="col-md-12" style="padding: 5px 10px;">
                                              Supplier : <?=$sql_no[$k]['SUPCODE']." - ".$supname[0]['SUPNAME'].", ".$supname[0]['CTYNAME']?>
                                          </div><!-- rate -->
                                          <div style="clear: both;"></div>                                         
										  ...
										  <div class="col-md-6" style="padding:0; text-align: right; padding-right: 10px; padding: 5px 10px; padding-left: 2px;font-weight:bold;color: #FF0000;">
                                              Val : <?=number_format(($sql_no[$k]['PORVAL']/100000),2);?> L
                                          </div><!-- SGST -->
