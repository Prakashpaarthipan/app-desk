...
if($_REQUEST['rsrid'] == '') {
    ...
    /* $sql_rqsr = select_query_json("select max(arqsrno) arqsrno from approval_request 
                                            where ARQCODE = '".$_REQUEST['reqid']."' and ARQYEAR = '".$_REQUEST['year']."' and 
                                                ATCCODE = '".$_REQUEST['creid']."' and ATYCODE = '".$_REQUEST['typeid']."'", "Centra", 'TCS');
...
$sql_reqid = select_query_json("select req.*, prj.APRNAME, top.ATCNAME, typ.ATYNAME, apm.APMNAME, regexp_replace(SubStr(nicname,1,4),'[0-9]','')||SubStr(nicname,5,10) branch, emp.EMPCODE,
                                    ...
                                    where req.ATYCODE = typ.ATYCODE and req.APRCODE = prj.APRCODE and req.ATCCODE = top.ATCCODE and req.APMCODE = apm.APMCODE and req.PRICODE = pr.pricode(+) and
                                    ...
                                    order by req.ARQCODE, req.ARQSRNO, req.ATYCODE", "Centra", 'TCS'); // req.ATMCODE = apm.ATMCODE and ---- for Approval Master
...
if(count($sql_reqid) <= 0) {
    $sql_reqid = select_query_json("select req.*, req.ARQCODE arcode, req.ARQSRNO arsrno, req.ATYCODE atcode, prj.APRNAME, top.ATCNAME, typ.ATYNAME, apm.APMNAME,
                                        ...
                                        where req.ATYCODE = typ.ATYCODE and req.APRCODE = prj.APRCODE and req.ATCCODE = top.ATCCODE and req.APMCODE = apm.APMCODE and req.PRICODE = pr.pricode(+)
                                    ...
                                    union
                                        ...
                                        where req.ATYCODE = typ.ATYCODE and req.APRCODE = prj.APRCODE and req.ATCCODE = top.ATCCODE and req.APMCODE = apm.APMCODE and req.PRICODE = pr.pricode(+)
                                            ...
                                            and req.BRNCODE = brn.BRNCODE and req.DEPCODE = ast.DEPCODE and req.ARQCODE = '".$_REQUEST['reqid']."' and req.ARQYEAR = '".$_REQUEST['year']."' and
                                            req.ARQSRNO = '".$rqsrno."' and req.ATCCODE = '".$_REQUEST['creid']."' and req.ATYCODE = '".$_REQUEST['typeid']."'
                                        order by arcode, arsrno, atcode", "Centra", 'TCS'); // req.ATMCODE = apm.ATMCODE and ---- for Approval Master
}

$sql_emp = select_query_json("select asy.* from approval_salary where to_char(asy.VALUPTO,'dd-MON-yyyy hh:mi:ss AM') VALUPTO_Time and to_char(asy.EFFDATE,'dd-MON-yyyy hh:mi:ss AM') EFFDATE_Time and to_char(asy.APPDATE,'dd-MON-yyyy hh:mi:ss AM') APPDATE_Time ","centra",'TEST');
/*
$sql_reqid_edit = select_query_json("select APPROVAL_REQUEST.REQSTBY from APPROVAL_REQUEST
                                            ...
                                            order by ARQCODE, ARQSRNO, ATYCODE", "Centra", 'TCS');
...
$sql_emp=select_query_json("select * from approval_salary where aprnumb like '".$sql_emp[0]['APRNUMB']."' order by APRNUMB","centra","TCS");
?>
<!DOCTYPE html>
<html lang="en">
<head>
                ...
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-xs-12">
                                                ...
                                                <? } else { ?>
                                                    ...
                                                    <?  $sql_submission_type = select_query_json("select * from approval_type where DELETED = 'N' and ATYCODE not in (1) order by ATYSRNO", "Centra", 'TCS'); // 1 for FIXED BUDGET, 7 for Extra Budget
                                                        ?>
                                                ...
                                                <div class="col-md-9 col-xs-12">
                                                    ...
                                                    <? } else { ?>
                                                        ...
                                                        <?  if($sql_vl[0]['EXPSRNO'] == '') {
                                                                ...
                                                                $sql_project = select_query_json("select distinct EXPSRNO, EXPNAME from department_asset
                                                                                                            where DELETED = 'N' and expsrno > 0 and EXPSRNO = '".$sql_vl[0]['EXPSRNO']."' order by EXPNAME", "Centra", 'TCS');
                                                            }
                                                    ...
                                                    <div class="col-md-9 col-xs-12">
                                                        ...
                                                        <? } else { ?>
                                                            <select <? if($_REQUEST['action'] == 'edit') { ?>disabled class="form-control custom-select"<? } else { ?>class="form-control custom-select chosn" onblur="get_advancedetails(this.value)" onChange="get_advancedetails(this.value)"<? } ?> tabindex='5' required name='slt_department_asset' id='slt_department_asset' data-toggle="tooltip" data-placement="top" data-original-title="Department Asset">
                                                                <?  $sql_project = select_query_json("select * from department_asset where DELETED = 'N' and expsrno > 0 order by DEPNAME", "Centra", 'TCS');
                                                                    for($project_i = 0; $project_i < count($sql_project); $project_i++) { ?>
                                                    ...
                                                    <div class="col-md-9 col-xs-12">
                                                        <?  if($_REQUEST['action'] == 'view') {
                                                                ...
                                                                for ($rlapri = 0; $rlapri < count($sql_rlapr); $rlapri++) {
                                                                    ...
                                                                    <a target="_blank" href='view_approval.php?action=view&reqid=<? echo $sql_apr[0]['ARQCODE']; ?>&year=<? echo $sql_apr[0]['ARQYEAR']; ?>&rsrid=1&creid=<? echo $sql_apr[0]['ATCCODE']; ?>&typeid=<? echo $sql_apr[0]['ATYCODE']; ?>' title='View' alt='View' style='color:<?=$clr?>; font-weight:normal; font-size:10px;'><? echo $sql_apr[0]['APRNUMB']; ?></a><br>
                                                                <? }
                                                            ...
                                                            <tr><td>
                                                                <table class="monthyr_wrap" style='width:100%;'>
                                                                    <?  $sql_plan = select_query_json("select * from ".$rcrd."
                                                                                                                where aprnumb = '".$sql_reqid[0]['APRNUMB']."' order by APRSRNO asc", "Centra", 'TCS');
                                                                        $total_amt = 0;
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="tags_clear"></div>
                                        <div class="form-group">
                                            <? $sql_details = select_query_json("Select APPRSUB from APPROVAL_POLICY_FORM req
						...
						<div class="row">
									...
									<div class="panel-body">
										...
										<div class="row">
											   ...
											   <div class="form-group">
													...
													<div class="col-md-10"  >
													 <? $sql_emp = select_query_json("select distinct POLSUBJ
                                                                                       from approval_salary", "Centra", 'TCS');
																					    if($_REQUEST['action'] == 'view') {
                                                                echo ": ".$sql_emp[0]['POLSUBJ']." ";
                                                            } else { ?>	
												...
												<div class="form-group">
													...
													<div class="col-md-9 col-xs-12">
														...
														if($_REQUEST['action'] == 'view') {
                                                                ...
                                                                <input type="text" tabindex='24' name="impldue_date" id="tar_date" class="form-control" required readonly placeholder='Implementation Due Date' <?=$rdonly;?> autocomplete='off' value='<? if($sql_reqid[0]['FNTARDT'] != '') { echo strtoupper(date("d-M-Y", strtotime($sql_reqid[0]['FNTARDT']))); } else { echo strtoupper(date("d-M-Y")); } ?>' style='text-transform:uppercase; ' maxlength='11' title='Implementation Due Date'>
                                                        <? } ?>
                                                    </div>
																</div>
																 <? } ?>
												...
												<div class="form-group">
                                                    <label class="col-md-3 control-label">APPROVAL DATE<span style='color:red'>*</span></label>
                                                      <div class="col-md-9 col-xs-12">
                                                        <?  $sql_emp = select_query_json("select APPDATE ,ent.aprnumb
                                                                                       from approval_salary app,approval_request ent where ent.aprnumb=app.aprnumb", "Centra", 'TEST'); 
														if($_REQUEST['action'] == 'view') {
                                                                 echo ": ";
                                                                if($sql_emp[0]['APPDATE'] != '') { echo strtoupper(date("dd-Mon-yyyy HH:MI:SS AM~~", strtotime($sql_emp[0]['APPDATE']))); } else { echo strtoupper(date("dd-Mon-yyyy HH:MI:SS AM~~")); }
                                                           } else { ?>
                                                                <input type="text" tabindex='24' name="impldue_date" id="app_date" class="form-control" required readonly placeholder='Implementation Due Date' <?=$rdonly;?> autocomplete='off' value='<? if($sql_emp[0]['APPDATE'] != '') { echo strtoupper(date("d-M-Y", strtotime($sql_emp[0]['APPDATE']))); } else { echo strtoupper(date("d-M-Y")); } ?>' style='text-transform:uppercase; ' maxlength='11' title='Implementation Due Date'>
                                                        <? } ?>
                                                    </div>
                                                </div>
												<div class="form-group">
                            ...
                            <div class="col-md-9 col-xs-12">
                                <b>
                                   <?  $sql_emp = select_query_json("select   emp.EMPCODE, emp.EMPNAME, emp.ESECODE, sec.ESENAME, des.DESNAME,ent.aprnumb
                                                                                                  from employee_office emp, empsection sec, designation des,approval_salary app,approval_request ent
                                                                                                  where  ent.aprnumb=app.aprnumb and emp.EMPCODE=app.USELIST and emp.ESECODE = sec.ESECODE and emp.DESCODE = des.DESCODE 
                                                                                                 ", "Centra", 'TEST');  
                                                   if($_REQUEST['action'] == 'view') {
                                                                echo ": ".$sql_emp[0]['EMPCODE']." - <b>".$sql_emp[0]['EMPNAME']."</b> (".$sql_emp[0]['DESNAME'].") - ".substr($sql_emp[0]['ESENAME'], 3)." ";
                                                            } else { ?>																							 
                                    ...
                                    <?  } ?>     					    
												...
												<?/*<div class="form-group">    
												<label class ="col-sm-3 control-label" id='attachment'>DESK PROCEDURE <label>
													<div class="col-md-9 col-xs-12">
                                                    <? if($_REQUEST['action'] != 'view') { 
													echo ":";?>
                                                        <div><input type="file" placeholder="Quotations & Estimations" tabindex='12' class="form-control fileselect" name='txt_submission_quotations[]' id='txt_submission_quotations' onchange="ValidateSingleInput(this, 'all');" multiple accept="image/jpg,image/jpeg,image/gif,image/png,image/jpg,.pdf" value='' data-toggle="tooltip" data-placement="top" title="Quotations & Estimations"><span class="help-block">NOTE : ALLOWED ONLY PDF / IMAGES</span></div>
												...
												<div class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-xs-12">
													 <? $sql_emp = select_query_json("select POLIDOC,ent.aprnumb
                                                                                       from approval_salary app,approval_request ent where app.aprnumb=ent.aprnumb", "Centra", 'TEST');
																					    if($_REQUEST['action'] == 'view') {
                                                                echo ": ".$sql_emp[0]['POLIDOC']." ";
                                                            } else { ?>	
...
<!--fix me-->
											<div class="col-md-6">
												...
												<div class="form-group">
													...
													<div class="col-md-9">
													 <? $sql_emp = select_query_json("select  app.POLTYPE ,ent.aprnumb
                                                           from approval_salary app,approval_request ent where ent.aprnumb=app.aprnumb", "Centra", 'TEST');
																					   if($_REQUEST['action'] == 'view') {
                                                               echo ": ".$sql_emp[0]['POLTYPE']." ";
                                                            } else { ?>	
                            ...
                            <div class="col-md-9 col-xs-12"
                                <b>
								 <? $sql_emp = select_query_json("select  emp.EMPCODE,emp.EMPNAME,ent.aprnumb
                                                                                       from approval_salary app,employee_office emp,approval_request ent where ent.aprnumb=app.aprnumb and emp.EMPCODE=app.CRENAME ", "Centra", 'TEST');                                                                                                                                                                                                                                                                                                                  
                                    if($_REQUEST['action'] == 'view') {
                            ...
                            <div class="col-md-9 col-xs-12">
                                <b>
								<? $sql_emp = select_query_json("select emp.EMPCODE,emp.EMPNAME,ent.aprnumb
                                                                                       from approval_salary app,employee_office emp,approval_request ent where ent.aprnumb=app.aprnumb and emp.EMPCODE=app.COONAME ", "Centra", 'TEST');
																					   if($_REQUEST['action'] == 'view') {
                                                               echo ": ".$sql_emp[0]['EMPCODE']." - <b>".$sql_emp[0]['EMPNAME'].substr($sql_emp[0]['ESENAME'], 3)." ";
                                                            } else { ?>	
						...
						<div class="form-group">
                            ...
                            <div class="col-md-9 col-xs-12">
                                <b>
								 <? $sql_emp = select_query_json("select emp.EMPCODE,emp.EMPNAME,ent.aprnumb
                                                                                       from approval_salary	 app,employee_office emp,approval_request ent where app.aprnumb=ent.aprnumb and emp.EMPCODE=app.ASISTBY ", "Centra", 'TEST');
																					   if($_REQUEST['action'] == 'view') {
                                                               echo ": ".$sql_emp[0]['EMPCODE']." - <b>".$sql_emp[0]['EMPNAME'].substr($sql_emp[0]['ESENAME'], 3)." ";
                                                            } else { ?>	
                                  <input type="text" class="form-control policy_approval_required" style="text-transform: uppercase;" required readonly name='txtdynamic_asistby' id='txtdynamic_asistby' data-toggle="tooltip" data-placement="top" data-original-title="ASSISTBY"  value='<?=$sql_emp[0]['EMPCODE']." - ".$sql_emp[0]['EMPNAME']." - ".substr($sql_emp[0]['ESENAME'], 3)?>'>     
                                        ...
                                        <div class="tags_clear"></div>
                                        <div class="form-group">
                                            <? $sql_details = select_query_json("Select FILEPOL from APPROVAL_SALARY app,APPROVAL_REQUEST req
                                                                                        where ent.aprnumb = app.aprnumb
                                                                                        ", "Centra", "TCS"); ?>
                                            <label class="col-md-3 control-label" style="text-align: left;">Details <span style='color:red'>*</span> : </label>
                                           <div class="tags_clear height10px"></div>
                                            <div class="col-md-12" style="border: 1px solid #dadada; padding: 5px !important;">
                                                <?  if($_REQUEST['action'] == 'view') {
                                                        if($sql_reqid[0]['APPRFOR'] == '1') {
                                                            $filepathname = $sql_details[0]['APRNUMB'];
                                                            $filename = "ftp://".$ftp_user_name_apdsk.":".$ftp_user_pass_apdsk."@".$ftp_server_apdsk.$ftp_srvport_apdsk."/approval_desk/text_approval_source/".$filepathname;
                                                            $handle = fopen($filename, "r") or die("The content might not be available!. Contact Admin - ". $sql_details[0]['APRNUMB']);
                                                            $contents = fread($handle, filesize($filename));
                                                            fclose($handle);
                                                            echo $contents;
                                                        } else {
                                                        ...
                                                        <? /* <textarea class="form-control" <? if($_REQUEST['action'] != 'edit') { } ?> tabindex='17' rows="10" placeholder="Details" required maxlength='400' name='txtdetails' id='txtdetails' data-toggle="tooltip" data-placement="top" title="Details" style='text-transform:uppercase' onKeyPress="return isQuotes(event)"><? echo $sql_reqid[0]['APPRDET']; ?></textarea>
                                                        <span style='color:#FF0000; font-size:10px;'>NOTE : MAXIMUM 400 CHARACTERS ALLOWED..</span> */ ?>
                                                        <input type="hidden" name="hid_apprsub" id='hid_apprsub' value="<?=$sql_details[0]['APRNUMB']?>">
                                                        <textarea name="FCKeditor2" id="FCKeditor2" >
                                                            <?  if($_REQUEST['action'] == 'edit') {
                                                                    if($sql_reqid[0]['APPRFOR'] == '1') {
                                                                        $filepathname = $sql_details[0]['APRNUMB'];
                                                                        $filename = "ftp://".$ftp_user_name_apdsk.":".$ftp_user_pass_apdsk."@".$ftp_server_apdsk.$ftp_srvport_apdsk."/approval_desk/text_approval_source/".$filepathname;
                                  ...
                                  <tbody>
                                    ...
                                    <?
                                      ...
                                      <tr class="active">
                                        ...
                                        <td>
                                          <?
                                            $sql_descode=select_query_json("select  EMPCODE , EMPNAME from approval_subject_add where APRNUMB = '".$sql_reqid[0]['APRNUMB']."' AND ENTSRNO = '".$sectionrow['ENTSRNO']."'", "Centra", "TCS");
                                ...
                                <!-- start advt audio and video add 11439-->
                                <style>
                                  .advt_view1{
                                    padding:10px;
                                  }
                                ...
                                <table style="min-width: 760px;width:100%">
                									<?
                									$sql_descode=select_query_json("select distinct rd.FR_TIME , rd.TO_TIME , rd.RO_FCT , rd.RO_DURA , rd.COSTPSE , rd.RATEPSE , rd.NETAMNT , rd.RO_NUMB , rd.TOTAMNT , rd.GSTAMNT , rs.CGST , rs.SGST , rs.IGST from av7_ro_summ rs , av7_ro_det rd where rs.RO_NUMB = rd.RO_NUMB and rs.APRNUMB = '".$sql_reqid[0]['APRNUMB']."'", "Centra", "TCS");
                									if(count($sql_descode) > 0) { ?>
                                    <hr>
                                    <div class="row">
                                      <div class="col-md-6 advt_view1">
                      									<div class="form-group">
                      								    <label class="col-sm-4 control-label">CHANNEL NAME : </label>
                      								    <div class="col-sm-8">
                      											<input type="text" name="txt_chname" id="txt_chname" class="form-control" placeholder="CHANNEL NAME" style="text-transform:uppercase"/>
                      								    </div>
                      								  </div>
                      								</div>
                      								<div class="col-md-6 advt_view1">
                      									<div class="form-group">
                      								    <label class="col-sm-4 control-label">DESCRIPTION OF CAMPAIGN : </label>
                      								    <div class="col-sm-8">
                      											<input type="text" name="txt_champaign" class="form-control" placeholder="DESCRIPTION OF CAMPAIGN" style="text-transform:uppercase"/>
                      								    </div>
                      								  </div>
                      								</div>
                      								<div class="col-md-6 advt_view1">
                      									<div class="form-group">
                      								    <label class="col-sm-4 control-label">SPONSER STATUS : </label>
                      								    <div class="col-sm-8">
                      								      <input type="text" name="txt_sponstus" class="form-control" placeholder="SPONSER STATUS" style="text-transform:uppercase"/>
                      								    </div>
                      								  </div>
                      								</div>
                                      <!-- <div class="col-md-6 advt_view1">
                      								    ...
                      								    <div class="col-sm-8">
                      								      <input type="text" name="txt_position" class="form-control" placeholder="18%" disabled style="text-transform:uppercase"/>
                      								    </div>
                      								  </div>
                      								</div> -->
                                    </div>
                									<thead>
                										<tr>
                											<th  class="colheight" style="padding:5px 0px;width: 5%;background:#1caf9a;color:#fff;text-align:center">S.NO</th>
                											<th  class="colheight" style="padding:5px 0px;width: 10%;background:#1caf9a;color:#fff;text-align:center">DATE</th>
                											<th  class="colheight" style="padding:5px 0px;width: 15%;background:#1caf9a;color:#fff;text-align:center">TIME</th>
                											<th  class="colheight" style="padding:5px 0px;width: 10%;background:#1caf9a;color:#fff;text-align:center">SPOT</th>
                											<th  class="colheight" style="padding:5px 0px;width: 10%;background:#1caf9a;color:#fff;text-align:center">DURATION (SEC)</th>
                											<th  class="colheight" style="padding:5px 0px;width: 10%;background:#1caf9a;color:#fff;text-align:center">COST/10 SEC (RS)</th>
                											<th  class="colheight" style="padding:5px 0px;width: 10%;background:#1caf9a;color:#fff;text-align:center">RATE / SPOT</th>
                											<th  class="colheight" style="padding:5px 0px;width: 10%;background:#1caf9a;color:#fff;text-align:center">TOTAL AMOUNT</th>
                											<th  class="colheight" style="padding:5px 0px;width: 10%;background:#1caf9a;color:#fff;text-align:center">GST <br>(<?
                											...
                											<th  class="colheight" style="padding:5px 0px;width: 15%;background:#1caf9a;color:#fff;text-align:center">NET AMOUNT</th>
                										</tr>
                									</thead>
                									<tbody>
                										<?
                										...
                										?>
                											<tr class="active">
                												...
                												<th  class="colheight" style="padding: 0px;width: 10%;text-align:center">
                													<?
                														$sql_descode=select_query_json("select RO_DATE from av7_ro_det where RO_NUMB = '".$sectionrow['RO_NUMB']."' ORDER BY RO_SRNO", "Centra", "TCS");
                														foreach($sql_descode as $sectionrow_emp) {
                											...
                											<tr>
                												...
                												<td class="colheight" style="padding: 0px;width: 10%;text-align:center">
                													 <label style=' font-size:14px; font-weight:bold;'><? if($sql_reqid[0]['APPFVAL'] == 0)
                														{
                														if($app_val != "")
                														{
                															echo $tot[$app_val];
                													...
                													} else { $apprvl = moneyFormatIndia($sql_reqid[0]['APPFVAL']); ?><img src='images/rupee.png' width=8 height=12 border=0> <?=$apprvl?></label> <label class='cls_rupees'><?")</label>"; } ?>
                													 <!-- Approved Value -->
                												</td>
                											</tr>
                											<?
                                ...
                                <!--  end advt audio and video add 11439-->
                                <div class="tags_clear"></div>
                        ...
                        <? $sql_prdlist = select_query_json("select * from APPROVAL_PRODUCTLIST
                                                                    where PBDCODE = '".$sql_reqid[0]['IMUSRIP']."' and PBDYEAR = '".$sql_reqid[0]['ARQYEAR']."'", 'Centra', 'TCS');
                        ...
                        <?  }
                                            ...
                                            <?  $sql_prdquotlist = select_query_json("select * from APPROVAL_PRODUCT_QUOTATION
                                                ...
                                                foreach($sql_prdquotlist as $prdquotlist) { $inc1++;
                                                    ...
                                                    <div class="row" style="margin-right: -10px; background-color: <?=$gridclr?>; display: flex; <?=$selected_supplier?>" onMouseover="this.style.background='#d0cfcf'; this.style.color='#000000';" onmouseout="this.style.backgroundColor='<?=$gridclr?>'; this.style.color='#000000';">
                                                        ...
                                                        <div class="col-sm-1 colheight" style="padding: 1px 0px;"> 
                                                            <!-- Uploaded Image -->
                                                            <? // $sql_docs = select_query_json("select * from APPROVAL_REQUEST_DOCS where aprnumb = '".$sql_reqid[0]['APRNUMB']."' and APRHEAD = 'othersupdocs'", 'Centra', 'TCS'); ?>
                            ...
                            <? /* <div>
                              ...
                              <?
                              $sql_project_branch = select_query_json("SELECT * from approval_branch_detail bd, approval_branch_list bl where bd.BRNCODE = bl.BRNCODE and bd.APRNUMB = '".$sql_reqid[0]['APRNUMB']."'","Centra","TCS");
                              //echo "SELECT * from approval_branch_detail where APRNUMB = ".$sql_reqid[0]['APRNUMB']."","Centra","TCS";
