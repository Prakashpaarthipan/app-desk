...
if($sql_reqid[0]['APPRSFR'] <= '22-APR-18' and $sql_reqid[0]['APTYPE'] == 'NEW PROPOSAL' ) { $aptype_display = "EXTRA BUDGET"; } 
...
<body>
	...
	<?php } ?>
		...
		<?	$kind_attn = 'Sri. KS Sir';
			...
			$sql_approve_comnts = select_query_json("select req.*, regexp_replace(SubStr(req.REQESEN,1,4),'[0-9]','')||SubStr(req.REQESEN,5,100) REQESEN, to_char(INTPFRD,'dd-MON-yyyy hh:mi:ss AM') HISTIME 
				...
				switch($find_lead)
				{
					case 3: // Manager
							if($sql_approve_comnts[$alaprcomments]['REQESEC'] == 137) {
								if($sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'I' && $sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'P' && $sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'Q') {
									...
									$cc_adddate = $sql_approve_comnts[$alaprcomments]['ADDDATE'];
								...
								if($sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'I' && $sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'P' && $sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'Q') { // echo "@@";
									...
									$srexc_mgr_adddate_audit = $sql_approve_comnts[$alaprcomments]['ADDDATE'];
								...
								if($sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'I' && $sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'P' && $sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'Q') {
									...
									$srexc_mgr_adddate[] = $sql_approve_comnts[$alaprcomments]['ADDDATE'];
					...
					case 67: // TJ / KTM BM
							if($sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'I' && $sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'P' && $sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'Q') {
								...
								$mgr_adddate = $sql_approve_comnts[$alaprcomments]['ADDDATE'];
								...
								$bm_adddate[] = $sql_approve_comnts[$alaprcomments]['ADDDATE'];
					...
					case 96:
							...
							if($sql_approve_comnts[$alaprcomments]['REQSTBY'] == 188 or $sql_approve_comnts[$alaprcomments]['REQSTBY'] == 62762) {
								...
								if($sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'I' && $sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'P' && $sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'Q') {
									...
									$steam_adddate = $sql_approve_comnts[$alaprcomments]['ADDDATE'];
								}
					...
					case 134:
							if($sql_approve_comnts[$alaprcomments]['REQESEC'] == 118) // DB
							{
								if($sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'I' && $sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'P' && $sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'Q') {
									...
									$exc_mgr_adddate = $sql_approve_comnts[$alaprcomments]['ADDDATE'];
								}
					...
					case 69: // KTM / TJ HOD
							...
							if($sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'I' && $sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'P' && $sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'Q') {
								...
								$hod_adddate[] = date("d-M-Y h:i:s A", strtotime($sql_approve_comnts[$alaprcomments]['ADDDATE']));
					...
					case 189:
							...
							if($sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'I' && $sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'P' && $sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'Q') {
								...
								$hod_empsrno[] = $sql_approve_comnts[$alaprcomments]['REQSTBY'];
								$hod_dept[] = $sql_approve_comnts[$alaprcomments]['REQESEN'];
								$hod_adddate[] = $sql_approve_comnts[$alaprcomments]['ADDDATE'];
					...
					case 150:
							...
							elseif($sql_approve_comnts[$alaprcomments]['REQESEC'] == 950) {
								if($sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'I' && $sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'P' && $sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'Q') {
									...
									$legal_adddate = $sql_approve_comnts[$alaprcomments]['ADDDATE'];
								}
					...
					case 19:
							if($sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'I' && $sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'P' && $sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'Q') {
								...
								$gm_adddate = date("d-M-Y h:i:s A", strtotime($sql_approve_comnts[$alaprcomments]['ADDDATE']));
					...
					case 165:
							if($sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'I' && $sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'P' && $sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'Q') {
								...
								$srgm_adddate = $sql_approve_comnts[$alaprcomments]['ADDDATE'];
					...
					case 78:
							...
							if($sql_approve_comnts[$alaprcomments]['REQSTBY'] == 21344 && $sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'I' && $sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'P' && $sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'Q')
							{
								...
								$ak_adddate = $sql_approve_comnts[$alaprcomments]['ADDDATE'];
					...
					case 9:
							...
							if($sql_approve_comnts[$alaprcomments]['REQSTBY'] == 43400 && $sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'I' && $sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'P' && $sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'Q')
							{
								...
								$ps_adddate = $sql_approve_comnts[$alaprcomments]['ADDDATE'];
							...
							elseif($sql_approve_comnts[$alaprcomments]['REQSTBY'] == 20118 && $sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'I' && $sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'P' && $sql_approve_comnts[$alaprcomments]['APPFRWD'] != 'Q')
							{
								...
								$ks_adddate = $sql_approve_comnts[$alaprcomments]['ADDDATE'];
					...
					<td colspan=2>
						<table border=0 width='100%' style='max-width: 773px; border: 1px solid #0088CC; min-height: 70px; height:auto; padding:3px; -webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px;'>
							...
							<table class="table table-bordered">
								<tr>
									<td colspan="2">
										<strong>SUBJECT</strong> : SALARY ADVANCE POLICY
									</td>
								</tr>
								<tr>
									<td>
										<B>EFFECTIVE DATE</B> : 00.00.00
									</td>
									<td>
										<B>POLICY TYPE</B> : ORIGINAL \ RENEWAL
									</td>
								</tr>
								<tr>
									<td>
										<B>VALID UPTO</B> : 00.00.00
									</td>
									<td>
										<B>CREATOR EC NO \ NAME</B> : 
									</td>
								</tr>
								<tr>
									<td>
										<B>APPROVAL DATE</B> : 00/00/0000
									</td>
									<td>
										<B>CO-ORDINATOR EC NO \ NAME</B> : 
									</td>
								</tr>
								<tr>
									<td>
								...
								<tr>
									<td colspan="2">
										<strong>DESK PROCEDURE</strong> : NEED TO ATTACH
									</td>
								</tr>
								<tr>
									<td colspan="2">
										<strong>NAINTANANCE OF POLICY</strong> : 
									</td>
								</tr>
							...
							<table class="table table-bordered">
								<tr>
									<td>
										<strong>POLICY</strong> :<p style="text-indent: 2em;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam semper diam at erat pulvinar, at pulvinar felis blandit. Vestibulum volutpat tellus diam, consequat gravida libero rhoncus ut.</p>
									</td>
								</tr>
							</table>
							<table class="table" style="border:solid 2px #ddd;margin-top:-23px">
								<tr>
									<td>
										01.
									</td>
							...
							<table class="table" style="border:solid 2px #ddd">
								<tr>
									<td>
										<b>ATTACHMENT AND DETAILS : </b> NILL
									</td>
								</tr>
								<tr class="active">
								...
								<tr>
									<td>
										<b>APPROVED IN ITS ORGINAL FORM : </b> NILL
									</td>
								</tr>
							</table>
								...
								if($col['COLSRNO'] == 1){ echo $row1; }
									...
									if($col['APMCODE'] == 856 and $col['COLSRNO'] == 2) { 
										...
										for($ij = 0; $ij < count($expl); $ij++) {
											$sql_tablemast = select_query_json("select * from master_table_detail where deleted = 'N' and MASTERID = '".$expl[$ij]."' order by TABNAME asc"); 
	...
	<?
		$sql_gift = select_query_json("select * from approval_staff_marriage where apryear='".$_REQUEST['year']."' and aprnumb like  '%".$sql_ap[0]['APRNUMB']."%'", 'Centra', 'TEST',"Centra","TCS");
		if(count($sql_gift)>0 && $sql_ap[0]['APRNUMB'] != ""){
			...
			<?}
					// STAFF SALARY CHANGE 
				/*$sql_salary = select_query_json("select * from approval_staff_salary_change where apryear='".$_REQUEST['year']."' and aprnumb like  '%".$sql_ap[0]['APRNUMB']."%'", 'Centra', 'TEST');*/

			$sql_salary = select_query_json("select app.* from approval_staff_salary_change app,employee_office emp  where emp.empsrno= app.empsrno and app.apryear='".$_REQUEST['year']."' and app.aprnumb like  '%".$sql_ap[0]['APRNUMB']."%'", 'Centra', 'TEST');
						...
						<tr><td colspan=4>
							<table border=0 cell-padding=1 cell-spacing=1 style='width:100%; padding-left:2px; padding-right:2px;'>
								...
								if($tot_len >7){?>
									...
									<? } elseif($ceo_available == 1) { ?>
										<td style='<?=$txtalign?> width:14%; font-size:11px;'>
											...
											<label style='color:#0088CC; font-weight:bold'>CEO</label> <!-- CEO / AK -->
										</td>
									<? }elseif($sql_hir[0]['AK'] != 0 && $sql_reqid[0]['APPSTAT'] != 'A'){?>
										<td style='<?=$txtalign?> width:14%; font-size:11px;vertical-align: top;'>
									...
									<? if($ps_name != '') { ?>
										<td style='<?=$txtalign?> width:14%; font-size:11px;vertical-align: top;'>
											...
											</label><br>CAO</label> <!-- CAO / PS Madam -->
										</td>
									<? }elseif($sql_hir[0]['PS'] != 0 && $sql_reqid[0]['APPSTAT'] != 'A'){?>
										<td style='<?=$txtalign?> width:14%; font-size:11px;vertical-align: top;'>
											<br>
									...
									<? if($ks_name != '') { ?>
										<td style='<?=$txtalign?> width:14%; font-size:11px;vertical-align: top;'>
											<label style='color:#0088CC; font-weight:bold'><?=$ks_adddate?><br>
												<label style="color: black;font-weight:bold;margin-right:  15px;">
												<?echo "K.SIVALINGAM";?>
											</label><br><? if($ks_adddate != '') { ?>COO<? } else { ?>CAO / COO<? } ?></label> <!-- COO / MD -->
										</td>
									<? } elseif($sql_hir[0]['KS'] != 0 && $sql_reqid[0]['APPSTAT'] != 'A'){?>
										<td style='<?=$txtalign?> width:14%; font-size:11px;vertical-align: top;'>
											<br>
								...
								<tr>									
									...
									<?/* if($ps_name != '') { ?>
										<td style='<?=$txtalign?> width:14%; font-size:11px;vertical-align: top;'>
											<label style='color:#0088CC; font-weight:bold'><?=$ps_adddate?><br>CAO</label> <!-- CAO / PS Madam -->
										</td>
									<? } elseif($sql_reqid[0]['APPSTAT'] != 'A') { ?>
										<td style='<?=$txtalign?> width:14%; font-size:11px;'>
											<label style='color:#0088CC; font-weight:bold'>CAO / COO</label> <!-- CAO / PS Madam -->
										</td>
									<? }*/ ?>
									
									<?/* if($ks_name != '') { ?>
										<td style='<?=$txtalign?> width:14%; font-size:11px;vertical-align: top;'>
											<label style='color:#0088CC; font-weight:bold'><?=$ks_adddate?><br><? if($ks_adddate != '') { ?>COO<? } else { ?>CAO / COO<? } ?></label> <!-- COO / MD -->
										</td>
									<? }*/ /*elseif($sql_reqid[0]['APPSTAT'] != 'A') { ?>
										<td style='<?=$txtalign?> width:14%; font-size:11px;'>
											<label style='color:#0088CC; font-weight:bold'>COO</label> <!-- COO / MD -->
										</td>
									<? } */ ?>
		...
		<? if(count($sql_prdlist) > 0 and $edtvl == 0) { 
			...
			<? /* <tr><td colspan="2" style="text-align: center; padding-top: 20px;"> 1 / 2 </td></tr> */ ?>
			...
			<? /* <tr><td colspan="2" style="text-align: center; padding-top: 20px;"> 2 / 2 </td></tr> */ ?>
			<!-- Page 2 -->
			</table>
			</td>
		</tr>
...
<table border=0 cell-padding=1 cell-spacing=1 align='center' class="fixed" style='border:5px solid #303030; border-style:double; width:796.8px; max-height:1123.2px; padding:7px'>
		...
		<tr>
			...
			for($ij = 0; $ij < count($pagearry['doc']); $ij++){ 
				...
				echo $fieldindi = "<a href=\"ftp://".$ftp_user_name.":".$ftp_user_pass."@".$ftp_server."/approval_desk/request_entry/".$dataurl."/".$filename."\" target=\"_blank\" class=\"style_box\">".$filename."</a><br><br>";
