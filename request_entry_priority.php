...
$sql_mnu_access = select_query_json("select distinct mnu.MNUCODE, mnu.MAINMENU, mnu.SUBMENU, acc.ENTSRNO, acc.vewvalu 
                                            from trandata.SRM_MENU@tcscentr mnu, trandata.SRM_MENU_ACCESS@tcscentr acc 
                                            where mnu.MNUCODE = acc.MNUCODE and mnu.MAINMENU = 'APPROVAL DESK' and acc.vewvalu = 'Y' and acc.entsrno = ".$_SESSION['tcs_empsrno']."
                                            order by mnu.MNUCODE Asc", "Centra", 'TCS'); 
if(in_multiarrays("APPROVAL DESK", $sql_mnu_access, "SUBMENU") == '') { ?>
    <script>alert("You dont have access to view this"); window.location='home.php';</script>
<? exit(); 
}

if(in_multiarrays("APPROVAL DESK", $sql_mnu_access, "SUBMENU") == 1) { // Menu Permission is allowed
    ...
    <body>
                                        ...
                                        <div class="col-md-6">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <? } else { ?>
                                                        ...
                                                        <?  $sql_project = select_query_json("select * from approval_project where DELETED = 'N' order by APRCODE Asc", "Centra", 'TCS');
                                                            $cnt_project = count($sql_project);
                                                            for($project_i = 0; $project_i < $cnt_project; $project_i++) { ?>
                                                ...
                                                <div class="col-md-9 col-xs-12" id="id_submission_type">
                                                    ...
                                                    <? } else { ?>
                                                        ...
                                                        <?  if($sql_reqid[0]['APRCODE'] != '') {
                                                            ...
                                                            <? $cnt_submission_type = count($sql_submission_type);
                                                                for($submission_type_i = 0; $submission_type_i < $cnt_submission_type; $submission_type_i++) { ?>
                                                    ...
                                                    <div class="col-md-9 col-xs-12">
                                                        ...
                                                        <? } else { ?>
                                                            ...
                                                            <?  if($sql_vl[0]['EXPSRNO'] == '') {
                                                                ...
                                                                $cnt_expsrno = count($sql_project);
                                                                for($project_i = 0; $project_i < $cnt_expsrno; $project_i++) { ?>
                                                            ...
                                                            <? } else { ?>
                                                                <select <? if($_REQUEST['action'] == 'edit') { ?>disabled class="form-control custom-select"<? } else { ?>class="form-control custom-select chosn" onblur="get_advancedetails(this.value);" onChange="get_advancedetails(this.value);"<? } ?> tabindex='4' required name='slt_department_asset' id='slt_department_asset' data-toggle="tooltip" data-placement="top" data-original-title="Department Asset">
                                                                    <?  $sql_project = select_query_json("select * from department_asset
                                                                        ...
                                                                        $cnt_department = count($sql_project);
                                                                        for($project_i = 0; $project_i < $cnt_department; $project_i++) { ?>
                                                            ...
                                                            <? } else {
                                                                ...
                                                                <div id='id_targetno'>
                                                                    ...
                                                                    <?  $sql_tarno = select_query_json("select distinct round(tarnumb) tarnumb, round(bpl.tarnumb)||' - '||( select distinct
                                                                        ...
                                                                        $cnt_tarno = count($sql_tarno);
                                                                        for($tarno_i = 0; $tarno_i < $cnt_tarno; $tarno_i++) {
                                                    ...
                                                    <? } else { ?>
                                                        <div id="id_appr_listings">
                                                            ...
                                                            <?  if($_REQUEST['action'] == 'edit') {
                                                                ...
                                                                $cnt_type_mode = count($sql_approval_type_mode);
                                                                for($approval_type_mode_i = 0; $approval_type_mode_i < $cnt_type_mode; $approval_type_mode_i++) { ?>
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <!-- Rate finalized by -->
                                                    <div id="id_rate_finalize_by" class="form-group">
                                                        <label class="col-md-3 control-label">Rate Finalized By User <span style='color:red'>*</span></label>
                                                        <div class="col-md-9 col-xs-12">
                                                            <?  if(count($sql_emp) > 1) {
                                                                    $emcd = $sql_emp[1]['EMPCODE'];
                                                                    $emnm = $sql_emp[1]['EMPNAME'];
                                                                ...
                                                                if($_REQUEST['action'] == 'view') {
                                                                    ...
                                                                    <input type='text' class="form-control" style="text-transform: uppercase;" tabindex='7' onblur="getapproval_listings(); find_tags();" name='txt_rate_finalized' id='txt_rate_finalized' data-toggle="tooltip" data-placement="top" data-original-title="Rate Finalized By User" value='<?=$emcd." - ".$emnm." - ".substr($senm, 3)?>'>
                                                            <?  } ?>
                                                        </div>
                                                    </div>
                                                    <div class="tags_clear"></div>
                                                    ...
                                                    <div class="form-group" id="id_txt_submission_quotations">
                                                        ...
                                                        <? if($_REQUEST['action'] != 'view') { ?>
                                                            ...
                                                            <div><? echo "<ul id=\"lightgallery\" class=\"list-unstyled row lightgallery\" style='float:left; margin-left:5px;'>";
                                                                    $cnt_qudocs = count($sql_docs);
                                                                    for($ij = 0; $ij < $cnt_qudocs; $ij++) {
                                                    ...
                                                    <div class="form-group" id="id_txt_submission_fieldimpl">
                                                        ...
                                                        <? if($_REQUEST['action'] != 'view') { ?>
                                                            ...
                                                            <div class='clear clear_both' style='min-height:1px;'></div>
                                                            <div><? echo "<ul id=\"lightgallery\" class=\"list-unstyled row lightgallery\" style='float:left; margin-left:5px;'>";
                                                              $cnt_bddocs = count($sql_docs);
                                                              for($ij = 0; $ij < $cnt_bddocs; $ij++) {
                                                                $filename = $sql_docs[$ij]['APRDOCS'];
                                                                $dataurl = $sql_docs[$ij]['APRHEAD'];
                                                                $exp = explode("_", $filename);
                                                                switch($exp[5])
                                                    ...
                                                    <!-- PO No  vikip-->
                                                    <? $sql_docs = select_query_json("select * from APPROVAL_REQUEST_DOCS
                                                                                            where aprnumb = '".$sql_reqid[0]['APRNUMB']."' and APRHEAD = 'ponumber'", "Centra", 'TCS'); ?>
                                                    <div class="form-group" id="id_pono_attachment">
                                                        <label class="col-md-3 control-label">PO NO <span style='color:red'>*</span></label>
                                                        <div class="col-md-9 col-xs-12">
                                                        <? if($_REQUEST['action'] != 'view') { ?>
                                                            <div><input type="file" placeholder="PO NO" tabindex='8' onblur="find_tags();" class="form-control fileselect" name='txt_po_no[]' id='txt_po_no' onchange="ValidateSingleInput(this, 'all');" multiple accept="image/jpg,image/jpeg,image/gif,image/png,image/jpg,.pdf" value='' data-toggle="tooltip" data-placement="top" title="PO NO"><span class="help-block">NOTE : ALLOWED ONLY PDF / IMAGES</span></div>
                                                                <div class="tags_clear"></div>
                                                            <div style="display: none;"><input type="text" placeholder="PO NO" tabindex='8' class="form-control bgclr_f8f8f8" name='txt_po_no_remark' id='txt_po_no_remark' maxlength="100" value='<?=$sql_reqid[0]['RMBDAPR']?>' data-toggle="tooltip" data-placement="top" title="PO NO" style="text-transform: uppercase;"></div>
                                                            <? } ?>
                                                            <div class='clear clear_both' style='min-height:1px;'></div>
                                                            <div><? echo "<ul id=\"lightgallery\" class=\"list-unstyled row lightgallery\" style='float:left; margin-left:5px;'>";
                                                              for($ij = 0; $ij < count($sql_docs); $ij++) {
                                                                ...
                                                                switch($exp[5])
                                                                {
                                                                    case 'i':$folder_path = "approval_desk/request_entry/".$dataurl."/";
                                                                            $thumbfolder_path = "approval_desk/request_entry/".$dataurl."/thumb_images/";
                                                    ...
                                                    <div class="form-group" id="id_txt_submission_clrphoto">
                                                        ...
                                                        <? if($_REQUEST['action'] != 'view') { ?>
                                                            ...
                                                            <div class='clear clear_both' style='min-height:1px;'></div>
                                                            <div><? echo "<ul id=\"lightgallery\" class=\"list-unstyled row lightgallery\" style='float:left; margin-left:5px;'>";
                                                                    $cnt_wpdocs = count($sql_docs);
                                                                    for($ij = 0; $ij < $cnt_wpdocs; $ij++) {
                                                                        $filename = $sql_docs[$ij]['APRDOCS'];
                                                                        $dataurl = $sql_docs[$ij]['APRHEAD'];
                                                                        $exp = explode("_", $filename);
                                                                        switch($exp[5])
                                                    ...
                                                    <div class="form-group" id="id_txt_submission_artwork">
                                                        ...
                                                        <? if($_REQUEST['action'] != 'view') { ?>
                                                            ...
                                                            <div class='clear clear_both' style='min-height:1px;'></div>
                                                            <div><? echo "<ul id=\"lightgallery\" class=\"list-unstyled row lightgallery\" style='float:left; margin-left:5px;'>";
                                                                    $cnt_awdocs = count($sql_docs);
                                                                    for($ij = 0; $ij < $cnt_awdocs; $ij++) {
                                                                        $filename = $sql_docs[$ij]['APRDOCS'];
                                                                        $dataurl = $sql_docs[$ij]['APRHEAD'];
                                                                        $exp = explode("_", $filename);
                                                                        switch($exp[5])
                                                    ...
                                                    <div class="form-group" id="id_txt_submission_othersupdocs">
                                                        ...
                                                        <? if($_REQUEST['action'] != 'view') { ?>
                                                            ...
                                                            <div class='clear clear_both' style='min-height:1px;'></div>
                                                            <div><? echo "<ul id=\"lightgallery\" class=\"list-unstyled row lightgallery\" style='float:left; margin-left:5px;'>";
                                                                    $cnt_cadocs = count($sql_docs);
                                                                    for($ij = 0; $ij < $cnt_cadocs; $ij++) {
                                                                        $filename = $sql_docs[$ij]['APRDOCS'];
                                                                        $dataurl = $sql_docs[$ij]['APRHEAD'];
                                                                        $exp = explode("_", $filename);
                                                                        switch($exp[5])
                                                            ...
                                                            <div class="col-md-9 col-xs-12">
                                                                ...
                                                                <? } else { ?>
                                                                    ...
                                                                    <?  $sql_project = select_query_json("select * from APPROVAL_BUDGET_MODE where DELETED = 'N' order by BUDCODE", "Centra", 'TCS');
                                                                        $cnt_bdmode = count($sql_project);
                                                                        for($project_i = 0; $project_i < $cnt_bdmode; $project_i++) { ?>
                                                                    ...
                                                                    if($_SESSION['tcs_brncode'] == 888 or $_SESSION['tcs_brncode'] == 100) { 
																		...
																		<div style="line-height: 32px; background-color: <?=$bgclr?>">
																			<div class="col-xs-12" style="border: 1px solid #c0c0c0; display: block">
																				...
																				<? $cnt_brnch = count($sql_project);
                                                                                    for($project_i = 0; $project_i < $cnt_brnch; $project_i++) { ?>
                                                        ...
                                                        <div class="form-group trbg">
                                                            ...
                                                            <div class="col-lg-9 col-xs-9" style="font-weight:bold;">
                                                                ...
                                                                if(count($sql_app_hierarchy) > 0) { $flo = 1; $newentry = 1; // echo "!!!";
                                                                    $cnt_app_hierarchy = count($sql_app_hierarchy);
                                                                    for($app_hierarchy_i = 0; $app_hierarchy_i < $cnt_app_hierarchy; $app_hierarchy_i++) { ?>
                                                                        <? $last[] = $sql_app_hierarchy[$app_hierarchy_i]['EMPCODE']; ?>
                                                                <?  }

                                                                    $cnt_aphier = count($sql_app_hierarchy);
                                                                    for($app_hierarchy_i = 0; $app_hierarchy_i < $cnt_aphier; $app_hierarchy_i++) {
                                                                        ...
                                                                        $sql_app_hierarchy = select_query_json("select * from APPROVAL_MODE_HIERARCHY amh, employee_office emp
                                                                                                                        ...
                                                                                                                        order by amh.APMCODE, amh.AMHSRNO desc", "Centra", 'TCS'); // 02052017
                                                                        $cnt_apphier = count($sql_app_hierarchy);
                                                                        for($app_hierarchy_i = 0; $app_hierarchy_i < $cnt_apphier; $app_hierarchy_i++) { ?>
                                                                            <? $last[] = $sql_app_hierarchy[$app_hierarchy_i]['EMPCODE']; ?>
                                                                    <?  }

                                                                        $cnt_apphierar = count($sql_app_hierarchy);
                                                                        for($app_hierarchy_i = 0; $app_hierarchy_i < $cnt_apphierar; $app_hierarchy_i++) {
                                                                            if($sql_app_hierarchy[$app_hierarchy_i]['APPHEAD'] == 1 or $sql_app_hierarchy[$app_hierarchy_i]['APPHEAD'] == 2 or $sql_app_hierarchy[$app_hierarchy_i]['APPHEAD'] == 3 or $sql_app_hierarchy[$app_hierarchy_i]['APPHEAD'] == 4 or $sql_app_hierarchy[$app_hierarchy_i]['APPHEAD'] == 5) {
                                                                                echo $sql_app_hierarchy[$app_hierarchy_i]['EMPNAME']." <br>";
                                                                            } else {
                                                                                echo $sql_app_hierarchy[$app_hierarchy_i]['EMPNAME'].' - '.$sql_app_hierarchy[$app_hierarchy_i]['APPHEAD'].' [ '.$sql_app_hierarchy[$app_hierarchy_i]['APPDAYS'].' Day(s) ] <br>';
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-xs-12">
                                                        <?  if($_REQUEST['action'] == 'view') {
                                                                ...
                                                                $cnt_rlapr = count($sql_rlapr);
                                                                for ($rlapri = 0; $rlapri < $cnt_rlapr; $rlapri++) {
                                                                    $sql_apr = select_query_json("select ARQCODE, ARQYEAR, ATCCODE, ATYCODE, APRNUMB from APPROVAL_REQUEST
                                                                                                        where aprnumb like '".trim($sql_rlapr[$rlapri])."' and ARQSRNO = 1", "Centra", "TCS"); ?>
                                                ...
                                                <div class="panel-body">
                                                    <? if($sql_reqid[0]['ARQSRNO'] == 1) {
                                                            $sql_approval_levels = select_query_json("select req.REQDESN, req.REQESEN, req.APPRMRK, req.APPFVAL, req.APPFRWD, req.REQDESC, req.REQESEC,
                                                                                                            ...
                                                                                                            order by req.ARQCODE, req.ARQSRNO, req.ATYCODE", "Centra", 'TCS');
                                                            $cnt_approval_levels = count($sql_approval_levels);
                                                            for($sql_approval_levelsi = 0; $sql_approval_levelsi < $cnt_approval_levels; $sql_approval_levelsi++) { ?>
                                                        ...
                                                        foreach($sql_prdlist as $prdlist) { $inc++;
                                                            ...
                                                            <div class="row" style="margin-right: -5px; min-height: 25px; display: flex; background-color: #FFFFFF; text-transform: uppercase;">
                                                                ...
                                                                <div class="col-sm-3 colheight" style="padding: 1px 0px;">
                                                                    ...
                                                                    <div>
                                                                        <input type="text" name="txt_prdspec[]" id="txt_prdspec_<?=$inc?>" onblur="find_tags();" value="<?=$prdlist['PRDSPEC']?>" required="required" maxlength="200" placeholder="Product Specification" onKeyPress="enable_product();" data-toggle="tooltip" data-placement="top" title="Product Specification" class="form-control supquot find_prdspec" onBlur="validate_prdspcempty(<?=$inc?>)" style=" text-transform: uppercase;height: 25px;">
                                                                        <input type="text" name="txt_prdpur[]" id="txt_prdpur_<?=$inc?>" onblur="find_tags();" value="<?=$prdlist['PRDSPEC']?>" maxlength="100" placeholder="Purpose Of Product Usage" onKeyPress="enable_product();" data-toggle="tooltip" data-placement="top" title="Purpose Of Product Usage" class="form-control supquot find_prdspec" onBlur="validate_prdspcempty(<?=$inc?>)" style=" text-transform: uppercase;height: 25px;">
                                                                    </div>
                                                                    <div style="clear: both;"></div>
        ...
        $(document).ready(function() {
            ...
            find_checklist();
            $('#id_rate_finalize_by').hide();
            // $('#id_pono_attachment').hide();
        });
            ...
            $.ajax({
                ...
                success: function(data1) {
                    ...
                    for (var exp_chklisti=0; exp_chklisti < chklist.length; exp_chklisti++) {
                        ...
                        /* if(slt_targetno != '') {
                            enable9 = 1;
                            $("#id_pono_attachment").css("display", "block");
                        } */
                    }
            ...
            $("#frm_request_entry").on('submit',(function(e) {
                ...
                if(flag == 1)
                {
                    ...
                    if (hid_noofdays == "" || hid_noofdays == "0") {
                        ...
                        $.ajax({
                            type: 'post',
                            url: "lib/process_connect_priority.php",
        ...
        function call_product_innergrid(gridid) {
                ...
                if( ($('.parts3 .part3').length+1) > 99) {
                    ...
                    var apnd_content = '<div class="part3" style="margin-right: -5px; text-transform: uppercase;">'+
                                            ...
                                            '<div class="col-sm-3 colheight" style="padding: 1px 0px;">'+
                                                ...
                                                '<div>'+
                                                    '<input type="text" name="txt_prdspec[]" id="txt_prdspec_'+id+'" required="required" maxlength="200" placeholder="Product Specification" data-toggle="tooltip" data-placement="top" onKeyPress="enable_product();" title="Product Specification" class="form-control supquot find_prdspec" onBlur="validate_prdspcempty('+id+'); find_tags();" style=" text-transform: uppercase;height: 25px;">'+
                                                '</div><div style="clear: both;"></div>'+

                                                '<div>'+
                                                    '<input type="text" name="txt_prdpur[]" id="txt_prdpur_'+id+'" maxlength="100" placeholder="Purpose Of Product Usage" data-toggle="tooltip" data-placement="top" title="Purpose Of Product Usage" class="form-control supquot find_prdspec" style=" text-transform: uppercase;height: 25px;">'+
                                                '</div><div style="clear: both;"></div>'+
                                            ...
                                            '<div class="col-sm-3 colheight" style="padding: 1px 0px;">'+
                                                '<div style="width: 49%; float: left;"><input type="text" onKeyPress="enable_product(); return isNumber(event)" name="txt_ad_duration[]" id="txt_ad_duration_'+id+'" onblur="calculateqtyamount('+id+'); find_tags();" maxlength="3" placeholder="Ad. Duration" data-toggle="tooltip" data-placement="top" title="Ad. Duration" class="form-control supquot ad_category" readonly value="1" style=" text-transform: uppercase;height: 25px;" >'+
                                                '</div>'+
                                                '<div style="width: 49%; float: left; margin-left: 2px;">'+
                                                    '<input type="text" name="txt_print_location[]" id="txt_print_location_'+id+'" maxlength="25" placeholder="Ad. Print Location" data-toggle="tooltip" data-placement="top" onKeyPress="enable_product();" title="Ad. Print Location" class="form-control supquot ad_category" readonly value="1" style=" text-transform: uppercase;height: 25px;" >'+
                                                '</div><div style="clear: both;"></div>'+
            ...
            if(slt_subtopcore == '29') {
                // $(".ad_category").attr("readonly", false); // 21-08-2018 // ADVT
                $(".ad_category").val("1");
 ...
 //  error
        ...
        <?  /* $sql_chklist = select_query_json("select * from approval_checklist where deleted = 'N' and tarnumb = 7515 order by apcklst");
            ...
            if(slt_submission == 1 || slt_submission == 6 || slt_submission == 7) {
                if (frm_request_entry.txt_rate_finalized.value == "" || frm_request_entry.txt_rate_finalized.value == " -  - ") {
                    frm_request_entry.txt_rate_finalized.value = '';
                    // alert( "Please enter the submission request by user id" );
                    var ALERT_TITLE = "Message";
                    var ALERTMSG = "Please enter the rate finalized user";
                    createCustomAlert(ALERTMSG, ALERT_TITLE);
                    frm_request_entry.txt_rate_finalized.focus();
                    $('#load_page').hide();
                    gtvl = 0 ;
                }
            }
        ...
        function getsubtype(subtype_id) {
            ...
            if(subtype_id == 1 || subtype_id == 6 || subtype_id == 7)
            {
                $('#id_rate_finalize_by').show();
                // $('#id_pono_attachment').show();
        ...
        <script type="text/javascript">
            $(document).ready(function ($) {
                ...
                $('#txt_rate_finalized').autocomplete({
                    source: function( request, response ) {
                        $.ajax({
                            url : 'ajax/ajax_employee_details.php',
                            dataType: "json",
                            data: {
                               ...
                               topcr: $('#slt_topcore').val(),
                               subcr: $('#slt_subcore').val(),
                               type: 'employee_exceptmd'
                            },
                            success: function( data ) {
                                <? /* if ($_SESSION['tcs_empsrno'] == 43878) { ?> alert("***"+data+"***"); <? } */ ?>
                                if(data == 1) {
                                    $('#txt_rate_finalized').val('');
                                    var ALERT_TITLE = "Message";
                                    var ALERTMSG = "HOD / DGM / GM User only allowed. Kindly Change this!!";
                                    createCustomAlert(ALERTMSG, ALERT_TITLE);
                                } else {
                                    response( $.map( data, function( item ) {
                                        return {
