...
if($inner_menuaccess[0]['VEWVALU'] == 'Y') { // Menu Permission is allowed ?>
		...
		<div class="panel-body">
			  ...
			  <?
				...
				?>
					...
					<div class="col-sm-6">
						...
						<label style="height:40px;padding-top:5px;padding-left:10px"  id = "projectcode">Project Name: <span style="font-weight:bold;font-size:16px;color:#e04b4a; margin-left:30px;"> <?echo $admin_project[0]['PRJNAME']." - " .$admin_project[0]['PRMSCOD'];?></span></label>
						</div>
					</div>
					<div class="col-sm-6">
							...
							?>	
								...
								<div style="width:100%">
									<div style="width:70%;float:left;">
									 <input type = "text" name ='txt_ledger_name[]' id = "txt_ledger_name<?echo $led_id;?>" class="form-control" value="<?echo $timer_value['TARNUMB']." - ".$timer_value['TARNAME'];?>" readonly >
									...
									</div><?if($_SESSION['tcs_empsrno'] == 188 || $_SESSION['tcs_empsrno'] == 61579 || $_SESSION['tcs_empsrno'] == 452 || $_SESSION['tcs_empsrno'] == 3 ){?>
									<div style="width:30%;float:right">
										<input type="text" name = "txt_values[]" id = "txt_values" class="form-control valold" value="<?echo $timer_value['PRJVALU'];?>" pattern= "^[0–9]$" onkeypress="javascript:return isNumber(event)" readonly>
									</div>
									<?} else{?>
									<div style="width:30%;float:right">
										<input type="text" name = "txt_values[]" id = "txt_values" class="form-control valold" value="<?echo $timer_value['PRJVALU'];?>" pattern= "^[0–9]$" onkeypress="javascript:return isNumber(event)" readonly >
								...
								var p_id = <?echo $admin_project[0]['PRMSCOD'];?>;
								$.ajax({
									type:"post",
					...
					<div class="col-sm-6">
						<div class="row form-group ">
							...
							<div class="col-lg-8 col-md-8">
								...
								<input type='text' name='txt_project_name' value='<?echo $admin_project[0]['PRJNAME'];?>' class='form-control' id ="txt_project_name" style='text-transform:uppercase;' readonly>
							</div>
						</div>
						<div class="row form-group " >
							<div class="col-lg-4 col-md-4">
					...
					<div class="col-lg-8 col-md-8">
						...
						?>
							<div class="form-group input-group">
							  ...
							  <input type="text" name="txt_project_head[]" id="txt_project_head<?echo $headid;?>" value="<?echo $timer_value['EMPCODE']." - ".$timer_value['EMPNAME'];?>" placeholder="THE PROJECT HEAD" title="the project head" class="form-control find_empcode" data-toggle="tooltip" data-placement="top" style=" text-transform: uppercase; padding: 2px;" readonly>
			...
			<div  class="input-group ">
				...
				<div class="form-group trbg" style='min-height:40px; padding-top:10px'>
					...
					<? if($_SESSION['tcs_empsrno'] == 188 || $_SESSION['tcs_empsrno'] == 83815 || $_SESSION['tcs_empsrno'] == 452 || $_SESSION['tcs_empsrno'] == 21344 ){?>
					...
					<?}?>
					  <!--  <button type="submit" id="approve_btn" tabindex='2' class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Modify"><i class="fa fa-check"></i> Approve</button>
						...
						<a id="reject-button" type="submit3" tabindex='2' style="background-color:orange" class="btn btn-danger pull-right" title="Reject"  ><i class="fa fa-ban"></i> Reject</a>
                           ...
                           <div class="panel panel-default panel-toggled">
							...
							//var_dump($table_history);
											...
											?>
												...
												<?$pname = select_query_json("select EMPNAME from employee_office where LEFT(EMPCODE = '".$table_history[$hlist]['EDTUSER']."',5)","Centra","TEST");?>
												<td class="center" style="text-align:center"><?echo $table_history[$hlist]['EDTUSER'];?></td>
    ...
    <script type="text/javascript" src="js/jquery-customselect.js"></script>
		...
		$('#datepicker').Zebra_DatePicker({
								 ...
								 // alert(date);
								  var p = <?echo $admin_project[0]['PRMSCOD'];?>;
								  var d_date = date;
									//$(this).change();
		...
		$("#approve_btn").click(function(e)
			{
				...
				//alert(result1);
								...
								$.ajax({
									type:"post",
									url:"prakash/project_update.php?action=newentry&pid="+p_id+"&newledgeritems="+fieldArray5+"&newledgervalues="+fieldArray7+"&newowner="+postOwner+"&newhead="+postHead+"&newmember="+postMember+"",
		...
		*/
        $('#add_ledger').append(
              '<div class="form-group input-group">'+
				'<div style="width:100%">'+
					'<div style="width:70%;float:left;">'+
						'<select class="form-control newledger" autofocus name="txt_ledger_name[]" id="txt_ledger_name'+id+'" data-toggle="tooltip" data-placement="top" title="ledger Name" ></select>'+
					'</div>'+
					'<div style="width:30%;float:right">'+
...
'<input type="file" placeholder="Document Attachment" tabindex="10" class="form-control  input-group" name="attachments[]"'+'id="attachments" onchange="ValidateSingleInput(this, all);" multiple accept="image/jpg,image/jpeg,image/gif,image/png,image/jpg,.pdf"'+  'data-toggle="tooltip" data-placement="top" title="Document Attachment">'+
    ...
    function ValidateSingleInput(oInput, file_ext) {
		...
		function attachFiles(){
			...
			//
			var pjid =	<?echo $admin_project[0]['PRMSCOD'];?>;
