 ...
 <div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <div class="pull-right">
                            <?  $menu_name = 'EMPLOYEE GRADE MASTER';
                                ...
                                if($inner_menuaccess[0]['VEWVALU'] == 'Y') { ?><a class="btn btn-danger" target="_blank" style="margin-right: 5px;" href="employee_add.php">(+) Add Employees</a>&nbsp;&nbsp;<? } ?><a class="btn btn-danger" target="_blank" style="margin-right: 50px;" href="employee_grade_fix_report2.php">Grade Fix Report</a><br><br>
                        </div>
                    </div>
                    ...
                    <table id="customers" class="table datatable" border="1">
						...
						<td class="center" style="text-align: center;">
                                    <select id="txt_employee_grade_<?=$search_i;?>_<?=$dt_value?>" name='txt_employee_grade_<?=$search_i;?>_<?=$dt_value?>' class="txt_employee_grade" onchange="task_assign('<?=$join[$search_i]['EMPSRNO']?>', '<?=$search_i?>', '<?=$dt_value?>');" style="min-height: 25px;">
    ...
    function task_assign(empsrno, iv, fromdate) {
      ...
      //  var txt_empgrade_remarks = $("#txt_empgrade_remarks_"+iv).val();
        ...
        var strURL="ajax/fix_grade_testpage.php?action=fix_grade&empsrno="+empsrno+"&grade="+grade+"&txt_empgrade_remarks="+txt_empgrade_remarks+"&fromdate="+fromdate;
