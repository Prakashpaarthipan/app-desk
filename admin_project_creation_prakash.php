            ...
            <div class="page-content">
                ...
                <div class="page-content-wrap">
                    <div class="panel panel-default">
											  ...
											  <div id="add_ledger" class="form-group">
													...
													<div style="width:100%">
														<div style="width:70%;float:left;">
															<select class="form-control" autofocus  name='txt_ledger_name[]' id='txt_ledger_name1' data-toggle="tooltip" data-placement="top" title="ledger Name" >
														</select>
														</div>
						...
						<!-- Form Data Div-->
						<div class = 'col-sm-6'>
							<div class = 'approve' style ="font-size:12px"><p></br>
							Approve Flow: </br> <b>
							1. S. ASHOKKUMAR </br>
							2. R. SURENDHAR </br>
							3. K. KUMARAN </br>
