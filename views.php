...
$sql_vl = select_query_json("select distinct req.APRQVAL, req.ADDDATE, max(req.arqsrno) mx, req.PRJPRCS, req.BUDCODE, req.SUPCODE, req.SUPNAME, req.SUPCONT, req.APPRDET, req.DEPCODE, req.TARNUMB,
                                        req.TARDESC, ast.EXPSRNO, ast.EXPNAME EXPHEAD, ast.DEPNAME, req.ADVAMNT, pri.pricode, pri.priname, pri.pricode||' - '||pri.priname priority
                                    ...
                                    group by req.APRQVAL, req.ADDDATE, req.PRJPRCS, req.BUDCODE, req.SUPCODE, req.SUPNAME, req.SUPCONT, req.APPRDET, req.DEPCODE, req.TARNUMB,
                                        req.TARDESC, ast.EXPSRNO, ast.EXPNAME, ast.DEPNAME, req.ADVAMNT, pri.pricode, pri.priname
        ...
        <div class="page-content">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <!-- Approval Status & History -->
										                    <!-- Project -->
                                        <form class="form-horizontal" role="form" id="frm_requirement_entry" name="frm_requirement_entry" action='lib/process_connect_test.php' enctype="multipart/form-data">
			<!--<form class="form-horizontal" role="form" id="frm_requirement_entry" name="frm_requirement_entry" action="" method="post" enctype="multipart/form-data">    -->
						...
						<div class="row">
											   ...
											   <div class="form-group">
													...
													<div class="col-md-10"  >
													 <? $sql_emp = select_query_json("select distinct POLSUBJ
                                                                                       from approval_salary", "Centra", 'TEST');?>
														<input type="text" class="form-control " autofocus tabindex='1' required name='txtdynamic_subject' id='txtdynamic_subject' value='<?=$sql_emp[0]['POLSUBJ']?>' data-toggle="tooltip" data-placement="top" data-original-title="Top Core" >
												...
												<div class="form-group">
													...
													<div class="col-md-9 col-xs-12">
                                                       <? $sql_emp = select_query_json("select distinct EFFDATE
                                                                                       from approval_salary", "Centra", 'TEST');?>
                                                    <input type="text" style="cursor: pointer; text-transform: uppercase; position: relative; top: auto; right: auto; bottom: auto; left: auto;" class="form-control" name="tar_date" id="tar_date" autocomplete="off" readonly="readonly" maxlength="11" tabindex="5" value='<?=$sql_emp[0]['EFFDATE']?>' data-toggle="tooltip" data-placement="top" placeholder="From Date" title=""  >
												...
												<div class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-xs-12">
                                                       <? $sql_emp = select_query_json("select distinct VALUPTO
                                                                                       from approval_salary", "Centra", 'TEST');?>
                                                    <input type="text" style="cursor: pointer; text-transform: uppercase; position: relative; top: auto; right: auto; bottom: auto; left: auto;" class="form-control" name="due_date" id="due_date" autocomplete="off" readonly="readonly" maxlength="11" tabindex="5" value='<?=$sql_emp[0]['VALUPTO']." - ".substr($sql_emp[0]['ESENAME'], 3)?>' data-toggle="tooltip" data-placement="top" placeholder="To Date" title=""  >
												...
												<div class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-xs-12">
                                                        	<? $sql_emp = select_query_json("select distinct APPDATE
                                                                                       from approval_salary", "Centra", 'TEST');?>
                                                    <input type="text" style="cursor: pointer; text-transform: uppercase; position: relative; top: auto; right: auto; bottom: auto; left: auto;" class="form-control" name="app_date" id="app_date" autocomplete="off" readonly="readonly" maxlength="11" tabindex="5" value='<?=$sql_emp[0]['APPDATE']." - ".substr($sql_emp[0]['ESENAME'], 3)?>' data-toggle="tooltip" data-placement="top" placeholder="From Date" title=""  >
                            ...
                            <div class="col-md-9 col-xs-12">
                                <b>
                                   <?  $sql_emp = select_query_json("select distinct  emp.EMPCODE, emp.EMPNAME, emp.ESECODE, sec.ESENAME, des.DESNAME
                                                                                                  from employee_office emp, empsection sec, designation des,approval_salary app
                                                                                                  where  emp.EMPCODE=app.USELIST and emp.ESECODE = sec.ESECODE and emp.DESCODE = des.DESCODE 
                                                                                                 order by EMPCODE", "Centra", 'TEST');  ?> 
                                                   <? if($_REQUEST['action'] == 'view') {
                                                                echo ": ".$sql_reqid[0]['EMPCODE'];
                                                           } else { ?>																								 
									<input type="text"  class="form-control "  tabindex='6' style="text-transform: uppercase;" required name='txtdynamic_userlist' id='txtdynamic_userlist' data-toggle="tooltip" data-placement="top" tabindex="10" data-original-title="USER LIST"  value='<?=$sql_emp[0]['EMPCODE']." - ".$sql_emp[0]['EMPNAME']." - ".substr($sql_emp[0]['ESENAME'], 3)?>'>     
                                      <? } ?>           					    
                            </div>
                        </div>
												<div class="form-group">
												...
												<div class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-xs-12">
													 <? $sql_emp = select_query_json("select distinct POLIDOC
                                                                                       from approval_salary", "Centra", 'TEST');?>
                                                    <input type='text' class="form-control policy_approval_required" style="text-transform: uppercase;" required name='txtdynamic_policy_docs' id='txtdynamic_policy_docs' data-toggle="tooltip" data-placement="top" data-original-title="POLICY DOCUMENTS" value='<?=$sql_emp[0]['POLIDOC']?>'>
                                                    </div>
                                                </div>
												</DIV>
...
<!--fix me-->
											<div class="col-md-6">
												...
												<div class="form-group">
													...
													<div class="col-md-9">
													 <? $sql_emp = select_query_json("select distinct POLTYPE
                                                                                       from approval_salary", "Centra", 'TEST');?>
														<input type="text" class="form-control policy_approval_required" required name='txtdynamic_policy_type' id='txtdynamic_policy_type'value='<?=$sql_emp[0]['POLTYPE']?>' data-toggle="tooltip" data-placement="top" data-original-title="POLICY TYPE">
													</div>
                            ...
                            <div class="col-md-9 col-xs-12"
                                <b>
								 <? $sql_emp = select_query_json("select distinct emp.EMPCODE,emp.EMPNAME 
                                                                                       from approval_salary app,employee_office emp where emp.EMPCODE=app.CRENAME order by EMPCODE ", "Centra", 'TEST');                                                                                                                                                                                                                                                                                                                  
                                     ?>
                                  <input type="text" class="form-control policy_approval_required" style="text-transform: uppercase;" required name='txtdynamic_creator' id='txtdynamic_creator' data-toggle="tooltip" data-placement="top" data-original-title="ASSISTBY"  value='<?=$sql_emp[0]['EMPCODE']." - ".$sql_emp[0]['EMPNAME'] ."".substr($sql_emp[0]['ESENAME'], 2)?>'>     
                            ...
                            <div class="col-md-9 col-xs-12">
                                <b>
								<? $sql_emp = select_query_json("select distinct emp.EMPCODE,emp.EMPNAME
                                                                                       from approval_salary app,employee_office emp where emp.EMPCODE=app.COONAME order by EMPCODE ", "Centra", 'TEST');?>
                                  <input type="text"  class="form-control policy_approval_required" style="text-transform: uppercase;" required name='txtdynamic_coordinator' id='txtdynamic_coordinator' data-toggle="tooltip" data-placement="top" data-original-title="ASSISTBY"  value='<?=$sql_emp[0]['EMPCODE']." - ".$sql_emp[0]['EMPNAME']."  ".substr($sql_emp[0]['ESENAME'], 2)?>'>     
						...
						<div class="form-group">
                            ...
                            <div class="col-md-9 col-xs-12">
                                <b>
								 <? $sql_emp = select_query_json("select distinct emp.EMPCODE,emp.EMPNAME
                                                                                       from approval_salary	 app,employee_office emp where emp.EMPCODE=app.ASISTBY order by EMPCODE ", "Centra", 'TEST');?>
                                  <input type="text"  class="form-control policy_approval_required" style="text-transform: uppercase;" required name='txtdynamic_asistby' id='txtdynamic_asistby' data-toggle="tooltip" data-placement="top" data-original-title="ASSISTBY"  value='<?=$sql_emp[0]['EMPCODE']." - ".$sql_emp[0]['EMPNAME']."  ".substr($sql_emp[0]['ESENAME'], 2)?>'>     
