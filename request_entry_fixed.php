...
if($inner_menuaccess[0]['VEWVALU'] == 'Y') { // Menu Permission is allowed
    ...
    <body>
                                        ...
                                        <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-9 col-xs-12">
                                                            ...
                                                            <? } else {
                                                                ...
                                                                <div id='id_targetno'>
                                                                    ...
                                                                    <?  $sql_tarno = select_query_json("select bpl.tarnumb tarnumb, round(bpl.tarnumb)||' - '||decode(nvl(tar.ptdesc,'-'),'-',dep.depname,tar.ptdesc) Depname, decode(nvl(tar.ptdesc,'-'),'-',dep.depname,tar.ptdesc) dpnm, 
                                                                                                            dep.depcode||'!!'||dep.depname||'!!'||dep.EXPSRNO||'!!'||dep.TOPCORE||'!!20!!N' deptdet
                                                                                                        from TRANDATA.budget_planner_branch@TCSCENTR bpl,TRANDATA.non_purchase_target@TCSCENTR tar, 
                                                                                                            TRANDATA.department_asset@TCSCENTR Dep
                                                                                                        where bpl.TARYEAR=".(date("y")-1)." and TARMONT=".$cur_mn." and (bpl.tarnumb>8000 or 
                                                                                                            bpl.tarnumb in (7632, 7630)) and tar.depcode=dep.depcode and tar.ptnumb=bpl.tarnumb and 
                                                                                                            dep.depcode=bpl.depcode and tar.brncode=bpl.brncode
                                                                                                        group by bpl.tarnumb,round(bpl.tarnumb)||' - '||decode(nvl(tar.ptdesc,'-'),'-',dep.depname,tar.ptdesc),
                                                                                                            decode(nvl(tar.ptdesc,'-'),'-',dep.depname,tar.ptdesc), 
                                                                                                            dep.depcode||'!!'||dep.depname||'!!'||dep.EXPSRNO||'!!'||dep.TOPCORE||'!!20!!N'
                                                        ...
                                                        <div class="col-md-9 col-xs-12">
                                                            <?  if(count($sql_emp) > 1) {
                                                                ...
                                                                if($_REQUEST['action'] == 'view') {
                                                                    ...
                                                                    <input type='text' class="form-control" style="text-transform: uppercase;" tabindex='7' onblur="find_tags();" name='txt_rate_finalized' id='txt_rate_finalized' data-toggle="tooltip" data-placement="top" data-original-title="Rate Finalized By User" value='<?=$emcd." - ".$emnm." - ".substr($senm, 3)?>'>
                                                            <?  } ?>
                                                        </div>
                                                    </div>
                                                    <div class="tags_clear"></div>
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="form-group trbg" id='getmonthwise_budget_choose' style='display:none;'>
                                                        <div class="col-lg-3 col-xs-3 control-label" style="text-align: right;">Budget Planner &#8377;</div>
                                                        <div class="col-lg-9 col-xs-9">
                                                            <div id='id_budplanner_choose'></div>
                                                            <div>
                                                                <table style='clear:both; float:left; width:100%;'>
                                                                <tr><td>
                                                                    <table class="monthyr_wrap_choose" style='width:100%;'></table>
                                                                </td></tr>
                                                                </table>
                                                            </div>
                                                            <div class="tags_clear"></div>
        ...
        function chkbox_validation(chkbox_name)
        {
            var checkboxs=document.getElementsByName(chkbox_name);
            var okay=0;
            ...
            if(okay == 0) alert("Please Choose atleast one Month");
        }
        ...
        function calculatenetamount(opt1, opt2){
            ...
            // console.log("@@"+prdqty+"@@"+pcless+"@@"+spldis+"@@"+prdcst+"@@"); mnt_yr_amt
            prdcst = Math.round(prdcst).toFixed(2);
            ...
            if($('#txt_sltsupplier_'+opt1+'_'+opt2).is(":checked")) {
                ...
                if(parseInt(requestedvalue) <= parseInt(ttl_lock) && parseInt(ttl_lock) > 0) {
                    ...
                    {
                        if(slt_submission == 1 && slt_fixbudget_planner == 'PRODUCTWISE') {
                            document.getElementById('mnt_yr_amt_<? $cur_mon1 = strtoupper(date('m', strtotime('+1 month'))); if($cur_mon1 < 10) { echo $input = ltrim($cur_mon1, '0'); } else { echo $cur_mon1; } ?>').value = requestedvalue;
                        } else {
                        ...
                        if(slt_submission == 1 && slt_fixbudget_planner == 'PRODUCTWISE') {
                            var cnt_srn = 0;
                            $('.ttlsum').val(requestedvalue);
                            $('.class_month_find').prop('checked', true);
                            $('input.class_month_find:checkbox:checked').each(function () {
                                cnt_srn++;
                            });

                            // alert("***"+cnt_srn+"***"+ttl_lock+"***"+requestedvalue+"***");
                            requestedvalue = (cnt_srn * requestedvalue);
                            // alert("+++++++++"+cnt_srn+"+++++++++"+ttl_lock+"+++++++++"+requestedvalue+"+++++++++");
                            if(parseInt(requestedvalue) <= parseInt(ttl_lock) && parseInt(ttl_lock) > 0) {
                                alert("==CAME=="+cnt_srn+"+++++++++"+ttl_lock+"+++++++++"+requestedvalue+"+++++++++");
                                document.getElementById('txtrequest_value').value = requestedvalue;
                                document.getElementById('txt_brnvalue_0').value = requestedvalue;
                                document.getElementById('hidrequest_value').value = requestedvalue;
                                $('.hidn_balance').val(requestedvalue);
            ...
            if(document.getElementById('npobudget'))
            {
                if(slt_submission == 1 && slt_fixbudget_planner == 'PRODUCTWISE') {
                    var cnt_srn = 0;
                    $('.ttlsum').val(requestedvalue);
                    $('#txt_fixedbudget').val(requestedvalue);
                    $('.class_month_find').prop('checked', true);
                    $('input.class_month_find:checkbox:checked').each(function () {
                        cnt_srn++;
                    });
        ...
        function find_chk_fixedbudget(ivalue) {
            var slt_submission = $('#slt_submission').val();
            var slt_fixbudget_planner = $('#slt_fixbudget_planner').val();
            var requestedvalue = $('#txt_fixedbudget').val();
            var ttl_lock = $("#ttl_lock").val();
            if(slt_submission == 1 && slt_fixbudget_planner == 'PRODUCTWISE') {
                var cnt_srn = 0;

                if($("#mnt_yr_amt_"+ivalue).prop('checked') == true){
                    // alert("IV - "+ivalue);
                    $('#mnt_yr_amt_'+ivalue).val(requestedvalue);
                } else {
                    $('#mnt_yr_amt_'+ivalue).val(0);
                }
                // console.log("0000"+ivalue); // ttl_mntyr
                $('input.class_month_find:checkbox:checked').each(function () {
                    cnt_srn++;
                });
                ...
                if(parseInt(requestedvalue) <= parseInt(ttl_lock) && parseInt(ttl_lock) > 0) {
                    ...
                    document.getElementById('txt_brnvalue_0').value = requestedvalue;
                    document.getElementById('hidrequest_value').value = requestedvalue;
                    document.getElementById('ttl_mntyr').innerHTML = requestedvalue;
                    $('.hidn_balance').val(requestedvalue);
                    // New Calculation - 22-09-2017 // GA
                }
            }
        ...
        function get_targetdates_readonly() {
            ...
            if(slt_submission == 1 || slt_submission == 6 || slt_submission == 7) {
                ...
                if(slt_submission == 1 && slt_fixbudget_planner == 'PRODUCTWISE') {
                    ...
                    var strURL="ajax/ajax_get_targetdt_month.php?action=choose&slt_branch="+slt_branch+"&deptid="+deptid+"&core_deptid="+core_deptid+"&target_no="+target_no+"&slt_submission="+slt_submission+"&slt_approval_listings="+slt_approval_listings;
                    $.ajax({
                        type: "POST",
                        url: strURL,
                        success: function(data1) {
                            $("#id_budplanner_choose").html(data1);
                            $("#getmonthwise_budget_choose").css("display", "block");
                            $("#getmonthwise_budget").html('');
                        }
                    });
        ...
        function get_targetdates() {
            ...
            ////////////// ** ////////////// 113!!AIR CONDITIONER!!10!!4!!20!!Y slt_fixbudget_planner
        ...
        function showmode() {
            ...
            if(budgettype == 1 || budgettype == 6 || budgettype == 7) {
                ...
                var strURL="ajax/ajax_product_details.php?action=budgetmode&budgettype="+budgettype;
                $.ajax({
                    type: "POST",
                    url: strURL,
                    success: function(data) {
                        $("#id_budgetmode").html(data);
                    }
                });
