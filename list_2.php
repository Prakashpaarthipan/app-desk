        ...
        $('#list_content').append("<div id=content"+ntab+" class='row' style='margin-bottom: 10px;''>"+
                                        "<div class='form-group'>"+
                                          ...
                                          "<div class='col-md-3 col-xs-3'>"+
                                              "<input type='text' class='form-control findsp required' id='#slp_load_"+ntab+"' name='slp_load[]' style='text-transform: uppercase;' maxlength='100' required onblur = 'javascript:return removeDupe(this)'/>"+
                                          "</div><!-- supplier -->"+
                                          ...
                                          "</div><!-- rate -->"+
                                          "<div class='col-md-1 col-xs-3'>"+
                                              "<input type='text' class='form-control required ' id='discount_"+ntab+"' name='discount[]' style='text-transform: uppercase;' maxlength='5' required />"+
                                          "</div><!-- discount -->"+
                                          "<div class='col-md-1 col-xs-3'>"+
