        ...
        $('#list_content').append("<div id=content"+ntab+" class='row' style='margin-bottom: 10px;''>"+
                                        "<div class='form-group'>"+
                                          ...
                                          "<div class='col-md-3 col-xs-3'>"+
                                              "<input type='text' class='form-control findsp required' onChange='return removeDupe(this)' id='#slp_load_"+ntab+"' name='slp_load[]' style='text-transform: uppercase;' maxlength='100' required />"+
                                          "</div><!-- supplier -->"+
                                          "<div class='col-md-1 col-xs-3'>"+
                                              "<input type='text' class='form-control required' id='duration_"+ntab+"' name='duration[]' style='text-transform: uppercase;' maxlength='2' required />"+
                                          "</div><!-- duration -->"+
                                          "<div class='col-md-1 col-xs-3'>"+
                                              "<input type='text' class='form-control required rateclass' id='rate_"+ntab+"' name='rate[]' style='text-transform: uppercase;' maxlength='8' required />"+
                                          "</div><!-- rate -->"+
                                          "<div class='col-md-1 col-xs-3'>"+
                                              "<input type='text' class='form-control required ' id='discount_"+ntab+"' name='discount[]' oninput='checknumber(this.value)' style='text-transform: uppercase;' maxlength='3' required />"+
                                          "</div><!-- discount -->"+
                                          "<div class='col-md-1 col-xs-3'>"+
