...
<?
if($_REQUEST['slt_submission'] != 9 && $_REQUEST['slt_submission'] != 8 && $_REQUEST['slt_submission'] != 4 && $_REQUEST['slt_submission'] != 2  && $_REQUEST['slt_submission'] != 3){$pathid = 1;}
...
<? 	// PO Based - End
	...
	case 13 :  ?>
		<div id='id_policy' style="padding-right: 5px; text-align: center;">
		<div class="parts3 fair_border">
			...
			<div class="row" style="margin-right: -5px; display: flex; text-transform: uppercase;">
	            ...
	            <div class="col-sm-10 colheight" style="padding: 0px; line-height: 30px;">
	            	<select class="form-control" required name='txt_policy_subject' id='txt_policy_subject' data-toggle="tooltip" data-placement="top" data-original-title="POLICY SUBJECT">
			...
			<div class="row" style="margin-right: -5px; display: flex; text-transform: uppercase;">
	            ...
	            <div class="col-sm-4 colheight" style="padding: 0px; line-height: 30px;">
	            	<input type="text" name="txtdynamic_valid_upto" id="datepicker_example6" class="form-control" required readonly placeholder='VALID UPTO' autocomplete='off' value='' style='text-transform:uppercase; ' maxlength='11' title='VALID UPTO'>
	            </div>
                 
				 <div class="col-sm-2 colheight" style="padding: 0px; text-align: right; line-height: 30px;">CREATOR ECNO/NAME : </div>
	            <div class="col-sm-4 colheight" style="padding: 0px; line-height: 30px;">
	            	<select input type='text' class="form-control" style="text-transform: uppercase;text-align:left" required name='txtdynamic_creator' id='txtdynamic_creator' data-toggle="tooltip" data-placement="top" data-original-title="CREATOR" value='<?=$sql_emp[0]['EMPCODE']." - ".$sql_emp[0]['EMPNAME']." - ".substr($sql_emp[0]['ESENAME'], 3)?>'>
			...
			<div class="row" style="margin-right: -5px; display: flex; text-transform: uppercase;">
	            ...
	            <div class="col-sm-4 colheight" style="padding: 0px; line-height: 30px;">
	            	<input type='text' class="form-control" style="text-transform: uppercase;" required name='txtdynamic_approval_date' id='datepicker_example13' data-toggle="tooltip" data-placement="top" data-original-title="APPROVAL DATE" value='<?=strtoupper(date("d-M-Y"));?>'>
	            </div>
				<?/*<div class="row" style="margin-right: -5px; display: flex; text-transform: uppercase;">
	            ...
	            <div class="col-sm-4 colheight" style="padding: 0px; line-height: 30px;">
	            	<select input type='text' class="form-control" style="text-transform: uppercase;" required name='txtdynamic_assistby' id='txtdynamic_assistby' data-toggle="tooltip" data-placement="top" data-original-title="ASSIST BY" value='<?=$sql_emp[0]['EMPCODE']." - ".$sql_emp[0]['EMPNAME']." - ".substr($sql_emp[0]['ESENAME'], 3)?>'>
	            <option>--Select User--</option>
			...
			<div class="row" style="margin-right: -5px; display: flex; text-transform: uppercase;">
	            ...
	            <div class="col-sm-4 colheight" style="padding: 0px; line-height: 30px;">
	            	<select input type='text' class="form-control" style="text-transform: uppercase;" required name='txtdynamic_userlist' id='txtdynamic_userlist' data-toggle="tooltip" data-placement="top" data-original-title="USER LIST" value='<?=$sql_emp[0]['EMPCODE']." - ".$sql_emp[0]['EMPNAME']." - ".substr($sql_emp[0]['ESENAME'], 3)?>'>
	            ...
	            <div class="col-sm-4 colheight" style="padding: 0px; line-height: 30px;">
	            	<select input type='text' class="form-control" style="text-transform: uppercase;" required name='txtdynamic_coordinator' id='txtdynamic_coordinator' data-toggle="tooltip" data-placement="top" data-original-title="APPROVED BY" value='<?=$sql_emp[0]['EMPCODE']." - ".$sql_emp[0]['EMPNAME']." - ".substr($sql_emp[0]['ESENAME'], 3)?>'>
	            <option>--Select User--</option>
  ...
  <script src="js/fSelect.js"></script>
	...
	$('#datepicker_example5').Zebra_DatePicker({
                      direction: ['<?=strtoupper(date("d-M-Y", strtotime("+1 days")))?>', true],
                      format: 'd-M-Y'
                    });
...
$('#datepicker_example13').Zebra_DatePicker({
                      direction: true,
                      format: 'd-M-Y'
                    });	
