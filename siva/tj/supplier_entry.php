										...
										<div class="fair_border">
											...
											<div class="col-md-12" style='text-transform:uppercase;'>
												...
												<div class="col-sm-6">
													...
													<select input type='text'  class="form-control custom select" style="text-transform: uppercase; width:100%; height:12%;"  name="weight_range" id="weight_range_1" value="<?php echo $weight_range_1;?>" data-toggle="tooltip" data-placement="top" data-original-title="weight range" >
											...
											<div class="col-sm-6">	
											       ...
											       <select  class="form-control ui-autocomplete-input number" input type='text' name="pay_mode[]" id="pay_mode_1"  title="Regular" style="width:100%;height:5%;">
