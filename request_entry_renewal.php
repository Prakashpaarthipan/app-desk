...
if($inner_menuaccess[0]['VEWVALU'] == 'Y') { // Menu Permission is allowed
    ...
    <body>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <? } else { ?>
                                                        ...
                                                        <?  $sql_project = select_query_json("select * from approval_project where DELETED = 'N' order by APRCODE Asc", "Centra", 'TCS');
                                                            $c_sql_project = count($sql_project);
                                                            for($project_i = 0; $project_i < $c_sql_project; $project_i++) { ?>
                                                        ...
                                                        <?  if($sql_reqid[0]['APRCODE'] != '') {
                                                            ...
                                                            if($sql_project[0]['BRNPROJ'] == 'P') {
                                                                $sql_submission_type = select_query_json("select * from approval_type
                                                                                                                    where DELETED = 'N' order by ATYSRNO", "Centra", 'TEST');
                                                            ...
                                                            <? $c_sql_submission_type=count($sql_submission_type);
                                                            for($submission_type_i = 0; $submission_type_i < $c_sql_submission_type; $submission_type_i++) { ?>
                                                            ...
                                                            <? } else {
                                                                ...
                                                                <div id='id_targetno'>
                                                                    ...
                                                                    <?  $sql_tarno = select_query_json("select distinct round(tarnumb) tarnumb, round(bpl.tarnumb)||' - '||( select distinct
                                                                        ...
                                                                        $c_sql_tarno=count($sql_tarno);
                                                                        for($tarno_i = 0; $tarno_i < $c_sql_tarno; $tarno_i++) {
                                                    ...
                                                    <? } else { ?>
                                                        <div id="id_appr_listings">
                                                            ...
                                                            <?  if($_REQUEST['action'] == 'edit') {
                                                                ...
                                                                $c_sql_approval_type_mode=count($sql_approval_type_mode);
                                                                for($approval_type_mode_i = 0; $approval_type_mode_i < $c_sql_approval_type_mode; $approval_type_mode_i++) { ?>
                                                        ...
                                                        <div id="dynamic_date_subject" style="display: none !important;">
                                                            ...
                                                            <div class="col-md-5 col-xs-12" style="padding-right: 0px !important;">
                                                                <input type="text" tabindex='6' onblur="find_tags();" name="txt_dynamic_subject21" id="txt_dynamic_subject21" class="form-control" required readonly placeholder='To Date' <?=$rdonly;?> autocomplete='off' value='<? echo strtoupper(date("d-M-Y",strtotime("+1 month"))); ?>' style='text-transform:uppercase; ' maxlength='11' title='To Date'>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="tags_clear"></div>
                                            <!-- Approval Subject -->
                                             <!-- Product Quotation fix Expense List Prakash 21-9-18-->
                                              <div id="list_expense_head" style=" display: none">
                                            ...
                                            <div class="form-group" style="margin-top: 5px;margin-bottom: 10px" >
                                                ...
                                                <div class="col-md-9 col-xs-12">
                                                    <? if($_REQUEST['action'] == 'view') { ?>
                                                        : <?=$sql_reqid[0]['APMNAME'].$sql_reqid[0]['DYNSUBJ'].$sql_reqid[0]['TXTSUBJ']?>
                                                    <? } else { ?>
                                             <div id="id_expense_head_list">
                                                            <select <? if($_REQUEST['action'] == 'edit') { ?> disabled class="form-control custom-select" <? } else { ?> class="form-control custom-select chosn"  onblur="call_days()" <? } ?> tabindex='7' onchange="getapproval_listings(this.value)" required name='slt_expense_approval_listings' id='slt_expense_approval_listings' data-toggle="tooltip" data-placement="top" data-original-title="Expense Head">
                                                                <?  $sql_expense_list = select_query_json("select distinct(expsrno),expname from trandata.department_asset@tcscentr 
                                                                                                                where deleted='N' and expsrno>0 order by expsrno", "Centra", "TCS");
                                                                for($approval_type_mode_i = 0; $approval_type_mode_i < count($sql_expense_list); $approval_type_mode_i++) { ?>
                                                                    <option value='<?=$sql_expense_list[$approval_type_mode_i]['EXPSRNO']?>' <? if($approval_type_mode_i == 0) { ?>selected<? } ?>><?=$sql_expense_list[$approval_type_mode_i]['EXPNAME']?></option>
                                                            <? } ?>
                                                            </select>
                                                        </div>
                                                        <?}?>
                                                     <!-- Product rate fix date time picker -->
                                     <!--<div class="form-group" style="margin-top: 5px;margin-bottom: 10px;margin-right: 5px;margin-left: 20px" >
                                           <div id="product_date" style="">
                                                <div class="col-md-4 col-xs-12" style="padding-left: 0px !important;">
                                                    <input type="text" tabindex='6' onblur="find_tags();" name="product_rate_date_frm" id="product_rate_date_frm" class="form-control" required readonly placeholder='From Date' <?=$rdonly;?> autocomplete='off' value='<? echo strtoupper(date("d-M-Y")); ?>' style='text-transform:uppercase; ' maxlength='11' title='From Date'>
                                                </div>
                                                <div class="col-md-2 col-xs-12" style="text-align: center;">&nbsp;- &nbsp;</div>
                                                <div class="col-md-5 col-xs-12" style="padding-right: 0px !important;">
                                                    <input type="text" tabindex='6' onblur="find_tags();" name="product_rate_date_to" id="product_rate_date_to" class="form-control" required readonly placeholder='To Date' <?=$rdonly;?> autocomplete='off' value='<? echo strtoupper(date("d-M-Y",strtotime("+1 month"))); ?>' style='text-transform:uppercase; ' maxlength='11' title='To Date'>
                                                </div>
                                            </div>
                                     </div>-->
                                     <div class="form-group" style="margin-top: 5px;margin-bottom: 10px;margin-right: 5px;margin-left: 20px" >
                                        <label class="col-md-3 control-label">Product Quotation Valid<span style='color:red'>*</span></label>
                                        <div class="col-md-9 col-xs-12" style="padding-left: 0px !important;">
                                                    <!--  -->
                                                    <select  name="product_acc_year" id="product_acc_year" class="form-control custom-select chosn" required>
                                                        <option value="<?=$current_year[0]['PORYEAR']?>"><?=$current_year[0]['PORYEAR']?></option>
                                                        <? $cmonth = date("m");

                                                            if($cmonth == 3){
                                                                 $year = $current_year[0]['PORYEAR'];
                                                                 $nxtyear = explode("-", $year);
                                                                $nextacc = intval($nxtyear[0])+1;
                                                                $nextshrt = intval($nxtyear[1])+1;

                                                                 ?>
                                                                 <option value="<?=$nextacc?>-<?=$nextshrt?>"><?=$nextacc?>-<?=$nextshrt?></option>
                                                           <? }?>
                                     ...
                                     <!-- date picker end here -->
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="form-group" id="id_txt_submission_quotations">
                                                        ...
                                                        <? if($_REQUEST['action'] != 'view') { ?>
                                                            ...
                                                            <div><? echo "<ul id=\"lightgallery\" class=\"list-unstyled row lightgallery\" style='float:left; margin-left:5px;'>";
                                                                $c_sql_docs=count($sql_docs);
                                                                    for($ij = 0; $ij < $c_sql_docs; $ij++) {
                                                    ...
                                                    <div class="form-group" id="id_txt_advpay_comperc1">
                                                    ...
                                                    <? if($_REQUEST['action'] == 'edit' or $_REQUEST['action'] == 'view') { ?>
                                                        <div class="form-group trbg">
                                                            ...
                                                            <div class="col-lg-9 col-xs-9" style="font-weight:bold;">
                                                                ...
                                                                $c_sql_app_hierarchy = count($sql_app_hierarchy) ;
                                                                if($c_sql_app_hierarchy> 0) { $flo = 1; $newentry = 1; // echo "!!!";
                                                                    for($app_hierarchy_i = 0; $app_hierarchy_i < $c_sql_app_hierarchy; $app_hierarchy_i++) { ?>
                                            ...
                                            <div class="panel panel-default" style="display: none;">
                                                ...
                                                <div class="panel-body">
                                                    <? if($sql_reqid[0]['ARQSRNO'] == 1) {
                                                            ...
                                                            $c_sql_approval_levels=count($sql_approval_levels);
                                                            for($sql_approval_levelsi = 0; $sql_approval_levelsi < $c_sql_approval_levels; $sql_approval_levelsi++) { ?>
                                    ...
                                    <? /* <div>
                                        ...
                                        <div class='clear clear_both'></div>
                                        <div id="redire" name="redire" style="display:none"></div>
                                    </div>
                                    <!-- Policy Docs-->
                                </div>
                    ...
                    for (var exp_chklisti=0; exp_chklisti < chklist.length; exp_chklisti++) {
                        ...
                        if(chklist[exp_chklisti] == 8) {
                            ...
                            if($slt_submission == 10){
                                $("#id_txt_advpay_comperc1").css("display", "none");
                            }
                            else{
                            ...
                            success: function(response)
                            {
                                ...
                                if(response == '{"type":"error","info":"ttlfailure","msg":"Failed in Request Creation. Kindly try again!"}' || response == '{"type":"error","info":"ttlfailure","msg":"Failed in Request Creation & Product Adding. Kindly try again!!!!"}' || response == '{"type":"error","info":"ttlfailure","msg":"Failed in Request Creation. Kindly try again!!"}' || response == '{"type":"error","info":"ttlfailure","msg":"Failed in Request Creation. Kindly try again!!!"}') {
                                   ...
                                   // $('input[type=text]').val('');
                                                                ...
                                                                //window.location="request_list_quote.php";
        ...
        function call_dynamic_option() {
            ...
            if(slt_submission == 1 && slt_fixbudget_planner == 'MONTHWISE') {
             ...
             // Prakash disexpanse Product Quotation Fix
            if(slt_submission == 10 || slt_submission == 11){
                    $("#list_expense_head").css("display","block");
                    $("#id_datepicker_example7").css("display","none");
                    $("#id_txt_advpay_comperc1").css("display","none");
            ...
            if(slt_approval_listings != '' && alow_prd == 1) {
                ...
                $.ajax({
                    ...
                    url: strURL,
                    success: function(data1) {
                        $.getScript("ajax/ajax_staff_change1.js");
 ...
 //  error
        ...
        $('#txt_dynamic_subject11').Zebra_DatePicker({ 
           direction: ['<?=date("d-M-Y")?>', '31-DEC-<?=date("Y", strtotime("+5 years"))?>'], 
            format: 'd-M-Y',
            pair: $('#txt_dynamic_subject21')
        });
        $('#txt_dynamic_subject21').Zebra_DatePicker({
            direction: ['<?=date("d-M-Y",strtotime("+1 month"))?>',false], 
            format: 'd-M-Y'
        });
        // Few Approvals show the Period Date

        //Product Rate Fix only
         $('#product_rate_date_frm').Zebra_DatePicker({ 
           direction: ['<?=date("d-M-Y")?>','31-MAR-<?=date("Y",strtotime("+1 years"))?>'], 
            format: 'd-M-Y',
            pair: $('#product_rate_date_to')
        });
        $('#product_rate_date_to').Zebra_DatePicker({
            direction: [1,'31-MAR-<?=date("Y",strtotime("+1 years"))?>'], 
            format: 'd-M-Y'
        });	
         //Product Rate Fix only end
        ...
        function getapproval_listings_only() {
            ...
            var slt_subtopcore = document.getElementById('slt_subcore').value;
            if(budgetidtype == 1 || budgetidtype ==10 ) {
                budgettype = 'FIXED';
            ...
            /* if(budgetidtype == 10) {
                var deptid = $("#slt_expense_approval_listings").val();
            } else { */
                var deptid = $("#slt_department_asset").val();
            // }
        ...
        function get_advancedetails() {
            ...
            if(approval_listings_id == 1781) { // 1781 - AMC (9063 - HW Maintenance)
                ...
                $("#dynamic_date_subject").css("display", "block");
                 $("#list_expense_head").css("display","none");
            } else if(subtype_id == 8 || subtype_id == 9 )
            {     //renewal entry 
                $("#dynamic_subject").css("display", "none");
                $("#dynamic_date_subject").css("display", "block");
                 $("#list_expense_head").css("display","none");
        ...
        function get_sub_core() {
           ...
           else if(slt_submission == 10 ||slt_submission == 11){
                var strURL="getsubcore.php?action=product_rate";
            }
            else {
        ...
        function getsubtype(subtype_id) {
            ...
            if(subtype_id == 1 || subtype_id == 6 || subtype_id == 7)
            {
                ...
                if(subtype_id ==10 || subtype_id == 11){
                     $("#list_expense_head").css("display","block");
                      $("#dynamic_subject").css("display", "block");
