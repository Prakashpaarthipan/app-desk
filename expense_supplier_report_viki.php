...
<head>
<!-- META SECTION -->
<title>PRODUCT RATE FIX REPORT:: <?php echo $site_title; ?></title>
                ...
                <div class="panel panel-default">
                  <div class="panel-body">
                    <div class="panel-heading" style="margin-bottom: 20px;">
                        <h3 class="panel-title"><strong>PRODUCT RATE FIX REPORT</strong></h3>
                                  ...
                                  <table id="current_req_table"  class="table datatable table-striped no-footer" style="margin-left: 20px;">
                                          <thead>
                                              <tr>
                                                ...
                                                <th class="center" style='text-align:left'>UNIT</th>
                                          <th class="center" style='text-align:center;'>RATE/per</th>
                                      ...
                                      {?>
                                          <tr class="odd gradeX" style='background-color:<?=$bgclr?>; color:<?=$clr?>;'>
                                              ...
                                              <td class="center" style='text-align:center'>
                                              <?
                                              $tardetails = select_query_json("select distinct  spa.subname,Tar.Ptnumb,Dep.expname,Dep.Depname Department,dep.depcode,pst.prdname,unt.untname from trandata.non_purchase_target@tcscentr Tar, trandata.Department_asset@tcscentr Dep,trandata.branch@tcscentr Brn,trandata.subproduct_asset@tcscentr spa,trandata.unit@tcscentr unt, trandata.product_asset@tcscentr pst where pst.depcode=dep.depcode and spa.prdcode=pst.prdcode and spa.untcode=unt.untcode and tar.ptnumb ='".$sql_data[$k]['TARNUMB']."'  and tar.brncode=1 and pst.PRDCODE = '".$sql_data[$k]['PRDCODE']."' and spa.subcode='".$sql_data[$k]['SUBCODE']."' and pst.deleted='N'and tar.depcode=dep.depcode and tar.brncode=brn.brncode and dep.Deleted='N'","Centra","TCS");
                                              ...
                                              <td class="center" style='text-align:left;'>
                                                <?
                                          echo $sql_data[$k]['PRDCODE'].'-'.$tardetails[0]['PRDNAME']; ?>
                                              </td>
                                              <td class="center" style='text-align:center;'>
                                        
                                                <? echo $sql_data[$k]['SUBCODE']." - ".$tardetails[0]['SUBNAME']; ?>
                                              </td>
                                              <td class="center" style='text-align:left;'>
                                        <?
