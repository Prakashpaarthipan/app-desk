                                        ...
                                        <table  class="table  table-striped" name="copy_pre" >
                                           ...
                                           // echo("</pre>");
                                            ...
                                            {   $k++;
                                                ...
                                                {
                                                     $sql_brn = select_query_json("select APR.BRNCODE,apr.EMPCODE||'-'||EMPNAME NAME from trandata.approval_branch_head@tcscentr apr, trandata.branch@tcscentr brn where apr.brncode = brn.brncode and apr.deleted = 'N' and brn.deleted = 'N' AND apr.tarnumb ='".$value[0]['TARNUMB']."'  and apr.APRVALU > 100000 GROUP BY apr.BRNCODE, apr.TARNUMB, apr.EMPSRNO, apr.EMPCODE, apr.EMPNAME, apr.brncode,apr.brnhdsr Order by apr.brncode,apr.brnhdsr", "Centra", 'TCS');
                                                }
                                                else{
                                                ...
                                                <tr class="odd gradeX" style='background-color:<?=$bgclr?>; color:<?=$clr?>;'>
                                                    ...
                                                    <td style='text-align:left;width: 10%;' data-toggle="tooltip" data-placement="top" title="TUP">
                                                        <input type="text" name="emp_<?=$k;?>_1" id="emp_<?=$k;?>_1" onblur="addselect('<?=$k;?>','1');" />
                                                        <select name="drop_<?=$k;?>_1" id="drop_<?=$k;?>_1">
...
<!-- START SCRIPTS -->
    ...
    function  addselect(row,brn){
        ...
        console.log(emp);
        $('#drop_'+row+'_'+brn).append('<option value="'+emp+'">'+emp+'</option>');
    }
