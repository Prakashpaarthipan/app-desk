...
if($_REQUEST['action'] == 'edit' and ( $sql_reqid_edit[0]['REQSTBY'] != $_SESSION['TEST_empsrno'] or count($sql_reqid_edit1[0][0]) > 0)) { ?>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type='hidden' name='slt_topcore_name' id='slt_topcore_name' value='<?=$_SESSION['TEST_emptopcore']?>'>
                                        <input type='hidden' name='hid_slt_subcore_name' id='hid_slt_subcore_name' value='<?=$_SESSION['TEST_empsubcore']?>'>
                                        <input type='hidden' name='slt_topcore' id='slt_topcore' value='<?=$_SESSION['TEST_emptopcore_code']?>'>
                                        <input type='hidden' name='hid_slt_subcore' id='hid_slt_subcore' value='<?=$_SESSION['TEST_empsubcore_code']?>'>
                                        <input type='hidden' name='slt_subcore' id='slt_subcore' value='<?=$_SESSION['TEST_empsubcore_code']?>'>
                                                ...
                                                <ul class="panel-controls">
                                                    <li style="font-weight: bold;">
                                                        <?  if($_REQUEST['action'] == 'view') {
                                                                ...
                                                                <input class="form-control" placeholder="Prepared By" tabindex='27' type='hidden' readonly required maxlength='100' name='txtrequest_by' id='txtrequest_by' <? if($_REQUEST['action'] == 'edit') { ?>value='<?=$sql_emp3[0]['EMPCODE']." - ".$sql_emp3[0]["EMPNAME"]?>'<? } else { ?>value='<?=$_SESSION['TEST_user']." - ".strtoupper($_SESSION['TEST_username'])?>'<? } ?> data-toggle="tooltip" data-placement="top" title="Prepared By">
                                                                <input class="form-control" placeholder="Prepared By" type='hidden' tabindex='27' readonly required maxlength='10' name='txtrequest_byid' <? if($_REQUEST['action'] == 'edit') { ?>value='<?=$sql_emp3[0]['EMPSRNO']?>'<? } else { ?>value='<?=$_SESSION['TEST_empsrno']?>'<? } ?> id='txtrequest_byid' data-toggle="tooltip" data-placement="top" title="Prepared By">
                                                                <? if($_REQUEST['action'] == 'edit') { echo "Prepared By : ".$sql_emp3[0]['EMPCODE']." - ".$sql_emp3[0]["EMPNAME"]; }
                                                                    else { echo "Prepared By : ".$_SESSION['TEST_user']." - ".strtoupper($_SESSION['TEST_username']); } ?>
                                                        <? } ?>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-xs-12">
                                                        <? if($_REQUEST['action'] == 'view') { ?>
                                                            : <?=$sql_reqid[0]['BRANCH']?>
                                                        <? } else { $allow_branch = explode(",", $_SESSION['TEST_allowed_branch']);
                                                                if(($_SESSION['TEST_brncode'] == 888 or $_SESSION['TEST_brncode'] == 100) and ($brnch_y_n == 'Y')) {
                                                                    ...
                                                                    $sql_project = select_query_json("select brn.*, regexp_replace(SubStr(nicname,1,4),'[0-9]','')||SubStr(nicname,5,10) branch from branch brn
                                                                                                                where brn.DELETED = 'N' and brn.BRNMODE in ('B', 'K', 'T') and
                                                                                                                    (brn.brncode in (".$_SESSION['TEST_brncode'].")) and brn.brncode not in (11, 22, 202, 205, 119)
                                                                                                                order by brn.BRNCODE", "Centra", 'TEST'); // 108 - TRY Airport Not available
                                                                }
                                                    ...
                                                    <div class="form-group trbg" style="text-align: right;">
                                                        ...
                                                        <div class="col-lg-9 col-xs-9" style="font-weight:normal; text-align: left;">
                                                            : <span style="font-weight: bold;"><? $flo = 0; $newentry = 0;
                                                                switch($_SESSION['TEST_empsrno']) {
                                                                    case 127:
                                                                        $usr_cd = '1333'; break;
                                                                    case 1202:
                                                                        $usr_cd = '1726'; break;
                                                                    default:
                                                                        $usr_cd = $_SESSION['TEST_user']; break;
                                                                }
                                                    ...
                                                    <div class="col-md-9 col-xs-12"> :
                                                        <?  $sql_rlapr = explode(",", $sql_reqid[0]['AGNSAPR']);
                                                            for ($rlapri = 0; $rlapri < count($sql_rlapr); $rlapri++) {
                                                                $sql_apr = select_query_json("select ARQCODE, ARQYEAR, ATCCODE, ATYCODE, APRNUMB from APPROVAL_REQUEST
                                                                                                    where aprnumb like '".trim($sql_rlapr[$rlapri])."' and ARQSRNO = 1", "Centra", "TEST"); ?>
                                                                    <a target="_blank" href='print_request.php?action=view&reqid=<? echo $sql_apr[0]['ARQCODE']; ?>&year=<? echo $sql_apr[0]['ARQYEAR']; ?>&rsrid=1&agnpr=1&creid=<? echo $sql_apr[0]['ATCCODE']; ?>&typeid=<? echo $sql_apr[0]['ATYCODE']; ?>' title='View' alt='View' style='color:<?=$clr?>; font-weight:normal; font-size:10px;'><? echo $sql_apr[0]['APRNUMB']; ?></a><br>
                                                            <? } ?>
                                                    </div>
                                                </div>
                                                <div class="tags_clear"></div>
											   ...
											   <div class="form-group">
												...
												<div class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-xs-12">
                                                        ...
                                                        <?  $sql_emp = select_query_json("select VALUPTO ,ent.aprnumb
                                                                                       from approval_salary app,approval_request ent where ent.aprnumb=app.aprnumb ", "Centra", 'TEST');
														if($_REQUEST['action'] == 'view') {
                                                                echo ": ";
                                                                if($sql_emp[0]['VALUPTO'] != '') { echo strtoupper(date("d-M-Y", strtotime($sql_emp[0]['VALUPTO']))); } else { echo strtoupper(date("d-M-Y")); }
                                                           } else { ?>
												...
												<div class="form-group">
                                                    <label class="col-md-3 control-label">APPROVAL DATE<span style='color:red'>*</span></label>
                                                      <div class="col-md-9 col-xs-12">
														...
														if($_REQUEST['action'] == 'view') {
                                                                 echo ": ";
                                                                if($sql_emp[0]['APPDATE'] != '') { echo strtoupper(date("d-M-Y", strtotime($sql_emp[0]['APPDATE']))); } else { echo strtoupper(date("d-M-Y")); }
                                                           } else { ?>
                                           ...
                                           <div class="tags_clear height10px"></div>
                                            <div class="col-md-12" style="border: 1px solid #dadada; padding: 5px !important;">
                                                <?  if($_REQUEST['action'] == 'view') {
                                                        ...
                                                        <textarea name="FCKeditor1" id="FCKeditor2" >
                                                            <?  if($_REQUEST['action'] == 'edit') {
                                                                    if($sql_reqid[0]['APPRFOR'] == '1') {
                                                                        $filepathname = $sql_details[0]['APRNUMB'];
                                                                        $filename = "ftp://".$ftp_user_name_apdsk.":".$ftp_user_pass_apdsk."@".$ftp_server_apdsk.$ftp_srvport_apdsk."/approval_desk/text_approval_source/".$filepathname;
