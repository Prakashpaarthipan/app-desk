...
function update_detail(){
 ...
 <div class="row">
                ...
                <div class="panel panel-default">
                    ...
                    <table id="customers" class="table datatable" border="1">
						...
						<?	foreach ($sql_week as $key => $week_value) {
							...
							?>		
							<th style="text-align: center;"><? echo $dt_value;?> TO <? echo $dt_val;?></th>
						<? }?>
						...
						<td class="center" style="text-align: center;">
                                    <select id="txt_employee_grade_<?=$search_i;?>_<?=$dt_value?>_<?=$dt_val?>" name='txt_employee_grade_<?=$search_i;?>_<?=$dt_value?>_<?=$dt_val?>' class="txt_employee_grade" onchange="task_assign('<?=$join[$search_i]['EMPSRNO']?>', '<?=$search_i?>', '<?=$dt_value?>', '<?=$dt_val?>');" style="min-height: 25px;">
								...
								<td class="center" style="text-align: center;"><input type="text" name="txt_empgrade_remarks_<?=$search_i?>" id='txt_empgrade_remarks_<?=$search_i?>' maxlength="100" class="form-control" placeholder="Employees Remarks" title="Employee Remarks" value="<?=$sql_empgrade[0]['EMPRMRK']?>" onchange="task_assign('<?=$join[$search_i]['EMPSRNO']?>', '<?=$search_i?>', '<?=$dt_value?>', '<?=$dt_val?>');" style="width: 100%; text-transform: uppercase; border: 1xp solid #000"></td>
    ...
    function task_assign(empsrno, iv, fromdate, todate) {
        $('#load_page').show();
        var grade = $("#txt_employee_grade_"+iv+"_"+fromdate+"_"+todate).val();
      ...
      //  var txt_empgrade_remarks = $("#txt_empgrade_remarks_"+iv).val();
        ...
        var strURL="ajax/fix_grade_week_report.php?action=fix_grade&empsrno="+empsrno+"&grade="+grade+"&txt_empgrade_remarks="+txt_empgrade_remarks+"&fromdate="+fromdate+"&todate="+todate;
