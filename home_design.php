                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12" style="width:100%">
                        ...
                        <div style="width:20%;float:left;">
                            ...
                            <a href="<?=$link_name?>?status=waiting&prty=1">
                              <img src="images/dashboard/img1.png" width="85%" style="position:relative" >
							  
                                <div class="pull-right" style='font-size:18px; font-weight:bold; background-color:#FFFFFF;color:#000000;min-width: 40px;text-align: center;border-radius:30px;margin:48px 64px;right:1%;bottom:-6px;padding:12px;position:absolute;border:solid 2px #E32139'  ><? if($sql_search2['1'][0]['CNTSTAT'] > 0) { echo $sql_search2['1'][0]['CNTSTAT']; } else { echo "0"; } ?></div>
                            </a>
                            </div>
                            <!-- Do Right Away -->
                      ...
                      <div style="width:20%;float:left">
                            ...
                            <a href="<?=$link_name?>?status=waiting&prty=2">
                              <img src="images/dashboard/img2.png" width="85%" style="position:relative" >
                       ...
                       <div style="width:20%;float:left">
                            ...
                            <a href="<?=$link_name?>?status=waiting&prty=3">
                              <img src="images/dashboard/img3.png" width="85%" style="position:relative" >
                        ...
                        <div style="width:20%;float:left">
                            ...
                            <a href="<?=$link_name?>?status=waiting&prty=4">
                              <img src="images/dashboard/img4.png" width="85%" style="position:relative" >
                       ...
                       <div style="width:20%;float:left">
                            ...
                            <a href="<?=$link_name?>?status=waiting&prty=5">
                              <img src="images/dashboard/img5.png" width="85%" style="position:relative" >
